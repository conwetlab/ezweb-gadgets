...
/* The Original Code is 8E0FDDD04250B9714440449EB80DDA34.cache.js
...
function th(b){var a,c;a=Bk(xmb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);zmb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(xmb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);zmb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(xmb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);zmb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(xmb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);zmb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(xmb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);zmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(xmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['D','S','T','Q','Q','S','S']);zmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(xmb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);zmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(xmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);zmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(xmb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);zmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(xmb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',348,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);zmb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new bfb();_.tN=CPb+'DateTimeConstants_pt_PT';_.tI=28;function gk(){return null;}
...
function eU(d,a,b,c){if(Ffb(a,'viewDetails'))tV(d.a,b,c);else{t7((rbb(),Abb,'ERRO'),(rbb(),Abb,'Comportamento n\xE3o definido'),(rbb(),Abb,'Aceitar'),null,null,null);}}
...
function lU(){}
_=lU.prototype=new bfb();_.tN=mQb+'CriterionsListElement';_.tI=151;_.a=null;_.b=null;function bV(a){a.p=hW(new CV());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=sjb(new qjb());a.g=sjb(new qjb());a.a=sjb(new qjb());a.c=CFb(new xFb(),(rbb(),Abb,'Pesquisando...'));}
...
function jV(e,b,d,c){var a;if(e.h.p){hJb(e.c);}a=BU(new AU(),e,b,d);sbb(e.k);if(e.h.q){lW(e.p,b.a,d5(b),e.m.a,d,(rbb(),Abb,'pt'),a);}else{iV(e,b,e.m.a,d,(rbb(),Abb,'pt'));}}
...
function zV(a,c,b){if(b!==null&& !Ffb(b.c,'')){sV(this,a,c);pV(this,this,true,b);}else{t7((rbb(),Abb,'ERRO'),(rbb(),Abb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(rbb(),Abb,'Aceitar'),null,null,null);}}
function sU(){}
...
function DU(b,a){if(b.a.h.p){dJb(b.a.c);}t7((rbb(),Abb,'ERRO'),(rbb(),Abb,'N\xE3o se p\xF4de ligar com o servidor')+': '+ehb(a),(rbb(),Abb,'Aceitar'),null,null,null);}
...
function w0(){}
_=w0.prototype=new bfb();_.je=z0;_.tN=oQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=176;function C0(a){Eq((rbb(),zbb,''),(rbb(),Abb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function A0(){}
...
function y3(d,b){var a,c;c=Bk(xmb(d.a,b),1);if(c!==null)return c;if(Ffb(b,'OuterServiceException')){a='Outer service reported an exception';zmb(d.a,'OuterServiceException',a);return a;}if(Ffb(b,'UnableToInitIndex')){a='Unable to init an index';zmb(d.a,'UnableToInitIndex',a);return a;}if(Ffb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';zmb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(Ffb(b,'usarMapa')){a='Usar mapa';zmb(d.a,'usarMapa',a);return a;}if(Ffb(b,'hasta')){a='a';zmb(d.a,'hasta',a);return a;}if(Ffb(b,'resultados')){a='Resultados';zmb(d.a,'resultados',a);return a;}if(Ffb(b,'valueErrors')){a='Error entering search criteria';zmb(d.a,'valueErrors',a);return a;}if(Ffb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';zmb(d.a,'ningunCriterioIntroducido',a);return a;}if(Ffb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';zmb(d.a,'requiredCriterionError',a);return a;}if(Ffb(b,'gazetteerTitle')){a='Nomenclatura';zmb(d.a,'gazetteerTitle',a);return a;}if(Ffb(b,'sourceURLTitle')){a='URL';zmb(d.a,'sourceURLTitle',a);return a;}if(Ffb(b,'UnknownFaliure')){a='Unknown service failure';zmb(d.a,'UnknownFaliure',a);return a;}if(Ffb(b,'okButtonLabel')){a='Aceitar';zmb(d.a,'okButtonLabel',a);return a;}if(Ffb(b,'nuevaBusqueda')){a='NOVA';zmb(d.a,'nuevaBusqueda',a);return a;}if(Ffb(b,'refinar')){a='REFINAR ';zmb(d.a,'refinar',a);return a;}if(Ffb(b,'newSourceTitle')){a='New source';zmb(d.a,'newSourceTitle',a);return a;}if(Ffb(b,'anterior')){a='Anterior';zmb(d.a,'anterior',a);return a;}if(Ffb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";zmb(d.a,'UnableToReadSourceResponse',a);return a;}if(Ffb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';zmb(d.a,'UnableToSynchroniseSource',a);return a;}if(Ffb(b,'siguiente')){a='Seguinte';zmb(d.a,'siguiente',a);return a;}if(Ffb(b,'UnsupportedEncoding')){a='Unsupported Encoding';zmb(d.a,'UnsupportedEncoding',a);return a;}if(Ffb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';zmb(d.a,'connection_error',a);return a;}if(Ffb(b,'limpiar')){a='Limpar';zmb(d.a,'limpiar',a);return a;}if(Ffb(b,'NoReachableOuterService')){a='Could not connect with the outer service';zmb(d.a,'NoReachableOuterService',a);return a;}if(Ffb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';zmb(d.a,'UnableToRemoveFromIndex',a);return a;}if(Ffb(b,'sourcesListTitle')){a='Sources list';zmb(d.a,'sourcesListTitle',a);return a;}if(Ffb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';zmb(d.a,'UnableToInitSource',a);return a;}if(Ffb(b,'ayuda')){a='Ajuda';zmb(d.a,'ayuda',a);return a;}if(Ffb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";zmb(d.a,'NoReachableRDF',a);return a;}if(Ffb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';zmb(d.a,'UnableToPerformInsertion',a);return a;}if(Ffb(b,'deUnTotalDe')){a='de um total de';zmb(d.a,'deUnTotalDe',a);return a;}if(Ffb(b,'invalidDate')){a='Invalid date';zmb(d.a,'invalidDate',a);return a;}if(Ffb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';zmb(d.a,'sinResultados',a);return a;}if(Ffb(b,'aceptar')){a='Aceitar';zmb(d.a,'aceptar',a);return a;}if(Ffb(b,'buscar')){a='Pesquisar';zmb(d.a,'buscar',a);return a;}if(Ffb(b,'ResultList_Title')){a='Lista de resultados';zmb(d.a,'ResultList_Title',a);return a;}if(Ffb(b,'buscando')){a='Pesquisando...';zmb(d.a,'buscando',a);return a;}if(Ffb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';zmb(d.a,'NoReachablePool',a);return a;}if(Ffb(b,'sourceTypeTitle')){a='Type';zmb(d.a,'sourceTypeTitle',a);return a;}if(Ffb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';zmb(d.a,'SearchInfo_Title',a);return a;}if(Ffb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';zmb(d.a,'undefinedBehaviour',a);return a;}if(Ffb(b,'detalle')){a='Pormenor';zmb(d.a,'detalle',a);return a;}if(Ffb(b,'error')){a='ERRO';zmb(d.a,'error',a);return a;}if(Ffb(b,'loading')){a='Carregando...';zmb(d.a,'loading',a);return a;}if(Ffb(b,'resultComponentVoid')){a='-';zmb(d.a,'resultComponentVoid',a);return a;}if(Ffb(b,'busquedaAnterior')){a='ANTERIOR';zmb(d.a,'busquedaAnterior',a);return a;}if(Ffb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';zmb(d.a,'wrongSourceDescriptionFile',a);return a;}if(Ffb(b,'locale')){a='pt';zmb(d.a,'locale',a);return a;}if(Ffb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";zmb(d.a,'NotAValidQuery',a);return a;}if(Ffb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';zmb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw rnb(new qnb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function u3(){}
_=u3.prototype=new bfb();_.tN=qQb+'Messages_pt';_.tI=181;function A3(a){a.a=sjb(new qjb());}
...
function n_(j,h){var a,b,c,d,e,f,g,i;pB(j.c);f=Dnb(new Cnb());j.h=h.e;j.f=Fk((h.g+1)/j.g);j.a=Fk((j.f-1)/j.d);if(j.a!=0){d=z8(new y8());uE(d,'<<');qE(d,j);B8(Bk(d,55),1+j.a*j.d-j.d);}else{d=oE(new nE());uE(d,' ');}d.dc('navigationArrowsLeft');Fnb(f,d);if(h.b!=0){b=z8(new y8());uE(b,(rbb(),Abb,'Anterior'));qE(b,j);B8(Bk(b,55),j.f-1);}else{b=oE(new nE());uE(b,' ');}b.dc('navigationPrevious');Fnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=ieb(h.f/j.g);e++){g=z8(new y8());if(e==j.f){g.dc('navigationCurrentPage');}else{qE(g,j);B8(g,e);}uE(g,''+e);Fnb(f,g);}if(j.f<ieb(h.f/j.g)){i=z8(new y8());uE(i,(rbb(),Abb,'Seguinte'));qE(i,j);B8(Bk(i,55),j.f+1);}else{i=oE(new nE());uE(i,' ');}i.dc('navigationNext');Fnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=z8(new y8());uE(c,'>>');qE(c,j);B8(Bk(c,55),e);}else{c=oE(new nE());uE(c,' ');}c.dc('navigationArrowsRight');Fnb(f,c);Cz(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){FB(j.c,0,a,Bk(bob(f,a),56));}}
...
function gab(c,a,b){fab(c);c.c=gyb(new rxb(),'',a);c.a=gyb(new rxb(),'',b);zxb(c.b,c.c);zxb(c.b,c.a);FEb(c.c,(rbb(),Abb,'REFINAR '));FEb(c.a,(rbb(),Abb,'NOVA'));kyb(c.c,'icon-refine');kyb(c.a,'icon-new');ty(c,c.b);return c;}
function eab(){}
...
function xab(c,b,a){wab(c);c.a=gyb(new rxb(),'',b);c.b=gyb(new rxb(),'',a);zxb(c.c,c.a);zxb(c.c,c.b);fAb(c.c,'searchButtonsPanel');FEb(c.a,(rbb(),Abb,'Pesquisar'));FEb(c.b,(rbb(),Abb,'Limpar'));kyb(c.a,'icon-search');kyb(c.b,'icon-clear');ty(c,c.c);return c;}
function vab(){}
...
function sbb(d){var a,b,c;if(d.h!==null){qKb(d.p,d.h);}d.h=aLb(new AKb(),2);a=d.h.b;if(d.a.h){ap(hzb(a),'height',d.a.l);}FEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");wyb(d.h,710,d.f);iKb(d.p,d.h);if(d.a.h){ap(Fn(hzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=kKb(d.p,c).b;ap(hzb(b),'height',d.a.l);}}}
...
function ubb(d,b){var a,c;iMb(d.h.b,b);FEb(d.h,'Pormenor');tKb(d.p,d.h);if(d.a.h){ap(Fn(hzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=kKb(d.p,c).b;ap(hzb(a),'height',d.a.l);}}}
...
function hPb(){}
_=hPb.prototype=new bfb();_.tN=bRb+'DateLocale_pt_PT';_.tI=346;function oPb(a,b){return qkb(new okb(),Ckb(a),ykb(a),ukb(a)+b);}
