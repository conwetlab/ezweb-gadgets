...
/* The Original Code is 1AF321A4D63918CFC4D897F5A78FD2E2.cache.js
...
function th(b){var a,c;a=Bk(vmb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);xmb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(vmb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);xmb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(vmb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);xmb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(vmb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);xmb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(vmb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);xmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(vmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['D','S','T','Q','Q','S','S']);xmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(vmb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);xmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(vmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);xmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(vmb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);xmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(vmb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',347,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);xmb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new Feb();_.tN=APb+'DateTimeConstants_pt_BR';_.tI=28;function gk(){return null;}
...
function cU(d,a,b,c){if(Dfb(a,'viewDetails'))rV(d.a,b,c);else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'Comportamento n\xE3o definido'),(pbb(),ybb,'Aceitar'),null,null,null);}}
...
function jT(){}
_=jT.prototype=new Feb();_.tN=iQb+'AVOFilterBuilder';_.tI=146;_.c=null;_.d='CONTAINS WORD';_.g=false;function wT(e,a,f,c){var b,d;b=null;if(Cfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(Cfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(Cfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(Cfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(Cfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(Cfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(Cfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!Cfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(pbb(),ybb,'Aceitar'),null,null,null);}return b;}
function xT(e,b,d,c){var a;a=null;if(Cfb(c,e.c)){a=e.b+b+d+e.a;}else if(Cfb(c,e.eb)){a=e.db+b+d+e.cb;}else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(pbb(),ybb,'Aceitar'),null,null,null);}return a;}
...
function jU(){}
_=jU.prototype=new Feb();_.tN=kQb+'CriterionsListElement';_.tI=150;_.a=null;_.b=null;function FU(a){a.p=fW(new AV());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=qjb(new ojb());a.g=qjb(new ojb());a.a=qjb(new ojb());a.c=AFb(new vFb(),(pbb(),ybb,'Pesquisando...'));}
...
function hV(e,b,d,c){var a;if(e.h.p){fJb(e.c);}a=zU(new yU(),e,b,d);qbb(e.k);if(e.h.q){jW(e.p,b.a,b5(b),e.m.a,d,(pbb(),ybb,'pt'),a);}else{gV(e,b,e.m.a,d,(pbb(),ybb,'pt'));}}
...
function lV(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=w6(new n6());t=new uX();e=cdb(hj(s,'totalLength').tS());F6(q,Bcb(e));C6(q,k8(hj(s,'queryErrorCode').ae().a));D6(q,k8(hj(s,'queryErrorMessage').ae().a));if(q.c!==null&&bgb(q.c)>0){g='';try{if(nQ(yV,q.c)!==null&&bgb(nQ(yV,q.c))>0){g=nQ(yV,q.c);}else{g=w3((pbb(),ybb),q.c);}if(Cfb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=hl(a);if(Ck(a,41)){a;g=q.d;}else throw a;}r7((pbb(),ybb,'ERRO'),g,(pbb(),ybb,'Aceitar'),null,null,null);}else{xX(t,hj(s,'initiallySelectedSource').Ed().a);yX(t,k8(hj(s,'sourceName').ae().a));zX(t,k8(hj(s,'sourceRDF').ae().a));CX(t,k8(hj(s,'sourceTitle').ae().a));EX(t,hj(s,'useSourceRDF').Ed().a);DX(t,hj(s,'useRDFMetadata').Ed().a);wX(t,hj(s,'createRDF').Ed().a);BX(t,k8(hj(s,'sourceServiceURL').ae().a));AX(t,k8(hj(s,'sourceServiceType').ae().a));for(h=0;h<ji(r);h++){p=p6(new o6());o=fi(r,h);n=bi(new ai());if((n=o.Cd())!==null){k=fi(n,0).Fd();c5(p.a,k8(hj(k,'fileIdentifier').ae().a));d5(p.a,k8(hj(k,'metadataLanguage').ae().a));m=qjb(new ojb());d=fi(n,1);c=bi(new ai());if((c=d.Cd())!==null){for(i=0;i<ji(c);i++){j=fi(c,i).Fd();l=new x5();C5(l,k8(hj(j,'text').ae().a));z5(l,k8(hj(j,'alternativeText').ae().a));f=cdb(hj(j,'type').tS());E5(l,Bcb(f));D5(l,k8(hj(j,'tooltip').ae().a));A5(l,k8(hj(j,'condition').ae().a));B5(l,k8(hj(j,'function').ae().a));rjb(m,i,l);}}r6(p,m);}x6(q,p);}E6(q,t);B6(q,u.l);a7(q,u.r);if(u.h.p){bJb(u.c);}sV(u,q);}}
function nV(f,c,d,e){var a,b;if(f.h.s){p8(f.h.j,f.h.i);f.h.k.vg(true);}a=sU(new rU(),f,c);if(d){f.d=f.m.a;}else{f.d=jV(f);j7(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&bgb(f.d.a)>0){if(d){if(e!==null&& !Dfb(e.c,'')){rbb(f.k,e);if(f.h.p){fJb(f.c);}if(f.h.q){kW(f.p,f.d,f.l,f.r,e,a);}else{mV(f,f.l,f.r,e);}}else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(pbb(),ybb,'Aceitar'),null,null,null);}}else{if(f.h.u){f.e=Dbb(f.k.b);}for(b=0;b<f.e.b;b++){if(Bk(xjb(f.e,b),40)!==null&& !Dfb(Bk(xjb(f.e,b),40).c,'')){rbb(f.k,Bk(xjb(f.e,b),40));if(f.h.p){fJb(f.c);}if(f.h.q){kW(f.p,f.d,f.l,f.r,Bk(xjb(f.e,b),40),a);}else{mV(f,f.l,f.r,Bk(xjb(f.e,b),40));}}else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Bk(xjb(f.e,b),40).c,(pbb(),ybb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&bgb(f.d.a)==0){s7(null,(pbb(),ybb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(pbb(),ybb,'Aceitar'),null,null,null);}}
...
function xV(a,c,b){if(b!==null&& !Dfb(b.c,'')){qV(this,a,c);nV(this,this,true,b);}else{r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(pbb(),ybb,'Aceitar'),null,null,null);}}
function qU(){}
...
function uU(b,a){if(b.a.h.p){bJb(b.a.c);}r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'N\xE3o se p\xF4de ligar com o servidor'),(pbb(),ybb,'Aceitar'),null,null,null);}
function vU(f,d){var a,c,e;e=Bk(d,43);if(e.c!==null&&bgb(e.c)>0){c='';try{if(nQ(yV,e.c)!==null&&bgb(nQ(yV,e.c))>0){c=nQ(yV,e.c);}else{c=w3((pbb(),ybb),e.c);}if(Cfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,41)){a;c=e.d;}else throw a;}r7((pbb(),ybb,'ERRO'),c,(pbb(),ybb,'Aceitar'),null,null,null);}else{sV(f.b,e);}if(f.a.h.p){bJb(f.a.c);}}
...
function BU(b,a){if(b.a.h.p){bJb(b.a.c);}r7((pbb(),ybb,'ERRO'),(pbb(),ybb,'N\xE3o se p\xF4de ligar com o servidor')+': '+chb(a),(pbb(),ybb,'Aceitar'),null,null,null);}
...
function u0(){}
_=u0.prototype=new Feb();_.me=x0;_.tN=mQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=175;function A0(a){Eq((pbb(),xbb,''),(pbb(),ybb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function y0(){}
...
function w3(d,b){var a,c;c=Bk(vmb(d.a,b),1);if(c!==null)return c;if(Dfb(b,'OuterServiceException')){a='Outer service reported an exception';xmb(d.a,'OuterServiceException',a);return a;}if(Dfb(b,'UnableToInitIndex')){a='Unable to init an index';xmb(d.a,'UnableToInitIndex',a);return a;}if(Dfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';xmb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(Dfb(b,'usarMapa')){a='Usar mapa';xmb(d.a,'usarMapa',a);return a;}if(Dfb(b,'hasta')){a='a';xmb(d.a,'hasta',a);return a;}if(Dfb(b,'resultados')){a='Resultados';xmb(d.a,'resultados',a);return a;}if(Dfb(b,'valueErrors')){a='Error entering search criteria';xmb(d.a,'valueErrors',a);return a;}if(Dfb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';xmb(d.a,'ningunCriterioIntroducido',a);return a;}if(Dfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';xmb(d.a,'requiredCriterionError',a);return a;}if(Dfb(b,'gazetteerTitle')){a='Nomenclatura';xmb(d.a,'gazetteerTitle',a);return a;}if(Dfb(b,'sourceURLTitle')){a='URL';xmb(d.a,'sourceURLTitle',a);return a;}if(Dfb(b,'UnknownFaliure')){a='Unknown service failure';xmb(d.a,'UnknownFaliure',a);return a;}if(Dfb(b,'okButtonLabel')){a='Aceitar';xmb(d.a,'okButtonLabel',a);return a;}if(Dfb(b,'nuevaBusqueda')){a='NOVA';xmb(d.a,'nuevaBusqueda',a);return a;}if(Dfb(b,'refinar')){a='REFINAR ';xmb(d.a,'refinar',a);return a;}if(Dfb(b,'newSourceTitle')){a='New source';xmb(d.a,'newSourceTitle',a);return a;}if(Dfb(b,'anterior')){a='Anterior';xmb(d.a,'anterior',a);return a;}if(Dfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";xmb(d.a,'UnableToReadSourceResponse',a);return a;}if(Dfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';xmb(d.a,'UnableToSynchroniseSource',a);return a;}if(Dfb(b,'siguiente')){a='Seguinte';xmb(d.a,'siguiente',a);return a;}if(Dfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';xmb(d.a,'UnsupportedEncoding',a);return a;}if(Dfb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';xmb(d.a,'connection_error',a);return a;}if(Dfb(b,'limpiar')){a='Limpar';xmb(d.a,'limpiar',a);return a;}if(Dfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';xmb(d.a,'NoReachableOuterService',a);return a;}if(Dfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';xmb(d.a,'UnableToRemoveFromIndex',a);return a;}if(Dfb(b,'sourcesListTitle')){a='Sources list';xmb(d.a,'sourcesListTitle',a);return a;}if(Dfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';xmb(d.a,'UnableToInitSource',a);return a;}if(Dfb(b,'ayuda')){a='Ajuda';xmb(d.a,'ayuda',a);return a;}if(Dfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";xmb(d.a,'NoReachableRDF',a);return a;}if(Dfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';xmb(d.a,'UnableToPerformInsertion',a);return a;}if(Dfb(b,'deUnTotalDe')){a='de um total de';xmb(d.a,'deUnTotalDe',a);return a;}if(Dfb(b,'invalidDate')){a='Invalid date';xmb(d.a,'invalidDate',a);return a;}if(Dfb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';xmb(d.a,'sinResultados',a);return a;}if(Dfb(b,'aceptar')){a='Aceitar';xmb(d.a,'aceptar',a);return a;}if(Dfb(b,'buscar')){a='Pesquisar';xmb(d.a,'buscar',a);return a;}if(Dfb(b,'ResultList_Title')){a='Lista de resultados';xmb(d.a,'ResultList_Title',a);return a;}if(Dfb(b,'buscando')){a='Pesquisando...';xmb(d.a,'buscando',a);return a;}if(Dfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';xmb(d.a,'NoReachablePool',a);return a;}if(Dfb(b,'sourceTypeTitle')){a='Type';xmb(d.a,'sourceTypeTitle',a);return a;}if(Dfb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';xmb(d.a,'SearchInfo_Title',a);return a;}if(Dfb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';xmb(d.a,'undefinedBehaviour',a);return a;}if(Dfb(b,'detalle')){a='Pormenor';xmb(d.a,'detalle',a);return a;}if(Dfb(b,'error')){a='ERRO';xmb(d.a,'error',a);return a;}if(Dfb(b,'loading')){a='Carregando...';xmb(d.a,'loading',a);return a;}if(Dfb(b,'resultComponentVoid')){a='-';xmb(d.a,'resultComponentVoid',a);return a;}if(Dfb(b,'busquedaAnterior')){a='ANTERIOR';xmb(d.a,'busquedaAnterior',a);return a;}if(Dfb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';xmb(d.a,'wrongSourceDescriptionFile',a);return a;}if(Dfb(b,'locale')){a='pt';xmb(d.a,'locale',a);return a;}if(Dfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";xmb(d.a,'NotAValidQuery',a);return a;}if(Dfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';xmb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw pnb(new onb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function s3(){}
_=s3.prototype=new Feb();_.tN=oQb+'Messages_pt';_.tI=180;function y3(a){a.a=qjb(new ojb());}
...
function eab(c,a,b){dab(c);c.c=eyb(new pxb(),'',a);c.a=eyb(new pxb(),'',b);xxb(c.b,c.c);xxb(c.b,c.a);DEb(c.c,(pbb(),ybb,'REFINAR '));DEb(c.a,(pbb(),ybb,'NOVA'));iyb(c.c,'icon-refine');iyb(c.a,'icon-new');py(c,c.b);return c;}
function cab(){}
...
function vab(c,b,a){uab(c);c.a=eyb(new pxb(),'',b);c.b=eyb(new pxb(),'',a);xxb(c.c,c.a);xxb(c.c,c.b);dAb(c.c,'searchButtonsPanel');DEb(c.a,(pbb(),ybb,'Pesquisar'));DEb(c.b,(pbb(),ybb,'Limpar'));iyb(c.a,'icon-search');iyb(c.b,'icon-clear');py(c,c.c);return c;}
function tab(){}
...
function qbb(d){var a,b,c;if(d.h!==null){oKb(d.p,d.h);}d.h=EKb(new yKb(),2);a=d.h.b;if(d.a.h){ap(fzb(a),'height',d.a.l);}DEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");uyb(d.h,710,d.f);gKb(d.p,d.h);if(d.a.h){ap(Fn(fzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=iKb(d.p,c).b;ap(fzb(b),'height',d.a.l);}}}
...
function sbb(d,b){var a,c;gMb(d.h.b,b);DEb(d.h,'Pormenor');rKb(d.p,d.h);if(d.a.h){ap(Fn(fzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=iKb(d.p,c).b;ap(fzb(a),'height',d.a.l);}}}
...
function fPb(){}
_=fPb.prototype=new Feb();_.tN=FQb+'DateLocale_pt_BR';_.tI=345;function mPb(a,b){return okb(new mkb(),Akb(a),wkb(a),skb(a)+b);}
