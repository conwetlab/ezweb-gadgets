...
/* The Original Code is E28BA4A7C24F55E5E6F686456A362BB4.cache.js
...
function ef(b){var a,c;a=ri(fmb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['vorm.','nachm.']);hmb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(fmb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['v. Chr.','n. Chr.']);hmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(fmb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['v. Chr.','n. Chr.']);hmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(fmb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);hmb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(fmb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);hmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(fmb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);hmb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(fmb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['So','Mo','Di','Mi','Do','Fr','Sa']);hmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(fmb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);hmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(fmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['S','M','D','M','D','F','S']);hmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(fmb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);hmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(fmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['So','Mo','Di','Mi','Do','Fr','Sa']);hmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(fmb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);hmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(fmb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);hmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new qeb();_.tN=hPb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function tCb(b,a){vCb();mIb(b,a);b.c=gxb(new axb(),67108864);if((a&16777216)!=0){wCb(b,0,'OK');}if((a&67108864)!=0){wCb(b,0,'OK');wCb(b,1,'Abbrechen');}if((a&268435456)!=0){wCb(b,2,'Ja');wCb(b,3,'Nein');}if((a&1073741824)!=0){wCb(b,2,'Ja');wCb(b,3,'Nein');wCb(b,1,'Abbrechen');}return b;}
...
function vOb(){}
_=vOb.prototype=new qeb();_.tN=oQb+'DateLocale_de_CH';_.tI=349;function COb(a,b){return Ejb(new Cjb(),kkb(a),gkb(a),ckb(a)+b);}
