...
/* The Original Code is 7E91BA217AB9AC1DB94258CE77000149.cache.js
...
function gf(b){var a,c;a=ri(Flb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['a.C.','d.C.']);bmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(Flb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['a.C.','d.C.']);bmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(Flb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);bmb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(Flb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);bmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(Flb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);bmb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(Flb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);bmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(Flb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);bmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(Flb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['D','S','T','Q','Q','S','S']);bmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(Flb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);bmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(Flb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);bmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(Flb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);bmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(Flb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',349,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);bmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new keb();_.tN=bPb+'DateTimeConstants_pt_PT';_.tI=18;function Ch(){return null;}
...
function tT(d,a,b,c){if(ifb(a,'viewDetails'))cV(d.a,b,c);else{c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'Comportamento n\xE3o definido'),(Aab(),dbb,'Aceitar'),null,null,null);}}
...
function AS(){}
_=AS.prototype=new keb();_.tN=rPb+'AVOFilterBuilder';_.tI=150;_.c=null;_.d='CONTAINS WORD';_.g=false;function hT(e,a,f,c){var b,d;b=null;if(hfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(hfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(hfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(hfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(hfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(hfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(hfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!hfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(Aab(),dbb,'Aceitar'),null,null,null);}return b;}
function iT(e,b,d,c){var a;a=null;if(hfb(c,e.c)){a=e.b+b+d+e.a;}else if(hfb(c,e.eb)){a=e.db+b+d+e.cb;}else{c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(Aab(),dbb,'Aceitar'),null,null,null);}return a;}
...
function AT(){}
_=AT.prototype=new keb();_.tN=tPb+'CriterionsListElement';_.tI=154;_.a=null;_.b=null;function qU(a){a.p=wV(new lV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Aib(new yib());a.g=Aib(new yib());a.a=Aib(new yib());a.c=eFb(new FEb(),(Aab(),dbb,'Pesquisando...'));}
...
function yU(e,b,d,c){var a;if(e.h.p){pIb(e.c);}a=kU(new jU(),e,b,d);Bab(e.k);if(e.h.q){AV(e.p,b.a,s4(b),e.m.a,d,(Aab(),dbb,'pt'),a);}else{xU(e,b,e.m.a,d,(Aab(),dbb,'pt'));}}
...
function iV(a,c,b){if(b!==null&& !ifb(b.c,'')){bV(this,a,c);EU(this,this,true,b);}else{c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(Aab(),dbb,'Aceitar'),null,null,null);}}
function bU(){}
...
function fU(b,a){if(b.a.h.p){lIb(b.a.c);}c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'N\xE3o se p\xF4de ligar com o servidor'),(Aab(),dbb,'Aceitar'),null,null,null);}
function gU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&mfb(e.c)>0){c='';try{if(lO(jV,e.c)!==null&&mfb(lO(jV,e.c))>0){c=lO(jV,e.c);}else{c=h3((Aab(),dbb),e.c);}if(hfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,40)){a;c=e.d;}else throw a;}c7((Aab(),dbb,'ERRO'),c,(Aab(),dbb,'Aceitar'),null,null,null);}else{dV(f.b,e);}if(f.a.h.p){lIb(f.a.c);}}
...
function mU(b,a){if(b.a.h.p){lIb(b.a.c);}c7((Aab(),dbb,'ERRO'),(Aab(),dbb,'N\xE3o se p\xF4de ligar com o servidor')+': '+mgb(a),(Aab(),dbb,'Aceitar'),null,null,null);}
...
function n0(d,a){var b,c;i$(d,a);m0(d);d.b=null.Dg;j$(d,d);zw(d.e,d);i4(d.j,'mapa',d.a);if(null.Dg==true){if(null.Dg){d.g=xBb(new EAb(),192,'my-cpanel-small');if(null.Dg){DBb(d.g,false);}}else{d.g=xBb(new EAb(),128,'my-cpanel-small');}aCb(d.g,null.Dg);Fxb(d.g,'criterionContentPanel');}else{d.g=xBb(new EAb(),0,'internal-compound-cpanel-small');Fxb(d.g,'internalCompoundCriterionContentPanel');}d.d.lg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',354,15,[])));nb(c,null.Dg);if(null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN){d.a=xS(new wS(),d.b,(Aab(),dbb,'pt'),null.Dg,null.Dg,null.Dg,null.Dg,null.Dg,bgb(null.Dg),bgb(null.Dg));}else{d.a=yS(new wS(),d.b,(Aab(),dbb,'pt'),bgb(null.Dg),bgb(null.Dg));}AJ(d.d,8);ou(d.d,d.a);if(null.Dg==true){d.k=lv(new iv(),' '+(Aab(),dbb,'Usar mapa'));d.k.Fb(g0(new f0(),d));tK(d.i,d.k);if(null.Dg){ov(d.k,true);}else{ov(d.k,false);zR(d.a);}if(null.Dg){p0(d);}if(null.Dg){d.rg(false);}}tF(d.e,d.d);tK(d.i,d.e);EBb(d.g,'icon-text');d.i.dc('criterionPanel');qLb(d.g,d.i);if(null.Dg){b=new j0();d.h=oxb(new zwb(),(Aab(),dbb,'Nomenclatura'),b);hzb(d.h,false);nzb(d.h,'coordinatesCCBGazetteerButton');qLb(d.g,d.h);}lw(d,d.g);return d;}
...
function f0(){}
_=f0.prototype=new keb();_.je=i0;_.tN=vPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=179;function l0(a){yo((Aab(),cbb,''),(Aab(),dbb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function j0(){}
...
function h3(d,b){var a,c;c=ri(Flb(d.a,b),1);if(c!==null)return c;if(ifb(b,'OuterServiceException')){a='Outer service reported an exception';bmb(d.a,'OuterServiceException',a);return a;}if(ifb(b,'UnableToInitIndex')){a='Unable to init an index';bmb(d.a,'UnableToInitIndex',a);return a;}if(ifb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';bmb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(ifb(b,'usarMapa')){a='Usar mapa';bmb(d.a,'usarMapa',a);return a;}if(ifb(b,'hasta')){a='a';bmb(d.a,'hasta',a);return a;}if(ifb(b,'resultados')){a='Resultados';bmb(d.a,'resultados',a);return a;}if(ifb(b,'valueErrors')){a='Error entering search criteria';bmb(d.a,'valueErrors',a);return a;}if(ifb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';bmb(d.a,'ningunCriterioIntroducido',a);return a;}if(ifb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';bmb(d.a,'requiredCriterionError',a);return a;}if(ifb(b,'gazetteerTitle')){a='Nomenclatura';bmb(d.a,'gazetteerTitle',a);return a;}if(ifb(b,'sourceURLTitle')){a='URL';bmb(d.a,'sourceURLTitle',a);return a;}if(ifb(b,'UnknownFaliure')){a='Unknown service failure';bmb(d.a,'UnknownFaliure',a);return a;}if(ifb(b,'okButtonLabel')){a='Aceitar';bmb(d.a,'okButtonLabel',a);return a;}if(ifb(b,'nuevaBusqueda')){a='NOVA';bmb(d.a,'nuevaBusqueda',a);return a;}if(ifb(b,'refinar')){a='REFINAR ';bmb(d.a,'refinar',a);return a;}if(ifb(b,'newSourceTitle')){a='New source';bmb(d.a,'newSourceTitle',a);return a;}if(ifb(b,'anterior')){a='Anterior';bmb(d.a,'anterior',a);return a;}if(ifb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";bmb(d.a,'UnableToReadSourceResponse',a);return a;}if(ifb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';bmb(d.a,'UnableToSynchroniseSource',a);return a;}if(ifb(b,'siguiente')){a='Seguinte';bmb(d.a,'siguiente',a);return a;}if(ifb(b,'UnsupportedEncoding')){a='Unsupported Encoding';bmb(d.a,'UnsupportedEncoding',a);return a;}if(ifb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';bmb(d.a,'connection_error',a);return a;}if(ifb(b,'limpiar')){a='Limpar';bmb(d.a,'limpiar',a);return a;}if(ifb(b,'NoReachableOuterService')){a='Could not connect with the outer service';bmb(d.a,'NoReachableOuterService',a);return a;}if(ifb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';bmb(d.a,'UnableToRemoveFromIndex',a);return a;}if(ifb(b,'sourcesListTitle')){a='Fontes dispon\xEDveis';bmb(d.a,'sourcesListTitle',a);return a;}if(ifb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';bmb(d.a,'UnableToInitSource',a);return a;}if(ifb(b,'ayuda')){a='Ajuda';bmb(d.a,'ayuda',a);return a;}if(ifb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";bmb(d.a,'NoReachableRDF',a);return a;}if(ifb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';bmb(d.a,'UnableToPerformInsertion',a);return a;}if(ifb(b,'deUnTotalDe')){a='de um total de';bmb(d.a,'deUnTotalDe',a);return a;}if(ifb(b,'invalidDate')){a='Invalid date';bmb(d.a,'invalidDate',a);return a;}if(ifb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';bmb(d.a,'sinResultados',a);return a;}if(ifb(b,'aceptar')){a='Aceitar';bmb(d.a,'aceptar',a);return a;}if(ifb(b,'buscar')){a='Pesquisar';bmb(d.a,'buscar',a);return a;}if(ifb(b,'ResultList_Title')){a='Lista de resultados';bmb(d.a,'ResultList_Title',a);return a;}if(ifb(b,'buscando')){a='Pesquisando...';bmb(d.a,'buscando',a);return a;}if(ifb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';bmb(d.a,'NoReachablePool',a);return a;}if(ifb(b,'sourceTypeTitle')){a='Type';bmb(d.a,'sourceTypeTitle',a);return a;}if(ifb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';bmb(d.a,'SearchInfo_Title',a);return a;}if(ifb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';bmb(d.a,'undefinedBehaviour',a);return a;}if(ifb(b,'detalle')){a='Pormenor';bmb(d.a,'detalle',a);return a;}if(ifb(b,'error')){a='ERRO';bmb(d.a,'error',a);return a;}if(ifb(b,'loading')){a='Carregando...';bmb(d.a,'loading',a);return a;}if(ifb(b,'resultComponentVoid')){a='-';bmb(d.a,'resultComponentVoid',a);return a;}if(ifb(b,'busquedaAnterior')){a='ANTERIOR';bmb(d.a,'busquedaAnterior',a);return a;}if(ifb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';bmb(d.a,'wrongSourceDescriptionFile',a);return a;}if(ifb(b,'locale')){a='pt';bmb(d.a,'locale',a);return a;}if(ifb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";bmb(d.a,'NotAValidQuery',a);return a;}if(ifb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';bmb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw zmb(new ymb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function d3(){}
_=d3.prototype=new keb();_.tN=xPb+'Messages_pt';_.tI=184;function j3(a){a.a=Aib(new yib());}
...
function p_(c,a,b){o_(c);c.c=oxb(new zwb(),'',a);c.a=oxb(new zwb(),'',b);bxb(c.b,c.c);bxb(c.b,c.a);hEb(c.c,(Aab(),dbb,'REFINAR '));hEb(c.a,(Aab(),dbb,'NOVA'));sxb(c.c,'icon-refine');sxb(c.a,'icon-new');lw(c,c.b);return c;}
function n_(){}
...
function aab(c,b,a){F_(c);c.a=oxb(new zwb(),'',b);c.b=oxb(new zwb(),'',a);bxb(c.c,c.a);bxb(c.c,c.b);nzb(c.c,'searchButtonsPanel');hEb(c.a,(Aab(),dbb,'Pesquisar'));hEb(c.b,(Aab(),dbb,'Limpar'));sxb(c.a,'icon-search');sxb(c.b,'icon-clear');lw(c,c.c);return c;}
function E_(){}
...
function Bab(d){var a,b,c;if(d.h!==null){yJb(d.p,d.h);}d.h=iKb(new cKb(),2);a=d.h.b;if(d.a.h){um(pyb(a),'height',d.a.l);}hEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");Exb(d.h,710,d.f);qJb(d.p,d.h);if(d.a.h){um(ul(pyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=sJb(d.p,c).b;um(pyb(b),'height',d.a.l);}}}
...
function Dab(d,b){var a,c;qLb(d.h.b,b);hEb(d.h,'Pormenor');BJb(d.p,d.h);if(d.a.h){um(ul(pyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=sJb(d.p,c).b;um(pyb(a),'height',d.a.l);}}}
...
function pOb(){}
_=pOb.prototype=new keb();_.tN=iQb+'DateLocale_pt_PT';_.tI=348;function wOb(a,b){return yjb(new wjb(),ekb(a),akb(a),Cjb(a)+b);}
