...
/* The Original Code is BDD7CA375478588C2AD45CF805A8E4F4.cache.js
 * The Initial Developer of the Original Code is IAAA.
 *
 * Created on Mon Feb 08 16:35:56 CET 2010 
 */
...
function ph(b){var a,c;a=Bk(fnb(b.a,'ampms'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['vorm.','nachm.']);hnb(b.a,'ampms',c);return c;}else return a;}
function rh(b){var a,c;a=Bk(fnb(b.a,'eraNames'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['v. Chr.','n. Chr.']);hnb(b.a,'eraNames',c);return c;}else return a;}
function sh(b){var a,c;a=Bk(fnb(b.a,'eras'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['v. Chr.','n. Chr.']);hnb(b.a,'eras',c);return c;}else return a;}
function th(b){var a,c;a=Bk(fnb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);hnb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(fnb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);hnb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(fnb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);hnb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(fnb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['So','Mo','Di','Mi','Do','Fr','Sa']);hnb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(fnb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);hnb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(fnb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['S','M','D','M','D','F','S']);hnb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(fnb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);hnb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(fnb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['So','Mo','Di','Mi','Do','Fr','Sa']);hnb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(fnb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);hnb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(fnb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);hnb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new pfb();_.tN=kQb+'DateTimeConstants_de_CH';_.tI=28;function gk(){return null;}
...
function tDb(b,a){vDb();mJb(b,a);b.c=gyb(new ayb(),67108864);if((a&16777216)!=0){wDb(b,0,'OK');}if((a&67108864)!=0){wDb(b,0,'OK');wDb(b,1,'Abbrechen');}if((a&268435456)!=0){wDb(b,2,'Ja');wDb(b,3,'Nein');}if((a&1073741824)!=0){wDb(b,2,'Ja');wDb(b,3,'Nein');wDb(b,1,'Abbrechen');}return b;}
...
function vPb(){}
_=vPb.prototype=new pfb();_.tN=pRb+'DateLocale_de_CH';_.tI=348;function CPb(a,b){return Ekb(new Ckb(),klb(a),glb(a),clb(a)+b);}
