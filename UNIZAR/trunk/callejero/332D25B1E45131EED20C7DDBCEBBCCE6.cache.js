...
/* The Original Code is 332D25B1E45131EED20C7DDBCEBBCCE6.cache.js
...
function ef(b){var a,c;a=ri(nmb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['vorm.','nachm.']);pmb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(nmb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['v. Chr.','n. Chr.']);pmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(nmb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['v. Chr.','n. Chr.']);pmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(nmb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);pmb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(nmb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);pmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(nmb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);pmb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(nmb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['So','Mo','Di','Mi','Do','Fr','Sa']);pmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(nmb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);pmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(nmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['S','M','D','M','D','F','S']);pmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(nmb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);pmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(nmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['So','Mo','Di','Mi','Do','Fr','Sa']);pmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(nmb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);pmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(nmb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);pmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new yeb();_.tN=pPb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function BCb(b,a){DCb();uIb(b,a);b.c=oxb(new ixb(),67108864);if((a&16777216)!=0){ECb(b,0,'OK');}if((a&67108864)!=0){ECb(b,0,'OK');ECb(b,1,'Abbrechen');}if((a&268435456)!=0){ECb(b,2,'Ja');ECb(b,3,'Nein');}if((a&1073741824)!=0){ECb(b,2,'Ja');ECb(b,3,'Nein');ECb(b,1,'Abbrechen');}return b;}
...
function DOb(){}
_=DOb.prototype=new yeb();_.tN=wQb+'DateLocale_de_CH';_.tI=350;function ePb(a,b){return gkb(new ekb(),skb(a),okb(a),kkb(a)+b);}
