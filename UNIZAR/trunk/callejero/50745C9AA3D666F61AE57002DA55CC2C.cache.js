...
/* The Original Code is 50745C9AA3D666F61AE57002DA55CC2C.cache.js
...
function gf(b){var a,c;a=ri(nmb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['a.C.','d.C.']);pmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(nmb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['a.C.','d.C.']);pmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(nmb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);pmb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(nmb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);pmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(nmb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);pmb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(nmb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);pmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(nmb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);pmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(nmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['D','S','T','Q','Q','S','S']);pmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(nmb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);pmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(nmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);pmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(nmb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);pmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(nmb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);pmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new yeb();_.tN=pPb+'DateTimeConstants_pt_BR';_.tI=18;function Ch(){return null;}
...
function bU(d,a,b,c){if(wfb(a,'viewDetails'))qV(d.a,b,c);else{q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'Comportamento n\xE3o definido'),(ibb(),rbb,'Aceitar'),null,null,null);}}
...
function iT(){}
_=iT.prototype=new yeb();_.tN=FPb+'AVOFilterBuilder';_.tI=152;_.c=null;_.d='CONTAINS WORD';_.g=false;function vT(e,a,f,c){var b,d;b=null;if(vfb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(vfb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(vfb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(vfb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(vfb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(vfb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(vfb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!vfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(ibb(),rbb,'Aceitar'),null,null,null);}return b;}
function wT(e,b,d,c){var a;a=null;if(vfb(c,e.c)){a=e.b+b+d+e.a;}else if(vfb(c,e.gb)){a=e.fb+b+d+e.eb;}else{q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(ibb(),rbb,'Aceitar'),null,null,null);}return a;}
...
function iU(){}
_=iU.prototype=new yeb();_.tN=bQb+'CriterionsListElement';_.tI=156;_.a=null;_.b=null;function EU(a){a.p=eW(new zV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=ijb(new gjb());a.g=ijb(new gjb());a.a=ijb(new gjb());a.c=sFb(new nFb(),(ibb(),rbb,'Pesquisando...'));}
...
function gV(e,b,d,c){var a;if(e.h.p){DIb(e.c);}a=yU(new xU(),e,b,d);jbb(e.k);if(e.h.q){iW(e.p,b.a,a5(b),e.m.a,d,(ibb(),rbb,'pt'),a);}else{fV(e,b,e.m.a,d,(ibb(),rbb,'pt'));}}
...
function wV(a,c,b){if(b!==null&& !wfb(b.c,'')){pV(this,a,c);mV(this,this,true,b);}else{q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(ibb(),rbb,'Aceitar'),null,null,null);}}
function pU(){}
...
function tU(b,a){if(b.a.h.p){zIb(b.a.c);}q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'N\xE3o se p\xF4de ligar com o servidor'),(ibb(),rbb,'Aceitar'),null,null,null);}
function uU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&Afb(e.c)>0){c='';try{if(zO(xV,e.c)!==null&&Afb(zO(xV,e.c))>0){c=zO(xV,e.c);}else{c=v3((ibb(),rbb),e.c);}if(vfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,40)){a;c=e.d;}else throw a;}q7((ibb(),rbb,'ERRO'),c,(ibb(),rbb,'Aceitar'),null,null,null);}else{rV(f.b,e);}if(f.a.h.p){zIb(f.a.c);}}
...
function AU(b,a){if(b.a.h.p){zIb(b.a.c);}q7((ibb(),rbb,'ERRO'),(ibb(),rbb,'N\xE3o se p\xF4de ligar com o servidor')+': '+Agb(a),(ibb(),rbb,'Aceitar'),null,null,null);}
...
function B0(d,a){var b,c;w$(d,a);A0(d);d.b=null.ch;x$(d,d);Bw(d.e,d);w4(d.j,'mapa',d.a);if(null.ch==true){if(null.ch){d.g=fCb(new mBb(),192,'my-cpanel-small');if(null.ch){lCb(d.g,false);}}else{d.g=fCb(new mBb(),128,'my-cpanel-small');}oCb(d.g,null.ch);nyb(d.g,'criterionContentPanel');}else{d.g=fCb(new mBb(),0,'internal-compound-cpanel-small');nyb(d.g,'internalCompoundCriterionContentPanel');}d.d.qg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',356,15,[])));nb(c,null.ch);if(null.ch!=NaN&&null.ch!=NaN&&null.ch!=NaN&&null.ch!=NaN){d.a=fT(new eT(),d.b,(ibb(),rbb,'pt'),null.ch,null.ch,null.ch,null.ch,null.ch,pgb(null.ch),pgb(null.ch));}else{d.a=gT(new eT(),d.b,(ibb(),rbb,'pt'),pgb(null.ch),pgb(null.ch));}CJ(d.d,8);qu(d.d,d.a);if(null.ch==true){d.k=nv(new kv(),' '+(ibb(),rbb,'Usar mapa'));d.k.bc(u0(new t0(),d));vK(d.i,d.k);if(null.ch){qv(d.k,true);}else{qv(d.k,false);hS(d.a);}if(null.ch){D0(d);}if(null.ch){d.wg(false);}}vF(d.e,d.d);vK(d.i,d.e);mCb(d.g,'icon-text');d.i.fc('criterionPanel');ELb(d.g,d.i);if(null.ch){b=new x0();d.h=Cxb(new hxb(),(ibb(),rbb,'Nomenclatura'),b);vzb(d.h,false);Bzb(d.h,'coordinatesCCBGazetteerButton');ELb(d.g,d.h);}nw(d,d.g);return d;}
...
function t0(){}
_=t0.prototype=new yeb();_.oe=w0;_.tN=dQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=181;function z0(a){yo((ibb(),qbb,''),(ibb(),rbb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function x0(){}
...
function v3(d,b){var a,c;c=ri(nmb(d.a,b),1);if(c!==null)return c;if(wfb(b,'OuterServiceException')){a='Outer service reported an exception';pmb(d.a,'OuterServiceException',a);return a;}if(wfb(b,'UnableToInitIndex')){a='Unable to init an index';pmb(d.a,'UnableToInitIndex',a);return a;}if(wfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';pmb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(wfb(b,'usarMapa')){a='Usar mapa';pmb(d.a,'usarMapa',a);return a;}if(wfb(b,'hasta')){a='a';pmb(d.a,'hasta',a);return a;}if(wfb(b,'resultados')){a='Resultados';pmb(d.a,'resultados',a);return a;}if(wfb(b,'valueErrors')){a='Error entering search criteria';pmb(d.a,'valueErrors',a);return a;}if(wfb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';pmb(d.a,'ningunCriterioIntroducido',a);return a;}if(wfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';pmb(d.a,'requiredCriterionError',a);return a;}if(wfb(b,'gazetteerTitle')){a='Nomenclatura';pmb(d.a,'gazetteerTitle',a);return a;}if(wfb(b,'sourceURLTitle')){a='URL';pmb(d.a,'sourceURLTitle',a);return a;}if(wfb(b,'UnknownFaliure')){a='Unknown service failure';pmb(d.a,'UnknownFaliure',a);return a;}if(wfb(b,'okButtonLabel')){a='Aceitar';pmb(d.a,'okButtonLabel',a);return a;}if(wfb(b,'nuevaBusqueda')){a='NOVA';pmb(d.a,'nuevaBusqueda',a);return a;}if(wfb(b,'refinar')){a='REFINAR ';pmb(d.a,'refinar',a);return a;}if(wfb(b,'newSourceTitle')){a='New source';pmb(d.a,'newSourceTitle',a);return a;}if(wfb(b,'anterior')){a='Anterior';pmb(d.a,'anterior',a);return a;}if(wfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";pmb(d.a,'UnableToReadSourceResponse',a);return a;}if(wfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';pmb(d.a,'UnableToSynchroniseSource',a);return a;}if(wfb(b,'siguiente')){a='Seguinte';pmb(d.a,'siguiente',a);return a;}if(wfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';pmb(d.a,'UnsupportedEncoding',a);return a;}if(wfb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';pmb(d.a,'connection_error',a);return a;}if(wfb(b,'limpiar')){a='Limpar';pmb(d.a,'limpiar',a);return a;}if(wfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';pmb(d.a,'NoReachableOuterService',a);return a;}if(wfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';pmb(d.a,'UnableToRemoveFromIndex',a);return a;}if(wfb(b,'sourcesListTitle')){a='Fontes dispon\xEDveis';pmb(d.a,'sourcesListTitle',a);return a;}if(wfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';pmb(d.a,'UnableToInitSource',a);return a;}if(wfb(b,'ayuda')){a='Ajuda';pmb(d.a,'ayuda',a);return a;}if(wfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";pmb(d.a,'NoReachableRDF',a);return a;}if(wfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';pmb(d.a,'UnableToPerformInsertion',a);return a;}if(wfb(b,'deUnTotalDe')){a='de um total de';pmb(d.a,'deUnTotalDe',a);return a;}if(wfb(b,'invalidDate')){a='Invalid date';pmb(d.a,'invalidDate',a);return a;}if(wfb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';pmb(d.a,'sinResultados',a);return a;}if(wfb(b,'aceptar')){a='Aceitar';pmb(d.a,'aceptar',a);return a;}if(wfb(b,'buscar')){a='Pesquisar';pmb(d.a,'buscar',a);return a;}if(wfb(b,'ResultList_Title')){a='Lista de resultados';pmb(d.a,'ResultList_Title',a);return a;}if(wfb(b,'buscando')){a='Pesquisando...';pmb(d.a,'buscando',a);return a;}if(wfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';pmb(d.a,'NoReachablePool',a);return a;}if(wfb(b,'sourceTypeTitle')){a='Type';pmb(d.a,'sourceTypeTitle',a);return a;}if(wfb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';pmb(d.a,'SearchInfo_Title',a);return a;}if(wfb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';pmb(d.a,'undefinedBehaviour',a);return a;}if(wfb(b,'detalle')){a='Pormenor';pmb(d.a,'detalle',a);return a;}if(wfb(b,'error')){a='ERRO';pmb(d.a,'error',a);return a;}if(wfb(b,'loading')){a='Carregando...';pmb(d.a,'loading',a);return a;}if(wfb(b,'resultComponentVoid')){a='-';pmb(d.a,'resultComponentVoid',a);return a;}if(wfb(b,'busquedaAnterior')){a='ANTERIOR';pmb(d.a,'busquedaAnterior',a);return a;}if(wfb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';pmb(d.a,'wrongSourceDescriptionFile',a);return a;}if(wfb(b,'locale')){a='pt';pmb(d.a,'locale',a);return a;}if(wfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";pmb(d.a,'NotAValidQuery',a);return a;}if(wfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';pmb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw hnb(new gnb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function r3(){}
_=r3.prototype=new yeb();_.tN=fQb+'Messages_pt';_.tI=186;function x3(a){a.a=ijb(new gjb());}
...
function e_(j,h){var a,b,c,d,e,f,g,i;nz(j.c);f=tnb(new snb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=x8(new w8());sC(d,'<<');oC(d,j);z8(ri(d,54),1+j.a*j.d-j.d);}else{d=mC(new lC());sC(d,' ');}d.fc('navigationArrowsLeft');vnb(f,d);if(h.b!=0){b=x8(new w8());sC(b,(ibb(),rbb,'Anterior'));oC(b,j);z8(ri(b,54),j.f-1);}else{b=mC(new lC());sC(b,' ');}b.fc('navigationPrevious');vnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=Fdb(h.f/j.g);e++){g=x8(new w8());if(e==j.f){g.fc('navigationCurrentPage');}else{oC(g,j);z8(g,e);}sC(g,''+e);vnb(f,g);}if(j.f<Fdb(h.f/j.g)){i=x8(new w8());sC(i,(ibb(),rbb,'Seguinte'));oC(i,j);z8(ri(i,54),j.f+1);}else{i=mC(new lC());sC(i,' ');}i.fc('navigationNext');vnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=x8(new w8());sC(c,'>>');oC(c,j);z8(ri(c,54),e);}else{c=mC(new lC());sC(c,' ');}c.fc('navigationArrowsRight');vnb(f,c);Ax(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){Dz(j.c,0,a,ri(xnb(f,a),55));}}
...
function D_(c,a,b){C_(c);c.c=Cxb(new hxb(),'',a);c.a=Cxb(new hxb(),'',b);pxb(c.b,c.c);pxb(c.b,c.a);vEb(c.c,(ibb(),rbb,'REFINAR '));vEb(c.a,(ibb(),rbb,'NOVA'));ayb(c.c,'icon-refine');ayb(c.a,'icon-new');nw(c,c.b);return c;}
function B_(){}
...
function oab(c,b,a){nab(c);c.a=Cxb(new hxb(),'',b);c.b=Cxb(new hxb(),'',a);pxb(c.c,c.a);pxb(c.c,c.b);Bzb(c.c,'searchButtonsPanel');vEb(c.a,(ibb(),rbb,'Pesquisar'));vEb(c.b,(ibb(),rbb,'Limpar'));ayb(c.a,'icon-search');ayb(c.b,'icon-clear');nw(c,c.c);return c;}
function mab(){}
...
function jbb(d){var a,b,c;if(d.h!==null){gKb(d.p,d.h);}d.h=wKb(new qKb(),2);a=d.h.b;if(d.a.h){um(Dyb(a),'height',d.a.l);}vEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");myb(d.h,710,d.f);EJb(d.p,d.h);if(d.a.h){um(ul(Dyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=aKb(d.p,c).b;um(Dyb(b),'height',d.a.l);}}}
function kbb(g,d){var a,b,c,e,f;myb(g.p,600,Eab(new Dab(),g));e=wKb(new qKb(),0);if(nmb(g.n,d.c)!==null){f=bKb(g.p,ri(nmb(g.n,d.c),62));gKb(g.p,ri(nmb(g.n,d.c),62));if(d.g!==null&& !wfb(d.g,'')){vEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{vEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Resultados");}Bzb(e,'resultsTabItem');a=e.b;vGb(a,true);if(g.a.h){um(Dyb(a),'height',g.a.l);}pmb(g.n,d.c,e);cKb(g.p,ri(nmb(g.n,d.c),62),f);jKb(g.p,e);}else{if(d.g!==null&& !wfb(d.g,'')){vEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{vEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Resultados");}Bzb(e,'resultsTabItem');a=e.b;vGb(a,true);if(g.a.h){um(Dyb(a),'height',g.a.l);}pmb(g.n,d.c,e);EJb(g.p,ri(nmb(g.n,d.c),62));}pmb(g.d,Fyb(e),dcb(new bcb(),false));jKb(g.p,ri(nmb(g.n,d.c),62));if(g.a.h){um(ul(Dyb(g.p),1),'height',g.a.l);for(c=0;c<g.p.B.b;c++){b=aKb(g.p,c).b;um(Dyb(b),'height',g.a.l);}}}
function lbb(d,b){var a,c;ELb(d.h.b,b);vEb(d.h,'Pormenor');jKb(d.p,d.h);if(d.a.h){um(ul(Dyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=aKb(d.p,c).b;um(Dyb(a),'height',d.a.l);}}}
function mbb(g,c,d){var a,b,e,f;e=ri(nmb(g.n,d.c),62);pmb(g.c,Fyb(e),c);myb(e,8,cbb(new bbb(),g));if(d.g!==null&& !wfb(d.g,'')){vEb(ri(nmb(g.n,d.c),62),d.g);}else{vEb(ri(nmb(g.n,d.c),62),'Resultados');}if(g.o==false||g.p.d.eQ(nmb(g.n,d.c))){g.o=true;jKb(g.p,g.i);f=bKb(g.p,ri(nmb(g.n,d.c),62));fMb(aKb(g.p,f).b);ELb(aKb(g.p,f).b,c);if(g.a.h){xzb(aKb(g.p,f),g.a.l);um(ul(Dyb(g.p),1),'height',g.a.l);for(b=0;b<g.p.B.b;b++){a=aKb(g.p,b).b;um(Dyb(a),'height',g.a.l);}}pmb(g.d,Fyb(e),dcb(new bcb(),true));jKb(g.p,ri(nmb(g.n,d.c),62));}}
...
function DOb(){}
_=DOb.prototype=new yeb();_.tN=wQb+'DateLocale_pt_BR';_.tI=350;function ePb(a,b){return gkb(new ekb(),skb(a),okb(a),kkb(a)+b);}
