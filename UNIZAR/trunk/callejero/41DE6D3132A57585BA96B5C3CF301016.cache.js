...
/* The Original Code is 41DE6D3132A57585BA96B5C3CF301016.cache.js
...
function th(b){var a,c;a=Dk(hnb(b.a,'eraNames'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['a.C.','d.C.']);jnb(b.a,'eraNames',c);return c;}else return a;}
function uh(b){var a,c;a=Dk(hnb(b.a,'eras'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['a.C.','d.C.']);jnb(b.a,'eras',c);return c;}else return a;}
function vh(b){var a,c;a=Dk(hnb(b.a,'months'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);jnb(b.a,'months',c);return c;}else return a;}
...
function xh(b){var a,c;a=Dk(hnb(b.a,'quarters'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);jnb(b.a,'quarters',c);return c;}else return a;}
function yh(b){var a,c;a=Dk(hnb(b.a,'shortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);jnb(b.a,'shortMonths',c);return c;}else return a;}
...
function Ah(b){var a,c;a=Dk(hnb(b.a,'shortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);jnb(b.a,'shortWeekdays',c);return c;}else return a;}
function Bh(b){var a,c;a=Dk(hnb(b.a,'standaloneMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);jnb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Dh(b){var a,c;a=Dk(hnb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['D','S','T','Q','Q','S','S']);jnb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Dk(hnb(b.a,'standaloneShortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);jnb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Fh(b){var a,c;a=Dk(hnb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);jnb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function ai(b){var a,c;a=Dk(hnb(b.a,'standaloneWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);jnb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function bi(b){var a,c;a=Dk(hnb(b.a,'weekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);jnb(b.a,'weekdays',c);return c;}else return a;}
function oh(){}
_=oh.prototype=new rfb();_.tN=oQb+'DateTimeConstants_pt_PT';_.tI=28;function ik(){return null;}
...
function uU(d,a,b,c){if(pgb(a,'viewDetails'))dW(d.a,b,c);else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'Comportamento n\xE3o definido'),(bcb(),kcb,'Aceitar'),null,null,null);}}
...
function BT(){}
_=BT.prototype=new rfb();_.tN=CQb+'AVOFilterBuilder';_.tI=148;_.c=null;_.d='CONTAINS WORD';_.g=false;function iU(e,a,f,c){var b,d;b=null;if(ogb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(ogb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(ogb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(ogb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(ogb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(ogb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(ogb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!ogb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(bcb(),kcb,'Aceitar'),null,null,null);}return b;}
function jU(e,b,d,c){var a;a=null;if(ogb(c,e.c)){a=e.b+b+d+e.a;}else if(ogb(c,e.eb)){a=e.db+b+d+e.cb;}else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(bcb(),kcb,'Aceitar'),null,null,null);}return a;}
...
function BU(){}
_=BU.prototype=new rfb();_.tN=EQb+'CriterionsListElement';_.tI=152;_.a=null;_.b=null;function rV(a){a.p=xW(new mW());a.j=a.p;a.n=le()+'SearchControllerServer';a.e=ckb(new akb());a.g=ckb(new akb());a.a=ckb(new akb());a.c=oGb(new jGb(),(bcb(),kcb,'Pesquisando...'));}
...
function zV(e,b,d,c){var a;if(e.h.p){zJb(e.c);}a=lV(new kV(),e,b,d);ccb(e.k);if(e.h.q){BW(e.p,b.a,t5(b),e.m.a,d,(bcb(),kcb,'pt'),a);}else{yV(e,b,e.m.a,d,(bcb(),kcb,'pt'));}}
...
function DV(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=i7(new F6());t=new gY();e=udb(jj(s,'totalLength').tS());r7(q,ndb(e));o7(q,C8(jj(s,'queryErrorCode').Cd().a));p7(q,C8(jj(s,'queryErrorMessage').Cd().a));if(q.c!==null&&tgb(q.c)>0){g='';try{if(FQ(kW,q.c)!==null&&tgb(FQ(kW,q.c))>0){g=FQ(kW,q.c);}else{g=i4((bcb(),kcb),q.c);}if(ogb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=jl(a);if(Ek(a,41)){a;g=q.d;}else throw a;}d8((bcb(),kcb,'ERRO'),g,(bcb(),kcb,'Aceitar'),null,null,null);}else{jY(t,jj(s,'initiallySelectedSource').Ad().a);kY(t,C8(jj(s,'sourceName').Cd().a));lY(t,C8(jj(s,'sourceRDF').Cd().a));oY(t,C8(jj(s,'sourceTitle').Cd().a));qY(t,jj(s,'useSourceRDF').Ad().a);pY(t,jj(s,'useRDFMetadata').Ad().a);iY(t,jj(s,'createRDF').Ad().a);nY(t,C8(jj(s,'sourceServiceURL').Cd().a));mY(t,C8(jj(s,'sourceServiceType').Cd().a));for(h=0;h<li(r);h++){p=b7(new a7());o=hi(r,h);n=di(new ci());if((n=o.yd())!==null){k=hi(n,0).Bd();u5(p.a,C8(jj(k,'fileIdentifier').Cd().a));v5(p.a,C8(jj(k,'metadataLanguage').Cd().a));m=ckb(new akb());d=hi(n,1);c=di(new ci());if((c=d.yd())!==null){for(i=0;i<li(c);i++){j=hi(c,i).Bd();l=new j6();o6(l,C8(jj(j,'text').Cd().a));l6(l,C8(jj(j,'alternativeText').Cd().a));f=udb(jj(j,'type').tS());q6(l,ndb(f));p6(l,C8(jj(j,'tooltip').Cd().a));m6(l,C8(jj(j,'condition').Cd().a));n6(l,C8(jj(j,'function').Cd().a));dkb(m,i,l);}}d7(p,m);}j7(q,p);}q7(q,t);n7(q,u.l);s7(q,u.r);if(u.h.p){vJb(u.c);}eW(u,q);}}
function FV(f,c,d,e){var a,b;if(f.h.s){b9(f.h.j,f.h.i);f.h.k.rg(true);}a=eV(new dV(),f,c);if(d){f.d=f.m.a;}else{f.d=BV(f);B7(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&tgb(f.d.a)>0){if(d){if(e!==null&& !pgb(e.c,'')){dcb(f.k,e);if(f.h.p){zJb(f.c);}if(f.h.q){CW(f.p,f.d,f.l,f.r,e,a);}else{EV(f,f.l,f.r,e);}}else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(bcb(),kcb,'Aceitar'),null,null,null);}}else{if(f.h.u){f.e=pcb(f.k.b);}for(b=0;b<f.e.b;b++){if(Dk(jkb(f.e,b),40)!==null&& !pgb(Dk(jkb(f.e,b),40).c,'')){dcb(f.k,Dk(jkb(f.e,b),40));if(f.h.p){zJb(f.c);}if(f.h.q){CW(f.p,f.d,f.l,f.r,Dk(jkb(f.e,b),40),a);}else{EV(f,f.l,f.r,Dk(jkb(f.e,b),40));}}else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Dk(jkb(f.e,b),40).c,(bcb(),kcb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&tgb(f.d.a)==0){e8(null,(bcb(),kcb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(bcb(),kcb,'Aceitar'),null,null,null);}}
...
function jW(a,c,b){if(b!==null&& !pgb(b.c,'')){cW(this,a,c);FV(this,this,true,b);}else{d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(bcb(),kcb,'Aceitar'),null,null,null);}}
function cV(){}
...
function gV(b,a){if(b.a.h.p){vJb(b.a.c);}d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'N\xE3o se p\xF4de ligar com o servidor'),(bcb(),kcb,'Aceitar'),null,null,null);}
function hV(f,d){var a,c,e;e=Dk(d,43);if(e.c!==null&&tgb(e.c)>0){c='';try{if(FQ(kW,e.c)!==null&&tgb(FQ(kW,e.c))>0){c=FQ(kW,e.c);}else{c=i4((bcb(),kcb),e.c);}if(ogb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=jl(a);if(Ek(a,41)){a;c=e.d;}else throw a;}d8((bcb(),kcb,'ERRO'),c,(bcb(),kcb,'Aceitar'),null,null,null);}else{eW(f.b,e);}if(f.a.h.p){vJb(f.a.c);}}
...
function nV(b,a){if(b.a.h.p){vJb(b.a.c);}d8((bcb(),kcb,'ERRO'),(bcb(),kcb,'N\xE3o se p\xF4de ligar com o servidor')+': '+uhb(a),(bcb(),kcb,'Aceitar'),null,null,null);}
...
function g1(){}
_=g1.prototype=new rfb();_.ie=j1;_.tN=aRb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=177;function m1(a){ar((bcb(),jcb,''),(bcb(),kcb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function k1(){}
...
function i4(d,b){var a,c;c=Dk(hnb(d.a,b),1);if(c!==null)return c;if(pgb(b,'OuterServiceException')){a='Outer service reported an exception';jnb(d.a,'OuterServiceException',a);return a;}if(pgb(b,'UnableToInitIndex')){a='Unable to init an index';jnb(d.a,'UnableToInitIndex',a);return a;}if(pgb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';jnb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(pgb(b,'usarMapa')){a='Usar mapa';jnb(d.a,'usarMapa',a);return a;}if(pgb(b,'hasta')){a='a';jnb(d.a,'hasta',a);return a;}if(pgb(b,'resultados')){a='Resultados';jnb(d.a,'resultados',a);return a;}if(pgb(b,'valueErrors')){a='Error entering search criteria';jnb(d.a,'valueErrors',a);return a;}if(pgb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';jnb(d.a,'ningunCriterioIntroducido',a);return a;}if(pgb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';jnb(d.a,'requiredCriterionError',a);return a;}if(pgb(b,'gazetteerTitle')){a='Nomenclatura';jnb(d.a,'gazetteerTitle',a);return a;}if(pgb(b,'sourceURLTitle')){a='URL';jnb(d.a,'sourceURLTitle',a);return a;}if(pgb(b,'UnknownFaliure')){a='Unknown service failure';jnb(d.a,'UnknownFaliure',a);return a;}if(pgb(b,'okButtonLabel')){a='Aceitar';jnb(d.a,'okButtonLabel',a);return a;}if(pgb(b,'nuevaBusqueda')){a='NOVA';jnb(d.a,'nuevaBusqueda',a);return a;}if(pgb(b,'refinar')){a='REFINAR ';jnb(d.a,'refinar',a);return a;}if(pgb(b,'newSourceTitle')){a='New source';jnb(d.a,'newSourceTitle',a);return a;}if(pgb(b,'anterior')){a='Anterior';jnb(d.a,'anterior',a);return a;}if(pgb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";jnb(d.a,'UnableToReadSourceResponse',a);return a;}if(pgb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';jnb(d.a,'UnableToSynchroniseSource',a);return a;}if(pgb(b,'siguiente')){a='Seguinte';jnb(d.a,'siguiente',a);return a;}if(pgb(b,'UnsupportedEncoding')){a='Unsupported Encoding';jnb(d.a,'UnsupportedEncoding',a);return a;}if(pgb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';jnb(d.a,'connection_error',a);return a;}if(pgb(b,'limpiar')){a='Limpar';jnb(d.a,'limpiar',a);return a;}if(pgb(b,'NoReachableOuterService')){a='Could not connect with the outer service';jnb(d.a,'NoReachableOuterService',a);return a;}if(pgb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';jnb(d.a,'UnableToRemoveFromIndex',a);return a;}if(pgb(b,'sourcesListTitle')){a='Sources list';jnb(d.a,'sourcesListTitle',a);return a;}if(pgb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';jnb(d.a,'UnableToInitSource',a);return a;}if(pgb(b,'ayuda')){a='Ajuda';jnb(d.a,'ayuda',a);return a;}if(pgb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";jnb(d.a,'NoReachableRDF',a);return a;}if(pgb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';jnb(d.a,'UnableToPerformInsertion',a);return a;}if(pgb(b,'deUnTotalDe')){a='de um total de';jnb(d.a,'deUnTotalDe',a);return a;}if(pgb(b,'invalidDate')){a='Invalid date';jnb(d.a,'invalidDate',a);return a;}if(pgb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';jnb(d.a,'sinResultados',a);return a;}if(pgb(b,'aceptar')){a='Aceitar';jnb(d.a,'aceptar',a);return a;}if(pgb(b,'buscar')){a='Pesquisar';jnb(d.a,'buscar',a);return a;}if(pgb(b,'ResultList_Title')){a='Lista de resultados';jnb(d.a,'ResultList_Title',a);return a;}if(pgb(b,'buscando')){a='Pesquisando...';jnb(d.a,'buscando',a);return a;}if(pgb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';jnb(d.a,'NoReachablePool',a);return a;}if(pgb(b,'sourceTypeTitle')){a='Type';jnb(d.a,'sourceTypeTitle',a);return a;}if(pgb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';jnb(d.a,'SearchInfo_Title',a);return a;}if(pgb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';jnb(d.a,'undefinedBehaviour',a);return a;}if(pgb(b,'detalle')){a='Pormenor';jnb(d.a,'detalle',a);return a;}if(pgb(b,'error')){a='ERRO';jnb(d.a,'error',a);return a;}if(pgb(b,'loading')){a='Carregando...';jnb(d.a,'loading',a);return a;}if(pgb(b,'resultComponentVoid')){a='-';jnb(d.a,'resultComponentVoid',a);return a;}if(pgb(b,'busquedaAnterior')){a='ANTERIOR';jnb(d.a,'busquedaAnterior',a);return a;}if(pgb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';jnb(d.a,'wrongSourceDescriptionFile',a);return a;}if(pgb(b,'locale')){a='pt';jnb(d.a,'locale',a);return a;}if(pgb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";jnb(d.a,'NotAValidQuery',a);return a;}if(pgb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';jnb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw bob(new aob(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function e4(){}
_=e4.prototype=new rfb();_.tN=cRb+'Messages_pt';_.tI=182;function k4(a){a.a=ckb(new akb());}
...
function wab(c,a,b){vab(c);c.c=yyb(new dyb(),'',a);c.a=yyb(new dyb(),'',b);lyb(c.b,c.c);lyb(c.b,c.a);rFb(c.c,(bcb(),kcb,'REFINAR '));rFb(c.a,(bcb(),kcb,'NOVA'));Cyb(c.c,'icon-refine');Cyb(c.a,'icon-new');az(c,c.b);return c;}
function uab(){}
...
function hbb(c,b,a){gbb(c);c.a=yyb(new dyb(),'',b);c.b=yyb(new dyb(),'',a);lyb(c.c,c.a);lyb(c.c,c.b);xAb(c.c,'searchButtonsPanel');rFb(c.a,(bcb(),kcb,'Pesquisar'));rFb(c.b,(bcb(),kcb,'Limpar'));Cyb(c.a,'icon-search');Cyb(c.b,'icon-clear');az(c,c.c);return c;}
function fbb(){}
...
function ccb(d){var a,b,c;if(d.h!==null){cLb(d.p,d.h);}d.h=sLb(new mLb(),2);a=d.h.b;if(d.a.h){cp(zzb(a),'height',d.a.l);}rFb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");izb(d.h,710,d.f);AKb(d.p,d.h);if(d.a.h){cp(bo(zzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=CKb(d.p,c).b;cp(zzb(b),'height',d.a.l);}}}
...
function ecb(d,b){var a,c;AMb(d.h.b,b);rFb(d.h,'Pormenor');fLb(d.p,d.h);if(d.a.h){cp(bo(zzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=CKb(d.p,c).b;cp(zzb(a),'height',d.a.l);}}}
...
function zPb(){}
_=zPb.prototype=new rfb();_.tN=tRb+'DateLocale_pt_PT';_.tI=348;function aQb(a,b){return alb(new Ekb(),mlb(a),ilb(a),elb(a)+b);}
