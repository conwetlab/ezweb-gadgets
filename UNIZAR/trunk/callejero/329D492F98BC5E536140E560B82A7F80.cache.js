...
/* The Original Code is 329D492F98BC5E536140E560B82A7F80.cache.js
...
function th(b){var a,c;a=Bk(fnb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);hnb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(fnb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);hnb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(fnb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);hnb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(fnb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);hnb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(fnb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);hnb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(fnb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['D','S','T','Q','Q','S','S']);hnb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(fnb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);hnb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(fnb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);hnb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(fnb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);hnb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(fnb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);hnb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new pfb();_.tN=kQb+'DateTimeConstants_pt_BR';_.tI=28;function gk(){return null;}
...
function sU(d,a,b,c){if(ngb(a,'viewDetails'))bW(d.a,b,c);else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'Comportamento n\xE3o definido'),(Fbb(),icb,'Aceitar'),null,null,null);}}
...
function zT(){}
_=zT.prototype=new pfb();_.tN=yQb+'AVOFilterBuilder';_.tI=149;_.c=null;_.d='CONTAINS WORD';_.g=false;function gU(e,a,f,c){var b,d;b=null;if(mgb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(mgb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(mgb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(mgb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(mgb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(mgb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(mgb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!mgb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(Fbb(),icb,'Aceitar'),null,null,null);}return b;}
function hU(e,b,d,c){var a;a=null;if(mgb(c,e.c)){a=e.b+b+d+e.a;}else if(mgb(c,e.gb)){a=e.fb+b+d+e.eb;}else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(Fbb(),icb,'Aceitar'),null,null,null);}return a;}
...
function zU(){}
_=zU.prototype=new pfb();_.tN=AQb+'CriterionsListElement';_.tI=153;_.a=null;_.b=null;function pV(a){a.p=vW(new kW());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=akb(new Ejb());a.g=akb(new Ejb());a.a=akb(new Ejb());a.c=kGb(new fGb(),(Fbb(),icb,'Pesquisando...'));}
...
function xV(e,b,d,c){var a;if(e.h.p){vJb(e.c);}a=jV(new iV(),e,b,d);acb(e.k);if(e.h.q){zW(e.p,b.a,r5(b),e.m.a,d,(Fbb(),icb,'pt'),a);}else{wV(e,b,e.m.a,d,(Fbb(),icb,'pt'));}}
...
function BV(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=g7(new D6());t=new eY();e=sdb(hj(s,'totalLength').tS());p7(q,ldb(e));m7(q,A8(hj(s,'queryErrorCode').ce().a));n7(q,A8(hj(s,'queryErrorMessage').ce().a));if(q.c!==null&&rgb(q.c)>0){g='';try{if(DQ(iW,q.c)!==null&&rgb(DQ(iW,q.c))>0){g=DQ(iW,q.c);}else{g=g4((Fbb(),icb),q.c);}if(mgb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=hl(a);if(Ck(a,41)){a;g=q.d;}else throw a;}b8((Fbb(),icb,'ERRO'),g,(Fbb(),icb,'Aceitar'),null,null,null);}else{hY(t,hj(s,'initiallySelectedSource').ae().a);iY(t,A8(hj(s,'sourceName').ce().a));jY(t,A8(hj(s,'sourceRDF').ce().a));mY(t,A8(hj(s,'sourceTitle').ce().a));oY(t,hj(s,'useSourceRDF').ae().a);nY(t,hj(s,'useRDFMetadata').ae().a);gY(t,hj(s,'createRDF').ae().a);lY(t,A8(hj(s,'sourceServiceURL').ce().a));kY(t,A8(hj(s,'sourceServiceType').ce().a));for(h=0;h<ji(r);h++){p=F6(new E6());o=fi(r,h);n=bi(new ai());if((n=o.Ed())!==null){k=fi(n,0).be();s5(p.a,A8(hj(k,'fileIdentifier').ce().a));t5(p.a,A8(hj(k,'metadataLanguage').ce().a));m=akb(new Ejb());d=fi(n,1);c=bi(new ai());if((c=d.Ed())!==null){for(i=0;i<ji(c);i++){j=fi(c,i).be();l=new h6();m6(l,A8(hj(j,'text').ce().a));j6(l,A8(hj(j,'alternativeText').ce().a));f=sdb(hj(j,'type').tS());o6(l,ldb(f));n6(l,A8(hj(j,'tooltip').ce().a));k6(l,A8(hj(j,'condition').ce().a));l6(l,A8(hj(j,'function').ce().a));bkb(m,i,l);}}b7(p,m);}h7(q,p);}o7(q,t);l7(q,u.l);q7(q,u.r);if(u.h.p){rJb(u.c);}cW(u,q);}}
function DV(f,c,d,e){var a,b;if(f.h.s){F8(f.h.j,f.h.i);f.h.k.xg(true);}a=cV(new bV(),f,c);if(d){f.d=f.m.a;}else{f.d=zV(f);z7(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&rgb(f.d.a)>0){if(d){if(e!==null&& !ngb(e.c,'')){bcb(f.k,e);if(f.h.p){vJb(f.c);}if(f.h.q){AW(f.p,f.d,f.l,f.r,e,a);}else{CV(f,f.l,f.r,e);}}else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(Fbb(),icb,'Aceitar'),null,null,null);}}else{if(f.h.u){f.e=ncb(f.k.b);}for(b=0;b<f.e.b;b++){if(Bk(hkb(f.e,b),40)!==null&& !ngb(Bk(hkb(f.e,b),40).c,'')){bcb(f.k,Bk(hkb(f.e,b),40));if(f.h.p){vJb(f.c);}if(f.h.q){AW(f.p,f.d,f.l,f.r,Bk(hkb(f.e,b),40),a);}else{CV(f,f.l,f.r,Bk(hkb(f.e,b),40));}}else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Bk(hkb(f.e,b),40).c,(Fbb(),icb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&rgb(f.d.a)==0){c8(null,(Fbb(),icb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(Fbb(),icb,'Aceitar'),null,null,null);}}
...
function hW(a,c,b){if(b!==null&& !ngb(b.c,'')){aW(this,a,c);DV(this,this,true,b);}else{b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(Fbb(),icb,'Aceitar'),null,null,null);}}
function aV(){}
...
function eV(b,a){if(b.a.h.p){rJb(b.a.c);}b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'N\xE3o se p\xF4de ligar com o servidor'),(Fbb(),icb,'Aceitar'),null,null,null);}
function fV(f,d){var a,c,e;e=Bk(d,43);if(e.c!==null&&rgb(e.c)>0){c='';try{if(DQ(iW,e.c)!==null&&rgb(DQ(iW,e.c))>0){c=DQ(iW,e.c);}else{c=g4((Fbb(),icb),e.c);}if(mgb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,41)){a;c=e.d;}else throw a;}b8((Fbb(),icb,'ERRO'),c,(Fbb(),icb,'Aceitar'),null,null,null);}else{cW(f.b,e);}if(f.a.h.p){rJb(f.a.c);}}
...
function lV(b,a){if(b.a.h.p){rJb(b.a.c);}b8((Fbb(),icb,'ERRO'),(Fbb(),icb,'N\xE3o se p\xF4de ligar com o servidor')+': '+shb(a),(Fbb(),icb,'Aceitar'),null,null,null);}
...
function e1(){}
_=e1.prototype=new pfb();_.oe=h1;_.tN=CQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=178;function k1(a){Eq((Fbb(),hcb,''),(Fbb(),icb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function i1(){}
...
function g4(d,b){var a,c;c=Bk(fnb(d.a,b),1);if(c!==null)return c;if(ngb(b,'OuterServiceException')){a='Outer service reported an exception';hnb(d.a,'OuterServiceException',a);return a;}if(ngb(b,'UnableToInitIndex')){a='Unable to init an index';hnb(d.a,'UnableToInitIndex',a);return a;}if(ngb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';hnb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(ngb(b,'usarMapa')){a='Usar mapa';hnb(d.a,'usarMapa',a);return a;}if(ngb(b,'hasta')){a='a';hnb(d.a,'hasta',a);return a;}if(ngb(b,'resultados')){a='Resultados';hnb(d.a,'resultados',a);return a;}if(ngb(b,'valueErrors')){a='Error entering search criteria';hnb(d.a,'valueErrors',a);return a;}if(ngb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';hnb(d.a,'ningunCriterioIntroducido',a);return a;}if(ngb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';hnb(d.a,'requiredCriterionError',a);return a;}if(ngb(b,'gazetteerTitle')){a='Nomenclatura';hnb(d.a,'gazetteerTitle',a);return a;}if(ngb(b,'sourceURLTitle')){a='URL';hnb(d.a,'sourceURLTitle',a);return a;}if(ngb(b,'UnknownFaliure')){a='Unknown service failure';hnb(d.a,'UnknownFaliure',a);return a;}if(ngb(b,'okButtonLabel')){a='Aceitar';hnb(d.a,'okButtonLabel',a);return a;}if(ngb(b,'nuevaBusqueda')){a='NOVA';hnb(d.a,'nuevaBusqueda',a);return a;}if(ngb(b,'refinar')){a='REFINAR ';hnb(d.a,'refinar',a);return a;}if(ngb(b,'newSourceTitle')){a='New source';hnb(d.a,'newSourceTitle',a);return a;}if(ngb(b,'anterior')){a='Anterior';hnb(d.a,'anterior',a);return a;}if(ngb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";hnb(d.a,'UnableToReadSourceResponse',a);return a;}if(ngb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';hnb(d.a,'UnableToSynchroniseSource',a);return a;}if(ngb(b,'siguiente')){a='Seguinte';hnb(d.a,'siguiente',a);return a;}if(ngb(b,'UnsupportedEncoding')){a='Unsupported Encoding';hnb(d.a,'UnsupportedEncoding',a);return a;}if(ngb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';hnb(d.a,'connection_error',a);return a;}if(ngb(b,'limpiar')){a='Limpar';hnb(d.a,'limpiar',a);return a;}if(ngb(b,'NoReachableOuterService')){a='Could not connect with the outer service';hnb(d.a,'NoReachableOuterService',a);return a;}if(ngb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';hnb(d.a,'UnableToRemoveFromIndex',a);return a;}if(ngb(b,'sourcesListTitle')){a='Sources list';hnb(d.a,'sourcesListTitle',a);return a;}if(ngb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';hnb(d.a,'UnableToInitSource',a);return a;}if(ngb(b,'ayuda')){a='Ajuda';hnb(d.a,'ayuda',a);return a;}if(ngb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";hnb(d.a,'NoReachableRDF',a);return a;}if(ngb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';hnb(d.a,'UnableToPerformInsertion',a);return a;}if(ngb(b,'deUnTotalDe')){a='de um total de';hnb(d.a,'deUnTotalDe',a);return a;}if(ngb(b,'invalidDate')){a='Invalid date';hnb(d.a,'invalidDate',a);return a;}if(ngb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';hnb(d.a,'sinResultados',a);return a;}if(ngb(b,'aceptar')){a='Aceitar';hnb(d.a,'aceptar',a);return a;}if(ngb(b,'buscar')){a='Pesquisar';hnb(d.a,'buscar',a);return a;}if(ngb(b,'ResultList_Title')){a='Lista de resultados';hnb(d.a,'ResultList_Title',a);return a;}if(ngb(b,'buscando')){a='Pesquisando...';hnb(d.a,'buscando',a);return a;}if(ngb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';hnb(d.a,'NoReachablePool',a);return a;}if(ngb(b,'sourceTypeTitle')){a='Type';hnb(d.a,'sourceTypeTitle',a);return a;}if(ngb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';hnb(d.a,'SearchInfo_Title',a);return a;}if(ngb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';hnb(d.a,'undefinedBehaviour',a);return a;}if(ngb(b,'detalle')){a='Pormenor';hnb(d.a,'detalle',a);return a;}if(ngb(b,'error')){a='ERRO';hnb(d.a,'error',a);return a;}if(ngb(b,'loading')){a='Carregando...';hnb(d.a,'loading',a);return a;}if(ngb(b,'resultComponentVoid')){a='-';hnb(d.a,'resultComponentVoid',a);return a;}if(ngb(b,'busquedaAnterior')){a='ANTERIOR';hnb(d.a,'busquedaAnterior',a);return a;}if(ngb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';hnb(d.a,'wrongSourceDescriptionFile',a);return a;}if(ngb(b,'locale')){a='pt';hnb(d.a,'locale',a);return a;}if(ngb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";hnb(d.a,'NotAValidQuery',a);return a;}if(ngb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';hnb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw Fnb(new Enb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function c4(){}
_=c4.prototype=new pfb();_.tN=EQb+'Messages_pt';_.tI=183;function i4(a){a.a=akb(new Ejb());}
...
function B_(j,h){var a,b,c,d,e,f,g,i;rB(j.c);f=lob(new kob());j.h=h.e;j.f=Fk((h.g+1)/j.g);j.a=Fk((j.f-1)/j.d);if(j.a!=0){d=h9(new g9());wE(d,'<<');sE(d,j);j9(Bk(d,55),1+j.a*j.d-j.d);}else{d=qE(new pE());wE(d,' ');}d.fc('navigationArrowsLeft');nob(f,d);if(h.b!=0){b=h9(new g9());wE(b,(Fbb(),icb,'Anterior'));sE(b,j);j9(Bk(b,55),j.f-1);}else{b=qE(new pE());wE(b,' ');}b.fc('navigationPrevious');nob(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=web(h.f/j.g);e++){g=h9(new g9());if(e==j.f){g.fc('navigationCurrentPage');}else{sE(g,j);j9(g,e);}wE(g,''+e);nob(f,g);}if(j.f<web(h.f/j.g)){i=h9(new g9());wE(i,(Fbb(),icb,'Seguinte'));sE(i,j);j9(Bk(i,55),j.f+1);}else{i=qE(new pE());wE(i,' ');}i.fc('navigationNext');nob(f,i);if((j.a+1)*j.g*j.d<h.f){c=h9(new g9());wE(c,'>>');sE(c,j);j9(Bk(c,55),e);}else{c=qE(new pE());wE(c,' ');}c.fc('navigationArrowsRight');nob(f,c);Ez(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){bC(j.c,0,a,Bk(pob(f,a),56));}}
...
function uab(c,a,b){tab(c);c.c=uyb(new Fxb(),'',a);c.a=uyb(new Fxb(),'',b);hyb(c.b,c.c);hyb(c.b,c.a);nFb(c.c,(Fbb(),icb,'REFINAR '));nFb(c.a,(Fbb(),icb,'NOVA'));yyb(c.c,'icon-refine');yyb(c.a,'icon-new');vy(c,c.b);return c;}
function sab(){}
...
function fbb(c,b,a){ebb(c);c.a=uyb(new Fxb(),'',b);c.b=uyb(new Fxb(),'',a);hyb(c.c,c.a);hyb(c.c,c.b);tAb(c.c,'searchButtonsPanel');nFb(c.a,(Fbb(),icb,'Pesquisar'));nFb(c.b,(Fbb(),icb,'Limpar'));yyb(c.a,'icon-search');yyb(c.b,'icon-clear');vy(c,c.c);return c;}
function dbb(){}
...
function acb(d){var a,b,c;if(d.h!==null){EKb(d.p,d.h);}d.h=oLb(new iLb(),2);a=d.h.b;if(d.a.h){ap(vzb(a),'height',d.a.l);}nFb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");ezb(d.h,710,d.f);wKb(d.p,d.h);if(d.a.h){ap(Fn(vzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=yKb(d.p,c).b;ap(vzb(b),'height',d.a.l);}}}
...
function ccb(d,b){var a,c;wMb(d.h.b,b);nFb(d.h,'Pormenor');bLb(d.p,d.h);if(d.a.h){ap(Fn(vzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=yKb(d.p,c).b;ap(vzb(a),'height',d.a.l);}}}
...
function vPb(){}
_=vPb.prototype=new pfb();_.tN=pRb+'DateLocale_pt_BR';_.tI=348;function CPb(a,b){return Ekb(new Ckb(),klb(a),glb(a),clb(a)+b);}
