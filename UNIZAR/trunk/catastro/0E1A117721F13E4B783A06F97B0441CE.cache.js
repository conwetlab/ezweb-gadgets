...
/* The Original Code is 0E1A117721F13E4B783A06F97B0441CE.cache.js
...
function gf(b){var a,c;a=ri(xpb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['av. J.-C.','ap. J.-C.']);zpb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(xpb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['av. J.-C.','apr. J.-C.']);zpb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(xpb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);zpb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(xpb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);zpb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(xpb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);zpb(b.a,'shortMonths',c);return c;}else return a;}
function nf(b){var a,c;a=ri(xpb(b.a,'shortQuarters'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['T1','T2','T3','T4']);zpb(b.a,'shortQuarters',c);return c;}else return a;}
function of(b){var a,c;a=ri(xpb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);zpb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(xpb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);zpb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(xpb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['D','L','M','M','J','V','S']);zpb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(xpb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);zpb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(xpb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);zpb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(xpb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);zpb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(xpb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);zpb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new Fhb();_.tN=zSb+'DateTimeConstants_fr_CA';_.tI=18;function Ch(){return null;}
...
function sW(d,a,b,c){if(Dib(a,'viewDetails'))cY(d.a,b,c);else{s$((meb(),veb,'ERREUR'),(meb(),veb,'Comportement non d\xE9fini'),(meb(),veb,'Accepter'),null,null,null);}}
...
function zV(){}
_=zV.prototype=new Fhb();_.tN=jTb+'AVOFilterBuilder';_.tI=161;_.c=null;_.d='CONTAINS WORD';_.g=false;function gW(e,a,f,c){var b,d;b=null;if(Cib(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(Cib(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(Cib(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(Cib(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(Cib(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(Cib(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(Cib(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!Cib(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{s$((meb(),veb,'ERREUR'),(meb(),veb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(meb(),veb,'Accepter'),null,null,null);}return b;}
function hW(e,b,d,c){var a;a=null;if(Cib(c,e.c)){a=e.b+b+d+e.a;}else if(Cib(c,e.eb)){a=e.db+b+d+e.cb;}else{s$((meb(),veb,'ERREUR'),(meb(),veb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(meb(),veb,'Accepter'),null,null,null);}return a;}
...
function zW(){}
_=zW.prototype=new Fhb();_.tN=lTb+'CriterionsListElement';_.tI=165;_.a=null;_.b=null;function pX(a){a.p=wY(new lY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=pmb(new nmb());a.g=pmb(new nmb());a.a=pmb(new nmb());a.c=CIb(new xIb(),(meb(),veb,'Recherche en cours\u2026'));}
...
function xX(e,b,d,c){var a;if(e.h.p){hMb(e.c);}a=jX(new iX(),e,b,d);neb(e.k);if(e.h.q){AY(e.p,b.a,c8(b),e.m.a,d,(meb(),veb,'fr'),a);}else{wX(e,b,e.m.a,d,(meb(),veb,'fr'));}}
...
function iY(a,c,b){if(b!==null&& !Dib(b.c,'')){bY(this,a,c);EX(this,this,true,b);}else{s$((meb(),veb,'ERREUR'),(meb(),veb,'Dossier de description de source incorrect')+': '+b.c,(meb(),veb,'Accepter'),null,null,null);}}
function aX(){}
...
function eX(b,a){if(b.a.h.p){dMb(b.a.c);}s$((meb(),veb,'ERREUR'),(meb(),veb,'Impossible de connecter au serveur'),(meb(),veb,'Accepter'),null,null,null);}
function fX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&bjb(e.c)>0){c='';try{if(BP(jY,e.c)!==null&&bjb(BP(jY,e.c))>0){c=BP(jY,e.c);}else{c=x6((meb(),veb),e.c);}if(Cib(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}s$((meb(),veb,'ERREUR'),c,(meb(),veb,'Accepter'),null,null,null);}else{dY(f.b,e);}if(f.a.h.p){dMb(f.a.c);}}
...
function lX(b,a){if(b.a.h.p){dMb(b.a.c);}s$((meb(),veb,'ERREUR'),(meb(),veb,'Impossible de connecter au serveur')+': '+bkb(a),(meb(),veb,'Accepter'),null,null,null);}
...
function s3(d,a){var b,c;ybb(d,a);r3(d);d.b=null.bh;Abb(d,d);uw(d.e,d);y7(d.k,'mapa',d.a);if(null.bh==true){if(null.bh){d.g=pFb(new wEb(),192,'my-cpanel-small');if(null.bh){vFb(d.g,false);}}else{d.g=pFb(new wEb(),128,'my-cpanel-small');}yFb(d.g,null.bh);xBb(d.g,'criterionContentPanel');}else{d.g=pFb(new wEb(),0,'internal-compound-cpanel-small');xBb(d.g,'internalCompoundCriterionContentPanel');}d.d.og('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',364,14,[])));nb(c,null.bh);if(null.bh!=NaN&&null.bh!=NaN&&null.bh!=NaN&&null.bh!=NaN){d.a=wV(new vV(),d.b,(meb(),veb,'fr'),null.bh,null.bh,null.bh,null.bh,null.bh,wjb(null.bh),wjb(null.bh));}else{d.a=xV(new vV(),d.b,(meb(),veb,'fr'),wjb(null.bh),wjb(null.bh));}vJ(d.d,8);ku(d.d,d.a);if(null.bh==true){d.l=gv(new dv(),' '+(meb(),veb,'Utiliser la carte'));d.l.Fb(l3(new k3(),d));oK(d.i,d.l);if(null.bh){jv(d.l,true);}else{jv(d.l,false);yU(d.a);}if(null.bh){u3(d);}if(null.bh){d.ug(false);}}oF(d.e,d.d);oK(d.i,d.e);wFb(d.g,'icon-text');d.i.dc('criterionPanel');iPb(d.g,d.i);if(null.bh){b=new o3();d.h=gBb(new rAb(),(meb(),veb,'Nomenclature'),b);FCb(d.h,false);fDb(d.h,'coordinatesCCBGazetteerButton');iPb(d.g,d.h);}gw(d,d.g);return d;}
...
function k3(){}
_=k3.prototype=new Fhb();_.me=n3;_.tN=nTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=190;function q3(a){yo((meb(),ueb,''),(meb(),veb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function o3(){}
...
function x6(d,b){var a,c;c=ri(xpb(d.a,b),1);if(c!==null)return c;if(Dib(b,'OuterServiceException')){a='Outer service reported an exception';zpb(d.a,'OuterServiceException',a);return a;}if(Dib(b,'UnableToInitIndex')){a='Unable to init an index';zpb(d.a,'UnableToInitIndex',a);return a;}if(Dib(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: op\xE9ration logique valide';zpb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(Dib(b,'usarMapa')){a='Utiliser la carte';zpb(d.a,'usarMapa',a);return a;}if(Dib(b,'hasta')){a='\xE0';zpb(d.a,'hasta',a);return a;}if(Dib(b,'resultados')){a='R\xE9sultats';zpb(d.a,'resultados',a);return a;}if(Dib(b,'valueErrors')){a='Error entering search criteria';zpb(d.a,'valueErrors',a);return a;}if(Dib(b,'ningunCriterioIntroducido')){a='Vous devez saisir un crit\xE8re pour lancer la rechercher';zpb(d.a,'ningunCriterioIntroducido',a);return a;}if(Dib(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';zpb(d.a,'requiredCriterionError',a);return a;}if(Dib(b,'gazetteerTitle')){a='Nomenclature';zpb(d.a,'gazetteerTitle',a);return a;}if(Dib(b,'sourceURLTitle')){a='URL';zpb(d.a,'sourceURLTitle',a);return a;}if(Dib(b,'UnknownFaliure')){a='Unknown service failure';zpb(d.a,'UnknownFaliure',a);return a;}if(Dib(b,'okButtonLabel')){a='Accepter';zpb(d.a,'okButtonLabel',a);return a;}if(Dib(b,'nuevaBusqueda')){a='NOUVELLE';zpb(d.a,'nuevaBusqueda',a);return a;}if(Dib(b,'refinar')){a='AFFINER';zpb(d.a,'refinar',a);return a;}if(Dib(b,'newSourceTitle')){a='New source';zpb(d.a,'newSourceTitle',a);return a;}if(Dib(b,'anterior')){a='Pr\xE9c\xE9dent';zpb(d.a,'anterior',a);return a;}if(Dib(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";zpb(d.a,'UnableToReadSourceResponse',a);return a;}if(Dib(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';zpb(d.a,'UnableToSynchroniseSource',a);return a;}if(Dib(b,'siguiente')){a='Suivant';zpb(d.a,'siguiente',a);return a;}if(Dib(b,'UnsupportedEncoding')){a='Unsupported Encoding';zpb(d.a,'UnsupportedEncoding',a);return a;}if(Dib(b,'connection_error')){a='Impossible de connecter au serveur';zpb(d.a,'connection_error',a);return a;}if(Dib(b,'limpiar')){a='Nettoyer';zpb(d.a,'limpiar',a);return a;}if(Dib(b,'NoReachableOuterService')){a='Could not connect with the outer service';zpb(d.a,'NoReachableOuterService',a);return a;}if(Dib(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';zpb(d.a,'UnableToRemoveFromIndex',a);return a;}if(Dib(b,'sourcesListTitle')){a='Sources disponibles';zpb(d.a,'sourcesListTitle',a);return a;}if(Dib(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';zpb(d.a,'UnableToInitSource',a);return a;}if(Dib(b,'ayuda')){a='Aide';zpb(d.a,'ayuda',a);return a;}if(Dib(b,'NoReachableRDF')){a="Unable to obtain outer service's description";zpb(d.a,'NoReachableRDF',a);return a;}if(Dib(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';zpb(d.a,'UnableToPerformInsertion',a);return a;}if(Dib(b,'deUnTotalDe')){a='sur un total de';zpb(d.a,'deUnTotalDe',a);return a;}if(Dib(b,'invalidDate')){a='Invalid date';zpb(d.a,'invalidDate',a);return a;}if(Dib(b,'sinResultados')){a="Aucun r\xE9sultat n'a \xE9t\xE9 trouv\xE9";zpb(d.a,'sinResultados',a);return a;}if(Dib(b,'aceptar')){a='Accepter';zpb(d.a,'aceptar',a);return a;}if(Dib(b,'buscar')){a='Rechercher';zpb(d.a,'buscar',a);return a;}if(Dib(b,'ResultList_Title')){a='Liste de r\xE9sultats';zpb(d.a,'ResultList_Title',a);return a;}if(Dib(b,'buscando')){a='Recherche en cours\u2026';zpb(d.a,'buscando',a);return a;}if(Dib(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';zpb(d.a,'NoReachablePool',a);return a;}if(Dib(b,'sourceTypeTitle')){a='Type';zpb(d.a,'sourceTypeTitle',a);return a;}if(Dib(b,'SearchInfo_Title')){a='Information de la requ\xEAte';zpb(d.a,'SearchInfo_Title',a);return a;}if(Dib(b,'undefinedBehaviour')){a='Comportement non d\xE9fini';zpb(d.a,'undefinedBehaviour',a);return a;}if(Dib(b,'detalle')){a='D\xE9tail';zpb(d.a,'detalle',a);return a;}if(Dib(b,'error')){a='ERREUR';zpb(d.a,'error',a);return a;}if(Dib(b,'loading')){a='Chargement\u2026';zpb(d.a,'loading',a);return a;}if(Dib(b,'resultComponentVoid')){a='-';zpb(d.a,'resultComponentVoid',a);return a;}if(Dib(b,'busquedaAnterior')){a='PR\xC9C\xC9DENT';zpb(d.a,'busquedaAnterior',a);return a;}if(Dib(b,'wrongSourceDescriptionFile')){a='Dossier de description de source incorrect';zpb(d.a,'wrongSourceDescriptionFile',a);return a;}if(Dib(b,'locale')){a='fr';zpb(d.a,'locale',a);return a;}if(Dib(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";zpb(d.a,'NotAValidQuery',a);return a;}if(Dib(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: op\xE9ration invalide';zpb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw rqb(new qqb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function t6(){}
_=t6.prototype=new Fhb();_.tN=pTb+'Messages_fr';_.tI=195;function z6(a){a.a=pmb(new nmb());}
...
function fGb(b,a){hGb();ELb(b,a);b.c=yAb(new sAb(),67108864);if((a&16777216)!=0){iGb(b,0,'OK');}if((a&67108864)!=0){iGb(b,0,'OK');iGb(b,1,'Annuler');}if((a&268435456)!=0){iGb(b,2,'Oui');iGb(b,3,'Non');}if((a&1073741824)!=0){iGb(b,2,'Oui');iGb(b,3,'Non');iGb(b,1,'Annuler');}return b;}
...
function adb(c,a,b){Fcb(c);c.c=gBb(new rAb(),'',a);c.a=gBb(new rAb(),'',b);zAb(c.b,c.c);zAb(c.b,c.a);FHb(c.c,(meb(),veb,'AFFINER'));FHb(c.a,(meb(),veb,'NOUVELLE'));kBb(c.c,'icon-refine');kBb(c.a,'icon-new');gw(c,c.b);return c;}
function Ecb(){}
...
function rdb(c,b,a){qdb(c);c.a=gBb(new rAb(),'',b);c.b=gBb(new rAb(),'',a);zAb(c.c,c.a);zAb(c.c,c.b);fDb(c.c,'searchButtonsPanel');FHb(c.a,(meb(),veb,'Rechercher'));FHb(c.b,(meb(),veb,'Nettoyer'));kBb(c.a,'icon-search');kBb(c.b,'icon-clear');gw(c,c.c);return c;}
...
function neb(d){var a,b,c;if(d.h!==null){qNb(d.p,d.h);}d.h=aOb(new ANb(),2);a=d.h.b;if(d.a.h){um(hCb(a),'height',d.a.l);}FHb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");wBb(d.h,710,d.f);iNb(d.p,d.h);if(d.a.h){um(ul(hCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=kNb(d.p,c).b;um(hCb(b),'height',d.a.l);}}}
function oeb(g,d){var a,b,c,e,f;wBb(g.p,600,ceb(new beb(),g));e=aOb(new ANb(),0);if(xpb(g.n,d.c)!==null){f=lNb(g.p,ri(xpb(g.n,d.c),68));qNb(g.p,ri(xpb(g.n,d.c),68));if(d.g!==null&& !Dib(d.g,'')){FHb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{FHb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}fDb(e,'resultsTabItem');a=e.b;FJb(a,true);if(g.a.h){um(hCb(a),'height',g.a.l);}zpb(g.n,d.c,e);mNb(g.p,ri(xpb(g.n,d.c),68),f);tNb(g.p,e);}else{if(d.g!==null&& !Dib(d.g,'')){FHb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{FHb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}fDb(e,'resultsTabItem');a=e.b;FJb(a,true);if(g.a.h){um(hCb(a),'height',g.a.l);}zpb(g.n,d.c,e);iNb(g.p,ri(xpb(g.n,d.c),68));}zpb(g.d,jCb(e),hfb(new ffb(),false));tNb(g.p,ri(xpb(g.n,d.c),68));if(g.a.h){um(ul(hCb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=kNb(g.p,c).b;um(hCb(b),'height',g.a.l);}}}
function peb(d,b){var a,c;iPb(d.h.b,b);FHb(d.h,'D\xE9tail');tNb(d.p,d.h);if(d.a.h){um(ul(hCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=kNb(d.p,c).b;um(hCb(a),'height',d.a.l);}}}
function qeb(g,c,d){var a,b,e,f;e=ri(xpb(g.n,d.c),68);zpb(g.c,jCb(e),c);wBb(e,8,geb(new feb(),g));if(d.g!==null&& !Dib(d.g,'')){FHb(ri(xpb(g.n,d.c),68),d.g);}else{FHb(ri(xpb(g.n,d.c),68),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(xpb(g.n,d.c))){g.o=true;tNb(g.p,g.i);f=lNb(g.p,ri(xpb(g.n,d.c),68));pPb(kNb(g.p,f).b);iPb(kNb(g.p,f).b,c);if(g.a.h){bDb(kNb(g.p,f),g.a.l);um(ul(hCb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=kNb(g.p,b).b;um(hCb(a),'height',g.a.l);}}zpb(g.d,jCb(e),hfb(new ffb(),true));tNb(g.p,ri(xpb(g.n,d.c),68));}}
...
function hSb(){}
_=hSb.prototype=new Fhb();_.tN=aUb+'DateLocale_fr_CA';_.tI=359;function oSb(a,b){return qnb(new onb(),Cnb(a),ynb(a),unb(a)+b);}
