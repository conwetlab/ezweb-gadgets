...
/* The Original Code is C84A43535BB60D7EEB4110B9E4FFA7FA.cache.js
...
function rh(b){var a,c;a=Bk(rqb(b.a,'eraNames'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['av. J.-C.','ap. J.-C.']);tqb(b.a,'eraNames',c);return c;}else return a;}
function sh(b){var a,c;a=Bk(rqb(b.a,'eras'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['av. J.-C.','apr. J.-C.']);tqb(b.a,'eras',c);return c;}else return a;}
function th(b){var a,c;a=Bk(rqb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);tqb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(rqb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);tqb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(rqb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);tqb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(rqb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);tqb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(rqb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);tqb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Ch(b){var a,c;a=Bk(rqb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);tqb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(rqb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);tqb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(rqb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);tqb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(rqb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',361,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);tqb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new yib();_.tN=wTb+'DateTimeConstants_fr_CH';_.tI=28;function gk(){return null;}
...
function fX(d,a,b,c){if(wjb(a,'viewDetails'))vY(d.a,b,c);else{f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'Comportement non d\xE9fini'),(ffb(),ofb,'Accepter'),null,null,null);}}
...
function mW(){}
_=mW.prototype=new yib();_.tN=eUb+'AVOFilterBuilder';_.tI=159;_.c=null;_.d='CONTAINS WORD';_.g=false;function zW(e,a,f,c){var b,d;b=null;if(vjb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(vjb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(vjb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(vjb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(vjb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(vjb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(vjb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!vjb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(ffb(),ofb,'Accepter'),null,null,null);}return b;}
function AW(e,b,d,c){var a;a=null;if(vjb(c,e.c)){a=e.b+b+d+e.a;}else if(vjb(c,e.eb)){a=e.db+b+d+e.cb;}else{f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(ffb(),ofb,'Accepter'),null,null,null);}return a;}
...
function mX(){}
_=mX.prototype=new yib();_.tN=gUb+'CriterionsListElement';_.tI=163;_.a=null;_.b=null;function cY(a){a.p=jZ(new EY());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=jnb(new hnb());a.g=jnb(new hnb());a.a=jnb(new hnb());a.c=wJb(new rJb(),(ffb(),ofb,'Recherche en cours\u2026'));}
...
function kY(e,b,d,c){var a;if(e.h.p){bNb(e.c);}a=CX(new BX(),e,b,d);gfb(e.k);if(e.h.q){nZ(e.p,b.a,v8(b),e.m.a,d,(ffb(),ofb,'fr'),a);}else{jY(e,b,e.m.a,d,(ffb(),ofb,'fr'));}}
...
function BY(a,c,b){if(b!==null&& !wjb(b.c,'')){uY(this,a,c);rY(this,this,true,b);}else{f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'Dossier de description de source incorrect')+': '+b.c,(ffb(),ofb,'Accepter'),null,null,null);}}
function tX(){}
...
function xX(b,a){if(b.a.h.p){DMb(b.a.c);}f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'Impossible de connecter au serveur'),(ffb(),ofb,'Accepter'),null,null,null);}
function yX(f,d){var a,c,e;e=Bk(d,49);if(e.c!==null&&Ajb(e.c)>0){c='';try{if(bS(CY,e.c)!==null&&Ajb(bS(CY,e.c))>0){c=bS(CY,e.c);}else{c=k7((ffb(),ofb),e.c);}if(vjb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,38)){a;c=e.d;}else throw a;}f_((ffb(),ofb,'ERREUR'),c,(ffb(),ofb,'Accepter'),null,null,null);}else{wY(f.b,e);}if(f.a.h.p){DMb(f.a.c);}}
...
function EX(b,a){if(b.a.h.p){DMb(b.a.c);}f_((ffb(),ofb,'ERREUR'),(ffb(),ofb,'Impossible de connecter au serveur')+': '+Bkb(a),(ffb(),ofb,'Accepter'),null,null,null);}
...
function f4(e,b){var a,c,d,f;kcb(e,b);e4(e);mcb(e,e);az(e.d,e);l8(e.k,'mapa',e.a);if(null.Fg==true){if(null.Fg){e.f=jGb(new qFb(),192,'my-cpanel-small');if(null.Fg){pGb(e.f,false);}}else{e.f=jGb(new qFb(),128,'my-cpanel-small');}sGb(e.f,null.Fg);rCb(e.f,'criterionContentPanel');}else{e.f=jGb(new qFb(),0,'internal-compound-cpanel-small');rCb(e.f,'internalCompoundCriterionContentPanel');}e.c.mg('coordinatesBox');d=Eb(new Db());ac(d,qb(new gb(),vk('[Lcom.eg.gwt.openLayers.client.JSObject;',362,12,[])));bc(d,null.Fg);e.j=tcb(new scb(),'280px','170px',d);e.a=fc(e.j);f=Fd(new Ed());be(f,'jpeg');ce(f,'Todas');de(f,'sombreado2');a=Ec(new Ac());dd(a,'singleTile',true);e.n=fe(new Ad(),'WMS Layer',(ffb(),nfb,'http://idee.unizar.es/wms/IDEE-Base/IDEE-Base'),f,a);qc(e.a,vk('[Lcom.eg.gwt.openLayers.client.layer.Layer;',363,13,[e.n]));pc(e.a,ld(new hd()));vcb(e.a.a);wcb(e.a.a,null.Fg,null.Fg,null.Fg,null.Fg);vd(yc(e.a),'mouseup',e.a,A3(new z3(),e));if(null.Fg==true){e.l=BD(new fD(),'images/over_map.png');e.l.eg('100%');e.l.ug('100%');ntb();tub(e.l.Fc(),ntb());e.m=sx(new px(),' '+(ffb(),ofb,'Utiliser la carte'));e.m.Fb(E3(new D3(),e));wM(e.h,e.m);if(null.Fg){vx(e.m,true);}else{vx(e.m,false);vw(e.c,e.l,0,0);}if(null.Fg){h4(e);}if(null.Fg){e.sg(false);}}uw(e.c,e.j);wH(e.d,e.c);wM(e.h,e.d);qGb(e.f,'icon-text');e.h.dc('criterionPanel');cQb(e.f,e.h);if(null.Fg){c=new b4();xcb(e.a.a);e.g=aCb(new lBb(),(ffb(),ofb,'Nomenclature'),c);zDb(e.g,false);FDb(e.g,'coordinatesCCBGazetteerButton');cQb(e.f,e.g);}sy(e,e.f);return e;}
...
function D3(){}
_=D3.prototype=new yib();_.je=a4;_.tN=iUb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=188;function d4(a){Eq((ffb(),nfb,''),(ffb(),ofb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function b4(){}
...
function k7(d,b){var a,c;c=Bk(rqb(d.a,b),1);if(c!==null)return c;if(wjb(b,'OuterServiceException')){a='Outer service reported an exception';tqb(d.a,'OuterServiceException',a);return a;}if(wjb(b,'UnableToInitIndex')){a='Unable to init an index';tqb(d.a,'UnableToInitIndex',a);return a;}if(wjb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: op\xE9ration logique valide';tqb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(wjb(b,'usarMapa')){a='Utiliser la carte';tqb(d.a,'usarMapa',a);return a;}if(wjb(b,'hasta')){a='\xE0';tqb(d.a,'hasta',a);return a;}if(wjb(b,'resultados')){a='R\xE9sultats';tqb(d.a,'resultados',a);return a;}if(wjb(b,'valueErrors')){a='Error entering search criteria';tqb(d.a,'valueErrors',a);return a;}if(wjb(b,'ningunCriterioIntroducido')){a='Vous devez saisir un crit\xE8re pour lancer la rechercher';tqb(d.a,'ningunCriterioIntroducido',a);return a;}if(wjb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';tqb(d.a,'requiredCriterionError',a);return a;}if(wjb(b,'gazetteerTitle')){a='Nomenclature';tqb(d.a,'gazetteerTitle',a);return a;}if(wjb(b,'sourceURLTitle')){a='URL';tqb(d.a,'sourceURLTitle',a);return a;}if(wjb(b,'UnknownFaliure')){a='Unknown service failure';tqb(d.a,'UnknownFaliure',a);return a;}if(wjb(b,'okButtonLabel')){a='Accepter';tqb(d.a,'okButtonLabel',a);return a;}if(wjb(b,'nuevaBusqueda')){a='NOUVELLE';tqb(d.a,'nuevaBusqueda',a);return a;}if(wjb(b,'refinar')){a='AFFINER';tqb(d.a,'refinar',a);return a;}if(wjb(b,'newSourceTitle')){a='New source';tqb(d.a,'newSourceTitle',a);return a;}if(wjb(b,'anterior')){a='Pr\xE9c\xE9dent';tqb(d.a,'anterior',a);return a;}if(wjb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";tqb(d.a,'UnableToReadSourceResponse',a);return a;}if(wjb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';tqb(d.a,'UnableToSynchroniseSource',a);return a;}if(wjb(b,'siguiente')){a='Suivant';tqb(d.a,'siguiente',a);return a;}if(wjb(b,'UnsupportedEncoding')){a='Unsupported Encoding';tqb(d.a,'UnsupportedEncoding',a);return a;}if(wjb(b,'connection_error')){a='Impossible de connecter au serveur';tqb(d.a,'connection_error',a);return a;}if(wjb(b,'limpiar')){a='Nettoyer';tqb(d.a,'limpiar',a);return a;}if(wjb(b,'NoReachableOuterService')){a='Could not connect with the outer service';tqb(d.a,'NoReachableOuterService',a);return a;}if(wjb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';tqb(d.a,'UnableToRemoveFromIndex',a);return a;}if(wjb(b,'sourcesListTitle')){a='Sources list';tqb(d.a,'sourcesListTitle',a);return a;}if(wjb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';tqb(d.a,'UnableToInitSource',a);return a;}if(wjb(b,'ayuda')){a='Aide';tqb(d.a,'ayuda',a);return a;}if(wjb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";tqb(d.a,'NoReachableRDF',a);return a;}if(wjb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';tqb(d.a,'UnableToPerformInsertion',a);return a;}if(wjb(b,'deUnTotalDe')){a='sur un total de';tqb(d.a,'deUnTotalDe',a);return a;}if(wjb(b,'invalidDate')){a='Invalid date';tqb(d.a,'invalidDate',a);return a;}if(wjb(b,'sinResultados')){a="Aucun r\xE9sultat n'a \xE9t\xE9 trouv\xE9";tqb(d.a,'sinResultados',a);return a;}if(wjb(b,'aceptar')){a='Accepter';tqb(d.a,'aceptar',a);return a;}if(wjb(b,'buscar')){a='Rechercher';tqb(d.a,'buscar',a);return a;}if(wjb(b,'ResultList_Title')){a='Liste de r\xE9sultats';tqb(d.a,'ResultList_Title',a);return a;}if(wjb(b,'buscando')){a='Recherche en cours\u2026';tqb(d.a,'buscando',a);return a;}if(wjb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';tqb(d.a,'NoReachablePool',a);return a;}if(wjb(b,'sourceTypeTitle')){a='Type';tqb(d.a,'sourceTypeTitle',a);return a;}if(wjb(b,'SearchInfo_Title')){a='Information de la requ\xEAte';tqb(d.a,'SearchInfo_Title',a);return a;}if(wjb(b,'undefinedBehaviour')){a='Comportement non d\xE9fini';tqb(d.a,'undefinedBehaviour',a);return a;}if(wjb(b,'detalle')){a='D\xE9tail';tqb(d.a,'detalle',a);return a;}if(wjb(b,'error')){a='ERREUR';tqb(d.a,'error',a);return a;}if(wjb(b,'loading')){a='Chargement\u2026';tqb(d.a,'loading',a);return a;}if(wjb(b,'resultComponentVoid')){a='-';tqb(d.a,'resultComponentVoid',a);return a;}if(wjb(b,'busquedaAnterior')){a='PR\xC9C\xC9DENT';tqb(d.a,'busquedaAnterior',a);return a;}if(wjb(b,'wrongSourceDescriptionFile')){a='Dossier de description de source incorrect';tqb(d.a,'wrongSourceDescriptionFile',a);return a;}if(wjb(b,'locale')){a='fr';tqb(d.a,'locale',a);return a;}if(wjb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";tqb(d.a,'NotAValidQuery',a);return a;}if(wjb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: op\xE9ration invalide';tqb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw lrb(new krb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function g7(){}
_=g7.prototype=new yib();_.tN=kUb+'Messages_fr';_.tI=193;function m7(a){a.a=jnb(new hnb());}
...
function FGb(b,a){bHb();yMb(b,a);b.c=sBb(new mBb(),67108864);if((a&16777216)!=0){cHb(b,0,'OK');}if((a&67108864)!=0){cHb(b,0,'OK');cHb(b,1,'Annuler');}if((a&268435456)!=0){cHb(b,2,'Oui');cHb(b,3,'Non');}if((a&1073741824)!=0){cHb(b,2,'Oui');cHb(b,3,'Non');cHb(b,1,'Annuler');}return b;}
...
function zdb(c,a,b){ydb(c);c.c=aCb(new lBb(),'',a);c.a=aCb(new lBb(),'',b);tBb(c.b,c.c);tBb(c.b,c.a);zIb(c.c,(ffb(),ofb,'AFFINER'));zIb(c.a,(ffb(),ofb,'NOUVELLE'));eCb(c.c,'icon-refine');eCb(c.a,'icon-new');sy(c,c.b);return c;}
function xdb(){}
...
function keb(c,b,a){jeb(c);c.a=aCb(new lBb(),'',b);c.b=aCb(new lBb(),'',a);tBb(c.c,c.a);tBb(c.c,c.b);FDb(c.c,'searchButtonsPanel');zIb(c.a,(ffb(),ofb,'Rechercher'));zIb(c.b,(ffb(),ofb,'Nettoyer'));eCb(c.a,'icon-search');eCb(c.b,'icon-clear');sy(c,c.c);return c;}
...
function gfb(d){var a,b,c;if(d.h!==null){kOb(d.p,d.h);}d.h=AOb(new uOb(),2);a=d.h.b;if(d.a.h){ap(bDb(a),'height',d.a.l);}zIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");qCb(d.h,710,d.f);cOb(d.p,d.h);if(d.a.h){ap(Fn(bDb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=eOb(d.p,c).b;ap(bDb(b),'height',d.a.l);}}}
function hfb(g,d){var a,b,c,e,f;qCb(g.p,600,Beb(new Aeb(),g));e=AOb(new uOb(),0);if(rqb(g.n,d.c)!==null){f=fOb(g.p,Bk(rqb(g.n,d.c),69));kOb(g.p,Bk(rqb(g.n,d.c),69));if(d.g!==null&& !wjb(d.g,'')){zIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{zIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}FDb(e,'resultsTabItem');a=e.b;zKb(a,true);if(g.a.h){ap(bDb(a),'height',g.a.l);}tqb(g.n,d.c,e);gOb(g.p,Bk(rqb(g.n,d.c),69),f);nOb(g.p,e);}else{if(d.g!==null&& !wjb(d.g,'')){zIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{zIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}FDb(e,'resultsTabItem');a=e.b;zKb(a,true);if(g.a.h){ap(bDb(a),'height',g.a.l);}tqb(g.n,d.c,e);cOb(g.p,Bk(rqb(g.n,d.c),69));}tqb(g.d,dDb(e),agb(new Efb(),false));nOb(g.p,Bk(rqb(g.n,d.c),69));if(g.a.h){ap(Fn(bDb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=eOb(g.p,c).b;ap(bDb(b),'height',g.a.l);}}}
function ifb(d,b){var a,c;cQb(d.h.b,b);zIb(d.h,'D\xE9tail');nOb(d.p,d.h);if(d.a.h){ap(Fn(bDb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=eOb(d.p,c).b;ap(bDb(a),'height',d.a.l);}}}
function jfb(g,c,d){var a,b,e,f;e=Bk(rqb(g.n,d.c),69);tqb(g.c,dDb(e),c);qCb(e,8,Feb(new Eeb(),g));if(d.g!==null&& !wjb(d.g,'')){zIb(Bk(rqb(g.n,d.c),69),d.g);}else{zIb(Bk(rqb(g.n,d.c),69),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(rqb(g.n,d.c))){g.o=true;nOb(g.p,g.i);f=fOb(g.p,Bk(rqb(g.n,d.c),69));jQb(eOb(g.p,f).b);cQb(eOb(g.p,f).b,c);if(g.a.h){BDb(eOb(g.p,f),g.a.l);ap(Fn(bDb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=eOb(g.p,b).b;ap(bDb(a),'height',g.a.l);}}tqb(g.d,dDb(e),agb(new Efb(),true));nOb(g.p,Bk(rqb(g.n,d.c),69));}}
...
function bTb(){}
_=bTb.prototype=new yib();_.tN=BUb+'DateLocale_fr_CH';_.tI=358;function iTb(a,b){return kob(new iob(),wob(a),sob(a),oob(a)+b);}
