...
/* The Original Code is 1313EE7F72ACEAA026132AC01574A8E5.cache.js
...
function ef(b){var a,c;a=ri(hqb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['DE','DU']);jqb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(hqb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['id\u0151sz\xE1m\xEDt\xE1sunk el\u0151tt','id\u0151sz\xE1m\xEDt\xE1sunk szerint']);jqb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(hqb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['i. e.','i. sz.']);jqb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(hqb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janu\xE1r','febru\xE1r','m\xE1rcius','\xE1prilis','m\xE1jus','j\xFAnius','j\xFAlius','augusztus','szeptember','okt\xF3ber','november','december']);jqb(b.a,'months',c);return c;}else return a;}
function kf(b){var a,c;a=ri(hqb(b.a,'narrowMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['J','F','M','\xC1','M','J','J','A','S','O','N','D']);jqb(b.a,'narrowMonths',c);return c;}else return a;}
function lf(b){var a,c;a=ri(hqb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['I. negyed\xE9v','II. negyed\xE9v','III. negyed\xE9v','IV. negyed\xE9v']);jqb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(hqb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['jan.','febr.','m\xE1rc.','\xE1pr.','m\xE1j.','j\xFAn.','j\xFAl.','aug.','szept.','okt.','nov.','dec.']);jqb(b.a,'shortMonths',c);return c;}else return a;}
function nf(b){var a,c;a=ri(hqb(b.a,'shortQuarters'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['N1','N2','N3','N4']);jqb(b.a,'shortQuarters',c);return c;}else return a;}
function of(b){var a,c;a=ri(hqb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['V','H','K','Sze','Cs','P','Szo']);jqb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(hqb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janu\xE1r','febru\xE1r','m\xE1rcius','\xE1prilis','m\xE1jus','j\xFAnius','j\xFAlius','augusztus','szeptember','okt\xF3ber','november','december']);jqb(b.a,'standaloneMonths',c);return c;}else return a;}
function qf(b){var a,c;a=ri(hqb(b.a,'standaloneNarrowMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['J','F','M','\xC1','M','J','J','A','S','O','N','D']);jqb(b.a,'standaloneNarrowMonths',c);return c;}else return a;}
function rf(b){var a,c;a=ri(hqb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['V','H','K','S','C','P','S']);jqb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(hqb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['jan.','febr.','m\xE1rc.','\xE1pr.','m\xE1j.','j\xFAn.','j\xFAl.','aug.','szept.','okt.','nov.','dec.']);jqb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(hqb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['V','H','K','Sze','Cs','P','Szo']);jqb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(hqb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['vas\xE1rnap','h\xE9tf\u0151','kedd','szerda','cs\xFCt\xF6rt\xF6k','p\xE9ntek','szombat']);jqb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(hqb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['vas\xE1rnap','h\xE9tf\u0151','kedd','szerda','cs\xFCt\xF6rt\xF6k','p\xE9ntek','szombat']);jqb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new pib();_.tN=jTb+'DateTimeConstants_hu_HU';_.tI=18;function Ch(){return null;}
...
function jW(){}
_=jW.prototype=new pib();_.tN=zTb+'AVOFilterBuilder';_.tI=164;_.c=null;_.d='CONTAINS WORD';_.g=false;function wW(e,a,f,c){var b,d;b=null;if(mjb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(mjb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(mjb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(mjb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(mjb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(mjb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(mjb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!mjb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c_((Ceb(),ffb,'ERROR'),(Ceb(),ffb,'FilterBuilderToolkitObject: operaci\xF3n inv\xE1lida'),(Ceb(),ffb,'Aceptar'),null,null,null);}return b;}
function xW(e,b,d,c){var a;a=null;if(mjb(c,e.c)){a=e.b+b+d+e.a;}else if(mjb(c,e.gb)){a=e.fb+b+d+e.eb;}else{c_((Ceb(),ffb,'ERROR'),(Ceb(),ffb,'FilterBuilderToolkitObject: operaci\xF3n l\xF3gica inv\xE1lida')+': '+c,(Ceb(),ffb,'Aceptar'),null,null,null);}return a;}
...
function jX(){}
_=jX.prototype=new pib();_.tN=BTb+'CriterionsListElement';_.tI=168;_.a=null;_.b=null;function FX(a){a.p=gZ(new BY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Fmb(new Dmb());a.g=Fmb(new Dmb());a.a=Fmb(new Dmb());a.c=mJb(new hJb(),(Ceb(),ffb,'Buscando...'));}
...
function hY(e,b,d,c){var a;if(e.h.p){xMb(e.c);}a=zX(new yX(),e,b,d);Deb(e.k);if(e.h.q){kZ(e.p,b.a,s8(b),e.m.a,d,(Ceb(),ffb,'es'),a);}else{gY(e,b,e.m.a,d,(Ceb(),ffb,'es'));}}
...
function uX(b,a){if(b.a.h.p){tMb(b.a.c);}c_((Ceb(),ffb,'ERROR'),(Ceb(),ffb,'No se pudo conectar con el servidor'),(Ceb(),ffb,'Aceptar'),null,null,null);}
function vX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&rjb(e.c)>0){c='';try{if(lQ(zY,e.c)!==null&&rjb(lQ(zY,e.c))>0){c=lQ(zY,e.c);}else{c=h7((Ceb(),ffb),e.c);}if(mjb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}c_((Ceb(),ffb,'ERROR'),c,(Ceb(),ffb,'Aceptar'),null,null,null);}else{tY(f.b,e);}if(f.a.h.p){tMb(f.a.c);}}
...
function BX(b,a){if(b.a.h.p){tMb(b.a.c);}c_((Ceb(),ffb,'ERROR'),(Ceb(),ffb,'No se pudo conectar con el servidor')+': '+rkb(a),(Ceb(),ffb,'Aceptar'),null,null,null);}
...
function c4(d,a){var b,c;icb(d,a);b4(d);d.b=null.dh;kcb(d,d);Aw(d.e,d);i8(d.k,'mapa',d.a);if(null.dh==true){if(null.dh){d.g=FFb(new gFb(),192,'my-cpanel-small');if(null.dh){fGb(d.g,false);}}else{d.g=FFb(new gFb(),128,'my-cpanel-small');}iGb(d.g,null.dh);hCb(d.g,'criterionContentPanel');}else{d.g=FFb(new gFb(),0,'internal-compound-cpanel-small');hCb(d.g,'internalCompoundCriterionContentPanel');}d.d.qg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',367,14,[])));nb(c,null.dh);if(null.dh!=NaN&&null.dh!=NaN&&null.dh!=NaN&&null.dh!=NaN){d.a=gW(new fW(),d.b,(Ceb(),ffb,'es'),null.dh,null.dh,null.dh,null.dh,null.dh,gkb(null.dh),gkb(null.dh));}else{d.a=hW(new fW(),d.b,(Ceb(),ffb,'es'),gkb(null.dh),gkb(null.dh));}BJ(d.d,8);qu(d.d,d.a);if(null.dh==true){d.l=mv(new jv(),' '+(Ceb(),ffb,'Usar mapa'));d.l.bc(B3(new A3(),d));uK(d.i,d.l);if(null.dh){pv(d.l,true);}else{pv(d.l,false);iV(d.a);}if(null.dh){e4(d);}if(null.dh){d.wg(false);}}uF(d.e,d.d);uK(d.i,d.e);gGb(d.g,'icon-text');d.i.fc('criterionPanel');yPb(d.g,d.i);if(null.dh){b=new E3();d.h=wBb(new bBb(),(Ceb(),ffb,'Nomencl\xE1tor'),b);pDb(d.h,false);vDb(d.h,'coordinatesCCBGazetteerButton');yPb(d.g,d.h);}mw(d,d.g);return d;}
...
function A3(){}
_=A3.prototype=new pib();_.oe=D3;_.tN=DTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=193;function a4(a){yo((Ceb(),efb,''),(Ceb(),ffb,'Nomencl\xE1tor'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function E3(){}
...
function x4(){var a,b;a=k8(new n7());this.c=E7(new C7());n8(a,this.c);if(!(tG(this.a),true)){m8(a,(Ceb(),ffb,'Fecha no v\xE1lida'));}else{if(this.a.d!==null){b=q7(new o7());s7(b,null.dh);t7(b,null.dh);u7(b,null.eh());c8(this.c,0,b);b8(this.c,null.dh);d8(this.c,null.dh);p8(a,null.dh+': '+null.eh());}else{a=null;}}return a;}
...
function d7(){}
_=d7.prototype=new pib();_.tN=FTb+'Messages_';_.tI=198;function j7(a){a.a=Fmb(new Dmb());}
...
function qdb(c,a,b){pdb(c);c.c=wBb(new bBb(),'',a);c.a=wBb(new bBb(),'',b);jBb(c.b,c.c);jBb(c.b,c.a);pIb(c.c,(Ceb(),ffb,'REFINAR '));pIb(c.a,(Ceb(),ffb,'NUEVA'));ABb(c.c,'icon-refine');ABb(c.a,'icon-new');mw(c,c.b);return c;}
function odb(){}
...
function beb(c,b,a){aeb(c);c.a=wBb(new bBb(),'',b);c.b=wBb(new bBb(),'',a);jBb(c.c,c.a);jBb(c.c,c.b);vDb(c.c,'searchButtonsPanel');pIb(c.a,(Ceb(),ffb,'Buscar'));pIb(c.b,(Ceb(),ffb,'Limpiar'));ABb(c.a,'icon-search');ABb(c.b,'icon-clear');mw(c,c.c);return c;}
...
function Deb(d){var a,b,c;if(d.h!==null){aOb(d.p,d.h);}d.h=qOb(new kOb(),2);a=d.h.b;if(d.a.h){um(xCb(a),'height',d.a.l);}pIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Detalle");gCb(d.h,710,d.f);yNb(d.p,d.h);if(d.a.h){um(ul(xCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=ANb(d.p,c).b;um(xCb(b),'height',d.a.l);}}}
...
function Feb(d,b){var a,c;yPb(d.h.b,b);pIb(d.h,'Detalle');dOb(d.p,d.h);if(d.a.h){um(ul(xCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=ANb(d.p,c).b;um(xCb(a),'height',d.a.l);}}}
...
function ifb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;hfb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;zx(p.d,p.e.b,2);if(p.i){zx(p.d,p.e.b+3,2);h=uE(new tE(),'myRadioGroup');pv(h,false);Cz(p.d,0,0,h);f=mC(new kC(),(Ceb(),ffb,'Nueva fuente'));Cz(p.d,0,1,f);o=AA(new yA());m=mC(new kC(),(Ceb(),ffb,'URL')+':  ');BA(o,m);p.h.qg('sourcesListTextBox');BA(o,p.h);Cz(p.d,1,1,o);c=AA(new yA());l=mC(new kC(),(Ceb(),ffb,'Tipo')+':  ');BA(c,l);p.a.qg('sourcesListListBox');BA(c,p.a);for(b=0;b<p.c.b;b++){CC(p.a,ri(gnb(p.c,b),1));}Cz(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=kv(new jv());Cz(p.d,b+e,0,a);pv(a,ri(gnb(p.e,b),45).b);j=mC(new kC(),ri(gnb(p.e,b),45).g);Cz(p.d,b+e,1,j);}else{h=uE(new tE(),'myRadioGroup');if(!i&&ri(gnb(p.e,b),45).b){pv(h,true);i=true;}Cz(p.d,b+e,0,h);k=mC(new kC(),ri(gnb(p.e,b),45).g);Cz(p.d,b+e,1,k);}}if(!p.b){if(!i){pv(ri(rz(p.d,0,0),72),true);}}if(lQ(zY,'sourcesListTitle')!==null&& !njb(lQ(zY,'sourcesListTitle'),'')){iGb(p.f,lQ(zY,'sourcesListTitle'));}else{iGb(p.f,(Ceb(),ffb,'Fuentes disponibles'));}hGb(p.f,5);hCb(p.f,'sourcesListPanel');gGb(p.f,'icon-text');yz(p.d,4);uF(p.g,p.d);p.g.qg('sourcesGrid');yPb(p.f,p.g);mw(p,p.f);return p;}
...
function xSb(){}
_=xSb.prototype=new pib();_.tN=qUb+'DateLocale_hu_HU';_.tI=362;function ESb(a,b){return aob(new Enb(),mob(a),iob(a),eob(a)+b);}
