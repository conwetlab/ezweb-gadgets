...
/* The Original Code is 324578F9A23349EBB0BBCC79C7D4BABB.cache.js
...
function bf(){}
_=bf.prototype=new pib();_.tN=jTb+'DateTimeConstants_fr_CA';_.tI=18;function Ch(){return null;}
...
function jW(){}
_=jW.prototype=new pib();_.tN=zTb+'AVOFilterBuilder';_.tI=164;_.c=null;_.d='CONTAINS WORD';_.g=false;function wW(e,a,f,c){var b,d;b=null;if(mjb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(mjb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(mjb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(mjb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(mjb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(mjb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(mjb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!mjb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(Ceb(),ffb,'Accepter'),null,null,null);}return b;}
function xW(e,b,d,c){var a;a=null;if(mjb(c,e.c)){a=e.b+b+d+e.a;}else if(mjb(c,e.gb)){a=e.fb+b+d+e.eb;}else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(Ceb(),ffb,'Accepter'),null,null,null);}return a;}
...
function jX(){}
_=jX.prototype=new pib();_.tN=BTb+'CriterionsListElement';_.tI=168;_.a=null;_.b=null;function FX(a){a.p=gZ(new BY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Fmb(new Dmb());a.g=Fmb(new Dmb());a.a=Fmb(new Dmb());a.c=mJb(new hJb(),(Ceb(),ffb,'Recherche en cours\u2026'));}
...
function hY(e,b,d,c){var a;if(e.h.p){xMb(e.c);}a=zX(new yX(),e,b,d);Deb(e.k);if(e.h.q){kZ(e.p,b.a,s8(b),e.m.a,d,(Ceb(),ffb,'fr'),a);}else{gY(e,b,e.m.a,d,(Ceb(),ffb,'fr'));}}
...
function uX(b,a){if(b.a.h.p){tMb(b.a.c);}c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Impossible de connecter au serveur'),(Ceb(),ffb,'Accepter'),null,null,null);}
function vX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&rjb(e.c)>0){c='';try{if(lQ(zY,e.c)!==null&&rjb(lQ(zY,e.c))>0){c=lQ(zY,e.c);}else{c=h7((Ceb(),ffb),e.c);}if(mjb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}c_((Ceb(),ffb,'ERREUR'),c,(Ceb(),ffb,'Accepter'),null,null,null);}else{tY(f.b,e);}if(f.a.h.p){tMb(f.a.c);}}
...
function BX(b,a){if(b.a.h.p){tMb(b.a.c);}c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Impossible de connecter au serveur')+': '+rkb(a),(Ceb(),ffb,'Accepter'),null,null,null);}
...
function c4(d,a){var b,c;icb(d,a);b4(d);d.b=null.dh;kcb(d,d);Aw(d.e,d);i8(d.k,'mapa',d.a);if(null.dh==true){if(null.dh){d.g=FFb(new gFb(),192,'my-cpanel-small');if(null.dh){fGb(d.g,false);}}else{d.g=FFb(new gFb(),128,'my-cpanel-small');}iGb(d.g,null.dh);hCb(d.g,'criterionContentPanel');}else{d.g=FFb(new gFb(),0,'internal-compound-cpanel-small');hCb(d.g,'internalCompoundCriterionContentPanel');}d.d.qg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',367,14,[])));nb(c,null.dh);if(null.dh!=NaN&&null.dh!=NaN&&null.dh!=NaN&&null.dh!=NaN){d.a=gW(new fW(),d.b,(Ceb(),ffb,'fr'),null.dh,null.dh,null.dh,null.dh,null.dh,gkb(null.dh),gkb(null.dh));}else{d.a=hW(new fW(),d.b,(Ceb(),ffb,'fr'),gkb(null.dh),gkb(null.dh));}BJ(d.d,8);qu(d.d,d.a);if(null.dh==true){d.l=mv(new jv(),' '+(Ceb(),ffb,'Utiliser la carte'));d.l.bc(B3(new A3(),d));uK(d.i,d.l);if(null.dh){pv(d.l,true);}else{pv(d.l,false);iV(d.a);}if(null.dh){e4(d);}if(null.dh){d.wg(false);}}uF(d.e,d.d);uK(d.i,d.e);gGb(d.g,'icon-text');d.i.fc('criterionPanel');yPb(d.g,d.i);if(null.dh){b=new E3();d.h=wBb(new bBb(),(Ceb(),ffb,'Nomenclature'),b);pDb(d.h,false);vDb(d.h,'coordinatesCCBGazetteerButton');yPb(d.g,d.h);}mw(d,d.g);return d;}
...
function A3(){}
_=A3.prototype=new pib();_.oe=D3;_.tN=DTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=193;function a4(a){yo((Ceb(),efb,''),(Ceb(),ffb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function E3(){}
...
function d7(){}
_=d7.prototype=new pib();_.tN=FTb+'Messages_fr';_.tI=198;function j7(a){a.a=Fmb(new Dmb());}
...
function vGb(b,a){xGb();oMb(b,a);b.c=iBb(new cBb(),67108864);if((a&16777216)!=0){yGb(b,0,'OK');}if((a&67108864)!=0){yGb(b,0,'OK');yGb(b,1,'Annuler');}if((a&268435456)!=0){yGb(b,2,'Oui');yGb(b,3,'Non');}if((a&1073741824)!=0){yGb(b,2,'Oui');yGb(b,3,'Non');yGb(b,1,'Annuler');}return b;}
...
function xcb(j,h){var a,b,c,d,e,f,g,i;mz(j.c);f=nrb(new mrb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=jab(new iab());rC(d,'<<');nC(d,j);lab(ri(d,60),1+j.a*j.d-j.d);}else{d=lC(new kC());rC(d,' ');}d.fc('navigationArrowsLeft');prb(f,d);if(h.b!=0){b=jab(new iab());rC(b,(Ceb(),ffb,'Pr\xE9c\xE9dent'));nC(b,j);lab(ri(b,60),j.f-1);}else{b=lC(new kC());rC(b,' ');}b.fc('navigationPrevious');prb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=whb(h.f/j.g);e++){g=jab(new iab());if(e==j.f){g.fc('navigationCurrentPage');}else{nC(g,j);lab(g,e);}rC(g,''+e);prb(f,g);}if(j.f<whb(h.f/j.g)){i=jab(new iab());rC(i,(Ceb(),ffb,'Suivant'));nC(i,j);lab(ri(i,60),j.f+1);}else{i=lC(new kC());rC(i,' ');}i.fc('navigationNext');prb(f,i);if((j.a+1)*j.g*j.d<h.f){c=jab(new iab());rC(c,'>>');nC(c,j);lab(ri(c,60),e);}else{c=lC(new kC());rC(c,' ');}c.fc('navigationArrowsRight');prb(f,c);zx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){Cz(j.c,0,a,ri(rrb(f,a),61));}}
...
function qdb(c,a,b){pdb(c);c.c=wBb(new bBb(),'',a);c.a=wBb(new bBb(),'',b);jBb(c.b,c.c);jBb(c.b,c.a);pIb(c.c,(Ceb(),ffb,'AFFINER'));pIb(c.a,(Ceb(),ffb,'NOUVELLE'));ABb(c.c,'icon-refine');ABb(c.a,'icon-new');mw(c,c.b);return c;}
function odb(){}
...
function beb(c,b,a){aeb(c);c.a=wBb(new bBb(),'',b);c.b=wBb(new bBb(),'',a);jBb(c.c,c.a);jBb(c.c,c.b);vDb(c.c,'searchButtonsPanel');pIb(c.a,(Ceb(),ffb,'Rechercher'));pIb(c.b,(Ceb(),ffb,'Nettoyer'));ABb(c.a,'icon-search');ABb(c.b,'icon-clear');mw(c,c.c);return c;}
...
function Deb(d){var a,b,c;if(d.h!==null){aOb(d.p,d.h);}d.h=qOb(new kOb(),2);a=d.h.b;if(d.a.h){um(xCb(a),'height',d.a.l);}pIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");gCb(d.h,710,d.f);yNb(d.p,d.h);if(d.a.h){um(ul(xCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=ANb(d.p,c).b;um(xCb(b),'height',d.a.l);}}}
function Eeb(g,d){var a,b,c,e,f;gCb(g.p,600,seb(new reb(),g));e=qOb(new kOb(),0);if(hqb(g.n,d.c)!==null){f=BNb(g.p,ri(hqb(g.n,d.c),68));aOb(g.p,ri(hqb(g.n,d.c),68));if(d.g!==null&& !njb(d.g,'')){pIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{pIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}vDb(e,'resultsTabItem');a=e.b;pKb(a,true);if(g.a.h){um(xCb(a),'height',g.a.l);}jqb(g.n,d.c,e);CNb(g.p,ri(hqb(g.n,d.c),68),f);dOb(g.p,e);}else{if(d.g!==null&& !njb(d.g,'')){pIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{pIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}vDb(e,'resultsTabItem');a=e.b;pKb(a,true);if(g.a.h){um(xCb(a),'height',g.a.l);}jqb(g.n,d.c,e);yNb(g.p,ri(hqb(g.n,d.c),68));}jqb(g.d,zCb(e),xfb(new vfb(),false));dOb(g.p,ri(hqb(g.n,d.c),68));if(g.a.h){um(ul(xCb(g.p),1),'height',g.a.l);for(c=0;c<g.p.B.b;c++){b=ANb(g.p,c).b;um(xCb(b),'height',g.a.l);}}}
function Feb(d,b){var a,c;yPb(d.h.b,b);pIb(d.h,'D\xE9tail');dOb(d.p,d.h);if(d.a.h){um(ul(xCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=ANb(d.p,c).b;um(xCb(a),'height',d.a.l);}}}
function afb(g,c,d){var a,b,e,f;e=ri(hqb(g.n,d.c),68);jqb(g.c,zCb(e),c);gCb(e,8,web(new veb(),g));if(d.g!==null&& !njb(d.g,'')){pIb(ri(hqb(g.n,d.c),68),d.g);}else{pIb(ri(hqb(g.n,d.c),68),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(hqb(g.n,d.c))){g.o=true;dOb(g.p,g.i);f=BNb(g.p,ri(hqb(g.n,d.c),68));FPb(ANb(g.p,f).b);yPb(ANb(g.p,f).b,c);if(g.a.h){rDb(ANb(g.p,f),g.a.l);um(ul(xCb(g.p),1),'height',g.a.l);for(b=0;b<g.p.B.b;b++){a=ANb(g.p,b).b;um(xCb(a),'height',g.a.l);}}jqb(g.d,zCb(e),xfb(new vfb(),true));dOb(g.p,ri(hqb(g.n,d.c),68));}}
...
function ifb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;hfb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;zx(p.d,p.e.b,2);if(p.i){zx(p.d,p.e.b+3,2);h=uE(new tE(),'myRadioGroup');pv(h,false);Cz(p.d,0,0,h);f=mC(new kC(),(Ceb(),ffb,'New source'));Cz(p.d,0,1,f);o=AA(new yA());m=mC(new kC(),(Ceb(),ffb,'URL')+':  ');BA(o,m);p.h.qg('sourcesListTextBox');BA(o,p.h);Cz(p.d,1,1,o);c=AA(new yA());l=mC(new kC(),(Ceb(),ffb,'Type')+':  ');BA(c,l);p.a.qg('sourcesListListBox');BA(c,p.a);for(b=0;b<p.c.b;b++){CC(p.a,ri(gnb(p.c,b),1));}Cz(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=kv(new jv());Cz(p.d,b+e,0,a);pv(a,ri(gnb(p.e,b),45).b);j=mC(new kC(),ri(gnb(p.e,b),45).g);Cz(p.d,b+e,1,j);}else{h=uE(new tE(),'myRadioGroup');if(!i&&ri(gnb(p.e,b),45).b){pv(h,true);i=true;}Cz(p.d,b+e,0,h);k=mC(new kC(),ri(gnb(p.e,b),45).g);Cz(p.d,b+e,1,k);}}if(!p.b){if(!i){pv(ri(rz(p.d,0,0),72),true);}}if(lQ(zY,'sourcesListTitle')!==null&& !njb(lQ(zY,'sourcesListTitle'),'')){iGb(p.f,lQ(zY,'sourcesListTitle'));}else{iGb(p.f,(Ceb(),ffb,'Sources disponibles'));}hGb(p.f,5);hCb(p.f,'sourcesListPanel');gGb(p.f,'icon-text');yz(p.d,4);uF(p.g,p.d);p.g.qg('sourcesGrid');yPb(p.f,p.g);mw(p,p.f);return p;}
...
function xSb(){}
_=xSb.prototype=new pib();_.tN=qUb+'DateLocale_fr_CA';_.tI=362;function ESb(a,b){return aob(new Enb(),mob(a),iob(a),eob(a)+b);}
