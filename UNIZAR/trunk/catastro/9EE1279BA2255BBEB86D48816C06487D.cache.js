...
/* The Original Code is 9EE1279BA2255BBEB86D48816C06487D.cache.js
...
function gf(b){var a,c;a=ri(zpb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['av. J.-C.','ap. J.-C.']);Bpb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(zpb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['av. J.-C.','apr. J.-C.']);Bpb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(zpb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);Bpb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(zpb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);Bpb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(zpb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);Bpb(b.a,'shortMonths',c);return c;}else return a;}
function nf(b){var a,c;a=ri(zpb(b.a,'shortQuarters'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['T1','T2','T3','T4']);Bpb(b.a,'shortQuarters',c);return c;}else return a;}
function of(b){var a,c;a=ri(zpb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);Bpb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(zpb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);Bpb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(zpb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['D','L','M','M','J','V','S']);Bpb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(zpb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);Bpb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(zpb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);Bpb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(zpb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);Bpb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(zpb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);Bpb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new bib();_.tN=BSb+'DateTimeConstants_fr_CA';_.tI=18;function Ch(){return null;}
...
function uW(d,a,b,c){if(Fib(a,'viewDetails'))eY(d.a,b,c);else{u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'Comportement non d\xE9fini'),(oeb(),xeb,'Accepter'),null,null,null);}}
...
function BV(){}
_=BV.prototype=new bib();_.tN=lTb+'AVOFilterBuilder';_.tI=162;_.c=null;_.d='CONTAINS WORD';_.g=false;function iW(e,a,f,c){var b,d;b=null;if(Eib(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(Eib(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(Eib(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(Eib(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(Eib(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(Eib(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(Eib(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!Eib(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(oeb(),xeb,'Accepter'),null,null,null);}return b;}
function jW(e,b,d,c){var a;a=null;if(Eib(c,e.c)){a=e.b+b+d+e.a;}else if(Eib(c,e.eb)){a=e.db+b+d+e.cb;}else{u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(oeb(),xeb,'Accepter'),null,null,null);}return a;}
...
function BW(){}
_=BW.prototype=new bib();_.tN=nTb+'CriterionsListElement';_.tI=166;_.a=null;_.b=null;function rX(a){a.p=yY(new nY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=rmb(new pmb());a.g=rmb(new pmb());a.a=rmb(new pmb());a.c=EIb(new zIb(),(oeb(),xeb,'Recherche en cours\u2026'));}
...
function zX(e,b,d,c){var a;if(e.h.p){jMb(e.c);}a=lX(new kX(),e,b,d);peb(e.k);if(e.h.q){CY(e.p,b.a,e8(b),e.m.a,d,(oeb(),xeb,'fr'),a);}else{yX(e,b,e.m.a,d,(oeb(),xeb,'fr'));}}
...
function kY(a,c,b){if(b!==null&& !Fib(b.c,'')){dY(this,a,c);aY(this,this,true,b);}else{u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'Dossier de description de source incorrect')+': '+b.c,(oeb(),xeb,'Accepter'),null,null,null);}}
function cX(){}
...
function gX(b,a){if(b.a.h.p){fMb(b.a.c);}u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'Impossible de connecter au serveur'),(oeb(),xeb,'Accepter'),null,null,null);}
function hX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&djb(e.c)>0){c='';try{if(DP(lY,e.c)!==null&&djb(DP(lY,e.c))>0){c=DP(lY,e.c);}else{c=z6((oeb(),xeb),e.c);}if(Eib(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}u$((oeb(),xeb,'ERREUR'),c,(oeb(),xeb,'Accepter'),null,null,null);}else{fY(f.b,e);}if(f.a.h.p){fMb(f.a.c);}}
...
function nX(b,a){if(b.a.h.p){fMb(b.a.c);}u$((oeb(),xeb,'ERREUR'),(oeb(),xeb,'Impossible de connecter au serveur')+': '+dkb(a),(oeb(),xeb,'Accepter'),null,null,null);}
...
function u3(d,a){var b,c;Abb(d,a);t3(d);d.b=null.Eg;Cbb(d,d);yw(d.e,d);A7(d.k,'mapa',d.a);if(null.Eg==true){if(null.Eg){d.g=rFb(new yEb(),192,'my-cpanel-small');if(null.Eg){xFb(d.g,false);}}else{d.g=rFb(new yEb(),128,'my-cpanel-small');}AFb(d.g,null.Eg);zBb(d.g,'criterionContentPanel');}else{d.g=rFb(new yEb(),0,'internal-compound-cpanel-small');zBb(d.g,'internalCompoundCriterionContentPanel');}d.d.lg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',365,14,[])));nb(c,null.Eg);if(null.Eg!=NaN&&null.Eg!=NaN&&null.Eg!=NaN&&null.Eg!=NaN){d.a=yV(new xV(),d.b,(oeb(),xeb,'fr'),null.Eg,null.Eg,null.Eg,null.Eg,null.Eg,yjb(null.Eg),yjb(null.Eg));}else{d.a=zV(new xV(),d.b,(oeb(),xeb,'fr'),yjb(null.Eg),yjb(null.Eg));}zJ(d.d,8);ou(d.d,d.a);if(null.Eg==true){d.l=kv(new hv(),' '+(oeb(),xeb,'Utiliser la carte'));d.l.Fb(n3(new m3(),d));sK(d.i,d.l);if(null.Eg){nv(d.l,true);}else{nv(d.l,false);AU(d.a);}if(null.Eg){w3(d);}if(null.Eg){d.rg(false);}}sF(d.e,d.d);sK(d.i,d.e);yFb(d.g,'icon-text');d.i.dc('criterionPanel');kPb(d.g,d.i);if(null.Eg){b=new q3();d.h=iBb(new tAb(),(oeb(),xeb,'Nomenclature'),b);bDb(d.h,false);hDb(d.h,'coordinatesCCBGazetteerButton');kPb(d.g,d.h);}kw(d,d.g);return d;}
...
function m3(){}
_=m3.prototype=new bib();_.je=p3;_.tN=pTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=191;function s3(a){yo((oeb(),web,''),(oeb(),xeb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function q3(){}
...
function hGb(b,a){jGb();aMb(b,a);b.c=AAb(new uAb(),67108864);if((a&16777216)!=0){kGb(b,0,'OK');}if((a&67108864)!=0){kGb(b,0,'OK');kGb(b,1,'Annuler');}if((a&268435456)!=0){kGb(b,2,'Oui');kGb(b,3,'Non');}if((a&1073741824)!=0){kGb(b,2,'Oui');kGb(b,3,'Non');kGb(b,1,'Annuler');}return b;}
...
function jcb(j,h){var a,b,c,d,e,f,g,i;kz(j.c);f=Fqb(new Eqb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=B_(new A_());pC(d,'<<');lC(d,j);D_(ri(d,60),1+j.a*j.d-j.d);}else{d=jC(new iC());pC(d,' ');}d.dc('navigationArrowsLeft');brb(f,d);if(h.b!=0){b=B_(new A_());pC(b,(oeb(),xeb,'Pr\xE9c\xE9dent'));lC(b,j);D_(ri(b,60),j.f-1);}else{b=jC(new iC());pC(b,' ');}b.dc('navigationPrevious');brb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=ihb(h.f/j.g);e++){g=B_(new A_());if(e==j.f){g.dc('navigationCurrentPage');}else{lC(g,j);D_(g,e);}pC(g,''+e);brb(f,g);}if(j.f<ihb(h.f/j.g)){i=B_(new A_());pC(i,(oeb(),xeb,'Suivant'));lC(i,j);D_(ri(i,60),j.f+1);}else{i=jC(new iC());pC(i,' ');}i.dc('navigationNext');brb(f,i);if((j.a+1)*j.g*j.d<h.f){c=B_(new A_());pC(c,'>>');lC(c,j);D_(ri(c,60),e);}else{c=jC(new iC());pC(c,' ');}c.dc('navigationArrowsRight');brb(f,c);xx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){Az(j.c,0,a,ri(drb(f,a),61));}}
...
function cdb(c,a,b){bdb(c);c.c=iBb(new tAb(),'',a);c.a=iBb(new tAb(),'',b);BAb(c.b,c.c);BAb(c.b,c.a);bIb(c.c,(oeb(),xeb,'AFFINER'));bIb(c.a,(oeb(),xeb,'NOUVELLE'));mBb(c.c,'icon-refine');mBb(c.a,'icon-new');kw(c,c.b);return c;}
function adb(){}
...
function tdb(c,b,a){sdb(c);c.a=iBb(new tAb(),'',b);c.b=iBb(new tAb(),'',a);BAb(c.c,c.a);BAb(c.c,c.b);hDb(c.c,'searchButtonsPanel');bIb(c.a,(oeb(),xeb,'Rechercher'));bIb(c.b,(oeb(),xeb,'Nettoyer'));mBb(c.a,'icon-search');mBb(c.b,'icon-clear');kw(c,c.c);return c;}
...
function peb(d){var a,b,c;if(d.h!==null){sNb(d.p,d.h);}d.h=cOb(new CNb(),2);a=d.h.b;if(d.a.h){um(jCb(a),'height',d.a.l);}bIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");yBb(d.h,710,d.f);kNb(d.p,d.h);if(d.a.h){um(ul(jCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=mNb(d.p,c).b;um(jCb(b),'height',d.a.l);}}}
function qeb(g,d){var a,b,c,e,f;yBb(g.p,600,eeb(new deb(),g));e=cOb(new CNb(),0);if(zpb(g.n,d.c)!==null){f=nNb(g.p,ri(zpb(g.n,d.c),68));sNb(g.p,ri(zpb(g.n,d.c),68));if(d.g!==null&& !Fib(d.g,'')){bIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{bIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}hDb(e,'resultsTabItem');a=e.b;bKb(a,true);if(g.a.h){um(jCb(a),'height',g.a.l);}Bpb(g.n,d.c,e);oNb(g.p,ri(zpb(g.n,d.c),68),f);vNb(g.p,e);}else{if(d.g!==null&& !Fib(d.g,'')){bIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{bIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}hDb(e,'resultsTabItem');a=e.b;bKb(a,true);if(g.a.h){um(jCb(a),'height',g.a.l);}Bpb(g.n,d.c,e);kNb(g.p,ri(zpb(g.n,d.c),68));}Bpb(g.d,lCb(e),jfb(new hfb(),false));vNb(g.p,ri(zpb(g.n,d.c),68));if(g.a.h){um(ul(jCb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=mNb(g.p,c).b;um(jCb(b),'height',g.a.l);}}}
function reb(d,b){var a,c;kPb(d.h.b,b);bIb(d.h,'D\xE9tail');vNb(d.p,d.h);if(d.a.h){um(ul(jCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=mNb(d.p,c).b;um(jCb(a),'height',d.a.l);}}}
function seb(g,c,d){var a,b,e,f;e=ri(zpb(g.n,d.c),68);Bpb(g.c,lCb(e),c);yBb(e,8,ieb(new heb(),g));if(d.g!==null&& !Fib(d.g,'')){bIb(ri(zpb(g.n,d.c),68),d.g);}else{bIb(ri(zpb(g.n,d.c),68),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(zpb(g.n,d.c))){g.o=true;vNb(g.p,g.i);f=nNb(g.p,ri(zpb(g.n,d.c),68));rPb(mNb(g.p,f).b);kPb(mNb(g.p,f).b,c);if(g.a.h){dDb(mNb(g.p,f),g.a.l);um(ul(jCb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=mNb(g.p,b).b;um(jCb(a),'height',g.a.l);}}Bpb(g.d,lCb(e),jfb(new hfb(),true));vNb(g.p,ri(zpb(g.n,d.c),68));}}
...
function jSb(){}
_=jSb.prototype=new bib();_.tN=cUb+'DateLocale_fr_CA';_.tI=360;function qSb(a,b){return snb(new qnb(),Enb(a),Anb(a),wnb(a)+b);}
