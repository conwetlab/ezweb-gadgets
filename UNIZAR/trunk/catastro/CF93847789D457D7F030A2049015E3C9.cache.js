...
/* The Original Code is CF93847789D457D7F030A2049015E3C9.cache.js
...
function ef(b){var a,c;a=ri(xpb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['vorm.','nachm.']);zpb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(xpb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['v. Chr.','n. Chr.']);zpb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(xpb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['v. Chr.','n. Chr.']);zpb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(xpb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);zpb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(xpb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);zpb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(xpb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);zpb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(xpb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['So','Mo','Di','Mi','Do','Fr','Sa']);zpb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(xpb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);zpb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(xpb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['S','M','D','M','D','F','S']);zpb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(xpb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);zpb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(xpb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['So','Mo','Di','Mi','Do','Fr','Sa']);zpb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(xpb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);zpb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(xpb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',361,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);zpb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new Fhb();_.tN=zSb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function fGb(b,a){hGb();ELb(b,a);b.c=yAb(new sAb(),67108864);if((a&16777216)!=0){iGb(b,0,'OK');}if((a&67108864)!=0){iGb(b,0,'OK');iGb(b,1,'Abbrechen');}if((a&268435456)!=0){iGb(b,2,'Ja');iGb(b,3,'Nein');}if((a&1073741824)!=0){iGb(b,2,'Ja');iGb(b,3,'Nein');iGb(b,1,'Abbrechen');}return b;}
...
function hSb(){}
_=hSb.prototype=new Fhb();_.tN=aUb+'DateLocale_de_CH';_.tI=359;function oSb(a,b){return qnb(new onb(),Cnb(a),ynb(a),unb(a)+b);}
