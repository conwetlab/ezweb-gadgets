...
/* The Original Code is 9A822BEEDFBD27BE2F1BE4B79C6A4787.cache.js
...
function gf(b){var a,c;a=ri(hqb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['av. J.-C.','ap. J.-C.']);jqb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(hqb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['av. J.-C.','apr. J.-C.']);jqb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(hqb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);jqb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(hqb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);jqb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(hqb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);jqb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(hqb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);jqb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(hqb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);jqb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function sf(b){var a,c;a=ri(hqb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);jqb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(hqb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);jqb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(hqb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);jqb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(hqb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',364,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);jqb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new pib();_.tN=lTb+'DateTimeConstants_fr_CA';_.tI=18;function Ch(){return null;}
...
function cX(d,a,b,c){if(njb(a,'viewDetails'))sY(d.a,b,c);else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Comportement non d\xE9fini'),(Ceb(),ffb,'Accepter'),null,null,null);}}
...
function jW(){}
_=jW.prototype=new pib();_.tN=BTb+'AVOFilterBuilder';_.tI=163;_.c=null;_.d='CONTAINS WORD';_.g=false;function wW(e,a,f,c){var b,d;b=null;if(mjb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(mjb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(mjb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(mjb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(mjb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(mjb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(mjb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!mjb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(Ceb(),ffb,'Accepter'),null,null,null);}return b;}
function xW(e,b,d,c){var a;a=null;if(mjb(c,e.c)){a=e.b+b+d+e.a;}else if(mjb(c,e.eb)){a=e.db+b+d+e.cb;}else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(Ceb(),ffb,'Accepter'),null,null,null);}return a;}
...
function jX(){}
_=jX.prototype=new pib();_.tN=DTb+'CriterionsListElement';_.tI=167;_.a=null;_.b=null;function FX(a){a.p=gZ(new BY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Fmb(new Dmb());a.g=Fmb(new Dmb());a.a=Fmb(new Dmb());a.c=oJb(new jJb(),(Ceb(),ffb,'Recherche en cours\u2026'));}
...
function hY(e,b,d,c){var a;if(e.h.p){zMb(e.c);}a=zX(new yX(),e,b,d);Deb(e.k);if(e.h.q){kZ(e.p,b.a,s8(b),e.m.a,d,(Ceb(),ffb,'fr'),a);}else{gY(e,b,e.m.a,d,(Ceb(),ffb,'fr'));}}
...
function yY(a,c,b){if(b!==null&& !njb(b.c,'')){rY(this,a,c);oY(this,this,true,b);}else{c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Dossier de description de source incorrect')+': '+b.c,(Ceb(),ffb,'Accepter'),null,null,null);}}
function qX(){}
...
function uX(b,a){if(b.a.h.p){vMb(b.a.c);}c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Impossible de connecter au serveur'),(Ceb(),ffb,'Accepter'),null,null,null);}
function vX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&rjb(e.c)>0){c='';try{if(lQ(zY,e.c)!==null&&rjb(lQ(zY,e.c))>0){c=lQ(zY,e.c);}else{c=h7((Ceb(),ffb),e.c);}if(mjb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}c_((Ceb(),ffb,'ERREUR'),c,(Ceb(),ffb,'Accepter'),null,null,null);}else{tY(f.b,e);}if(f.a.h.p){vMb(f.a.c);}}
...
function BX(b,a){if(b.a.h.p){vMb(b.a.c);}c_((Ceb(),ffb,'ERREUR'),(Ceb(),ffb,'Impossible de connecter au serveur')+': '+rkb(a),(Ceb(),ffb,'Accepter'),null,null,null);}
...
function c4(d,a){var b,c;icb(d,a);b4(d);d.b=null.Dg;kcb(d,d);dx(d.e,d);i8(d.k,'mapa',d.a);if(null.Dg==true){if(null.Dg){d.g=bGb(new iFb(),192,'my-cpanel-small');if(null.Dg){hGb(d.g,false);}}else{d.g=bGb(new iFb(),128,'my-cpanel-small');}kGb(d.g,null.Dg);jCb(d.g,'criterionContentPanel');}else{d.g=bGb(new iFb(),0,'internal-compound-cpanel-small');jCb(d.g,'internalCompoundCriterionContentPanel');}d.d.kg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',367,14,[])));nb(c,null.Dg);if(null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN){d.a=gW(new fW(),d.b,(Ceb(),ffb,'fr'),null.Dg,null.Dg,null.Dg,null.Dg,null.Dg,gkb(null.Dg),gkb(null.Dg));}else{d.a=hW(new fW(),d.b,(Ceb(),ffb,'fr'),gkb(null.Dg),gkb(null.Dg));}eK(d.d,8);zu(d.d,d.a);if(null.Dg==true){d.l=vv(new sv(),' '+(Ceb(),ffb,'Utiliser la carte'));d.l.Fb(B3(new A3(),d));DK(d.i,d.l);if(null.Dg){yv(d.l,true);}else{yv(d.l,false);iV(d.a);}if(null.Dg){e4(d);}if(null.Dg){d.qg(false);}}DF(d.e,d.d);DK(d.i,d.e);iGb(d.g,'icon-text');d.i.dc('criterionPanel');APb(d.g,d.i);if(null.Dg){b=new E3();d.h=yBb(new dBb(),(Ceb(),ffb,'Nomenclature'),b);rDb(d.h,false);xDb(d.h,'coordinatesCCBGazetteerButton');APb(d.g,d.h);}vw(d,d.g);return d;}
...
function A3(){}
_=A3.prototype=new pib();_.ie=D3;_.tN=FTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=192;function a4(a){yo((Ceb(),efb,''),(Ceb(),ffb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function E3(){}
...
function h7(d,b){var a,c;c=ri(hqb(d.a,b),1);if(c!==null)return c;if(njb(b,'OuterServiceException')){a='Outer service reported an exception';jqb(d.a,'OuterServiceException',a);return a;}if(njb(b,'UnableToInitIndex')){a='Unable to init an index';jqb(d.a,'UnableToInitIndex',a);return a;}if(njb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: op\xE9ration logique valide';jqb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(njb(b,'usarMapa')){a='Utiliser la carte';jqb(d.a,'usarMapa',a);return a;}if(njb(b,'hasta')){a='\xE0';jqb(d.a,'hasta',a);return a;}if(njb(b,'resultados')){a='R\xE9sultats';jqb(d.a,'resultados',a);return a;}if(njb(b,'valueErrors')){a='Error entering search criteria';jqb(d.a,'valueErrors',a);return a;}if(njb(b,'ningunCriterioIntroducido')){a='Vous devez saisir un crit\xE8re pour lancer la rechercher';jqb(d.a,'ningunCriterioIntroducido',a);return a;}if(njb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';jqb(d.a,'requiredCriterionError',a);return a;}if(njb(b,'gazetteerTitle')){a='Nomenclature';jqb(d.a,'gazetteerTitle',a);return a;}if(njb(b,'sourceURLTitle')){a='URL';jqb(d.a,'sourceURLTitle',a);return a;}if(njb(b,'UnknownFaliure')){a='Unknown service failure';jqb(d.a,'UnknownFaliure',a);return a;}if(njb(b,'okButtonLabel')){a='Accepter';jqb(d.a,'okButtonLabel',a);return a;}if(njb(b,'nuevaBusqueda')){a='NOUVELLE';jqb(d.a,'nuevaBusqueda',a);return a;}if(njb(b,'refinar')){a='AFFINER';jqb(d.a,'refinar',a);return a;}if(njb(b,'newSourceTitle')){a='New source';jqb(d.a,'newSourceTitle',a);return a;}if(njb(b,'anterior')){a='Pr\xE9c\xE9dent';jqb(d.a,'anterior',a);return a;}if(njb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";jqb(d.a,'UnableToReadSourceResponse',a);return a;}if(njb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';jqb(d.a,'UnableToSynchroniseSource',a);return a;}if(njb(b,'siguiente')){a='Suivant';jqb(d.a,'siguiente',a);return a;}if(njb(b,'UnsupportedEncoding')){a='Unsupported Encoding';jqb(d.a,'UnsupportedEncoding',a);return a;}if(njb(b,'connection_error')){a='Impossible de connecter au serveur';jqb(d.a,'connection_error',a);return a;}if(njb(b,'limpiar')){a='Nettoyer';jqb(d.a,'limpiar',a);return a;}if(njb(b,'NoReachableOuterService')){a='Could not connect with the outer service';jqb(d.a,'NoReachableOuterService',a);return a;}if(njb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';jqb(d.a,'UnableToRemoveFromIndex',a);return a;}if(njb(b,'sourcesListTitle')){a='Sources disponibles';jqb(d.a,'sourcesListTitle',a);return a;}if(njb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';jqb(d.a,'UnableToInitSource',a);return a;}if(njb(b,'ayuda')){a='Aide';jqb(d.a,'ayuda',a);return a;}if(njb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";jqb(d.a,'NoReachableRDF',a);return a;}if(njb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';jqb(d.a,'UnableToPerformInsertion',a);return a;}if(njb(b,'deUnTotalDe')){a='sur un total de';jqb(d.a,'deUnTotalDe',a);return a;}if(njb(b,'invalidDate')){a='Invalid date';jqb(d.a,'invalidDate',a);return a;}if(njb(b,'sinResultados')){a="Aucun r\xE9sultat n'a \xE9t\xE9 trouv\xE9";jqb(d.a,'sinResultados',a);return a;}if(njb(b,'aceptar')){a='Accepter';jqb(d.a,'aceptar',a);return a;}if(njb(b,'buscar')){a='Rechercher';jqb(d.a,'buscar',a);return a;}if(njb(b,'ResultList_Title')){a='Liste de r\xE9sultats';jqb(d.a,'ResultList_Title',a);return a;}if(njb(b,'buscando')){a='Recherche en cours\u2026';jqb(d.a,'buscando',a);return a;}if(njb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';jqb(d.a,'NoReachablePool',a);return a;}if(njb(b,'sourceTypeTitle')){a='Type';jqb(d.a,'sourceTypeTitle',a);return a;}if(njb(b,'SearchInfo_Title')){a='Information de la requ\xEAte';jqb(d.a,'SearchInfo_Title',a);return a;}if(njb(b,'undefinedBehaviour')){a='Comportement non d\xE9fini';jqb(d.a,'undefinedBehaviour',a);return a;}if(njb(b,'detalle')){a='D\xE9tail';jqb(d.a,'detalle',a);return a;}if(njb(b,'error')){a='ERREUR';jqb(d.a,'error',a);return a;}if(njb(b,'loading')){a='Chargement\u2026';jqb(d.a,'loading',a);return a;}if(njb(b,'resultComponentVoid')){a='-';jqb(d.a,'resultComponentVoid',a);return a;}if(njb(b,'busquedaAnterior')){a='PR\xC9C\xC9DENT';jqb(d.a,'busquedaAnterior',a);return a;}if(njb(b,'wrongSourceDescriptionFile')){a='Dossier de description de source incorrect';jqb(d.a,'wrongSourceDescriptionFile',a);return a;}if(njb(b,'locale')){a='fr';jqb(d.a,'locale',a);return a;}if(njb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";jqb(d.a,'NotAValidQuery',a);return a;}if(njb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: op\xE9ration invalide';jqb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw brb(new arb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function d7(){}
_=d7.prototype=new pib();_.tN=bUb+'Messages_fr';_.tI=197;function j7(a){a.a=Fmb(new Dmb());}
...
function xGb(b,a){zGb();qMb(b,a);b.c=kBb(new eBb(),67108864);if((a&16777216)!=0){AGb(b,0,'OK');}if((a&67108864)!=0){AGb(b,0,'OK');AGb(b,1,'Annuler');}if((a&268435456)!=0){AGb(b,2,'Oui');AGb(b,3,'Non');}if((a&1073741824)!=0){AGb(b,2,'Oui');AGb(b,3,'Non');AGb(b,1,'Annuler');}return b;}
...
function xcb(j,h){var a,b,c,d,e,f,g,i;vz(j.c);f=nrb(new mrb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=jab(new iab());AC(d,'<<');wC(d,j);lab(ri(d,60),1+j.a*j.d-j.d);}else{d=uC(new tC());AC(d,' ');}d.dc('navigationArrowsLeft');prb(f,d);if(h.b!=0){b=jab(new iab());AC(b,(Ceb(),ffb,'Pr\xE9c\xE9dent'));wC(b,j);lab(ri(b,60),j.f-1);}else{b=uC(new tC());AC(b,' ');}b.dc('navigationPrevious');prb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=whb(h.f/j.g);e++){g=jab(new iab());if(e==j.f){g.dc('navigationCurrentPage');}else{wC(g,j);lab(g,e);}AC(g,''+e);prb(f,g);}if(j.f<whb(h.f/j.g)){i=jab(new iab());AC(i,(Ceb(),ffb,'Suivant'));wC(i,j);lab(ri(i,60),j.f+1);}else{i=uC(new tC());AC(i,' ');}i.dc('navigationNext');prb(f,i);if((j.a+1)*j.g*j.d<h.f){c=jab(new iab());AC(c,'>>');wC(c,j);lab(ri(c,60),e);}else{c=uC(new tC());AC(c,' ');}c.dc('navigationArrowsRight');prb(f,c);cy(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){fA(j.c,0,a,ri(rrb(f,a),61));}}
...
function qdb(c,a,b){pdb(c);c.c=yBb(new dBb(),'',a);c.a=yBb(new dBb(),'',b);lBb(c.b,c.c);lBb(c.b,c.a);rIb(c.c,(Ceb(),ffb,'AFFINER'));rIb(c.a,(Ceb(),ffb,'NOUVELLE'));CBb(c.c,'icon-refine');CBb(c.a,'icon-new');vw(c,c.b);return c;}
function odb(){}
...
function beb(c,b,a){aeb(c);c.a=yBb(new dBb(),'',b);c.b=yBb(new dBb(),'',a);lBb(c.c,c.a);lBb(c.c,c.b);xDb(c.c,'searchButtonsPanel');rIb(c.a,(Ceb(),ffb,'Rechercher'));rIb(c.b,(Ceb(),ffb,'Nettoyer'));CBb(c.a,'icon-search');CBb(c.b,'icon-clear');vw(c,c.c);return c;}
...
function Deb(d){var a,b,c;if(d.h!==null){cOb(d.p,d.h);}d.h=sOb(new mOb(),2);a=d.h.b;if(d.a.h){um(zCb(a),'height',d.a.l);}rIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");iCb(d.h,710,d.f);ANb(d.p,d.h);if(d.a.h){um(ul(zCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=CNb(d.p,c).b;um(zCb(b),'height',d.a.l);}}}
function Eeb(g,d){var a,b,c,e,f;iCb(g.p,600,seb(new reb(),g));e=sOb(new mOb(),0);if(hqb(g.n,d.c)!==null){f=DNb(g.p,ri(hqb(g.n,d.c),68));cOb(g.p,ri(hqb(g.n,d.c),68));if(d.g!==null&& !njb(d.g,'')){rIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{rIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}xDb(e,'resultsTabItem');a=e.b;rKb(a,true);if(g.a.h){um(zCb(a),'height',g.a.l);}jqb(g.n,d.c,e);ENb(g.p,ri(hqb(g.n,d.c),68),f);fOb(g.p,e);}else{if(d.g!==null&& !njb(d.g,'')){rIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{rIb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}xDb(e,'resultsTabItem');a=e.b;rKb(a,true);if(g.a.h){um(zCb(a),'height',g.a.l);}jqb(g.n,d.c,e);ANb(g.p,ri(hqb(g.n,d.c),68));}jqb(g.d,BCb(e),xfb(new vfb(),false));fOb(g.p,ri(hqb(g.n,d.c),68));if(g.a.h){um(ul(zCb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=CNb(g.p,c).b;um(zCb(b),'height',g.a.l);}}}
function Feb(d,b){var a,c;APb(d.h.b,b);rIb(d.h,'D\xE9tail');fOb(d.p,d.h);if(d.a.h){um(ul(zCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=CNb(d.p,c).b;um(zCb(a),'height',d.a.l);}}}
function afb(g,c,d){var a,b,e,f;e=ri(hqb(g.n,d.c),68);jqb(g.c,BCb(e),c);iCb(e,8,web(new veb(),g));if(d.g!==null&& !njb(d.g,'')){rIb(ri(hqb(g.n,d.c),68),d.g);}else{rIb(ri(hqb(g.n,d.c),68),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(hqb(g.n,d.c))){g.o=true;fOb(g.p,g.i);f=DNb(g.p,ri(hqb(g.n,d.c),68));bQb(CNb(g.p,f).b);APb(CNb(g.p,f).b,c);if(g.a.h){tDb(CNb(g.p,f),g.a.l);um(ul(zCb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=CNb(g.p,b).b;um(zCb(a),'height',g.a.l);}}jqb(g.d,BCb(e),xfb(new vfb(),true));fOb(g.p,ri(hqb(g.n,d.c),68));}}
...
function ifb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;hfb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;cy(p.d,p.e.b,2);if(p.i){cy(p.d,p.e.b+3,2);h=DE(new CE(),'myRadioGroup');yv(h,false);fA(p.d,0,0,h);f=vC(new tC(),(Ceb(),ffb,'New source'));fA(p.d,0,1,f);o=dB(new bB());m=vC(new tC(),(Ceb(),ffb,'URL')+':  ');eB(o,m);p.h.kg('sourcesListTextBox');eB(o,p.h);fA(p.d,1,1,o);c=dB(new bB());l=vC(new tC(),(Ceb(),ffb,'Type')+':  ');eB(c,l);p.a.kg('sourcesListListBox');eB(c,p.a);for(b=0;b<p.c.b;b++){fD(p.a,ri(gnb(p.c,b),1));}fA(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=tv(new sv());fA(p.d,b+e,0,a);yv(a,ri(gnb(p.e,b),45).b);j=vC(new tC(),ri(gnb(p.e,b),45).g);fA(p.d,b+e,1,j);}else{h=DE(new CE(),'myRadioGroup');if(!i&&ri(gnb(p.e,b),45).b){yv(h,true);i=true;}fA(p.d,b+e,0,h);k=vC(new tC(),ri(gnb(p.e,b),45).g);fA(p.d,b+e,1,k);}}if(!p.b){if(!i){yv(ri(Az(p.d,0,0),72),true);}}if(lQ(zY,'sourcesListTitle')!==null&& !njb(lQ(zY,'sourcesListTitle'),'')){kGb(p.f,lQ(zY,'sourcesListTitle'));}else{kGb(p.f,(Ceb(),ffb,'Sources disponibles'));}jGb(p.f,5);jCb(p.f,'sourcesListPanel');iGb(p.f,'icon-text');bA(p.d,4);DF(p.g,p.d);p.g.kg('sourcesGrid');APb(p.f,p.g);vw(p,p.f);return p;}
...
function zSb(){}
_=zSb.prototype=new pib();_.tN=sUb+'DateLocale_fr_CA';_.tI=362;function aTb(a,b){return aob(new Enb(),mob(a),iob(a),eob(a)+b);}
