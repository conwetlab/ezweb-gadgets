...
/* The Original Code is C4F9FED26D6AD6588EF1F163378B8FC0.cache.js
...
function bf(){}
_=bf.prototype=new pib();_.tN=lTb+'DateTimeConstants_pt_BR';_.tI=18;function Ch(){return null;}
...
function jW(){}
_=jW.prototype=new pib();_.tN=BTb+'AVOFilterBuilder';_.tI=163;_.c=null;_.d='CONTAINS WORD';_.g=false;function wW(e,a,f,c){var b,d;b=null;if(mjb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(mjb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(mjb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(mjb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(mjb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(mjb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(mjb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!mjb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c_((Ceb(),ffb,'ERRO'),(Ceb(),ffb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(Ceb(),ffb,'Aceitar'),null,null,null);}return b;}
function xW(e,b,d,c){var a;a=null;if(mjb(c,e.c)){a=e.b+b+d+e.a;}else if(mjb(c,e.eb)){a=e.db+b+d+e.cb;}else{c_((Ceb(),ffb,'ERRO'),(Ceb(),ffb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(Ceb(),ffb,'Aceitar'),null,null,null);}return a;}
...
function jX(){}
_=jX.prototype=new pib();_.tN=DTb+'CriterionsListElement';_.tI=167;_.a=null;_.b=null;function FX(a){a.p=gZ(new BY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Fmb(new Dmb());a.g=Fmb(new Dmb());a.a=Fmb(new Dmb());a.c=oJb(new jJb(),(Ceb(),ffb,'Pesquisando...'));}
...
function hY(e,b,d,c){var a;if(e.h.p){zMb(e.c);}a=zX(new yX(),e,b,d);Deb(e.k);if(e.h.q){kZ(e.p,b.a,s8(b),e.m.a,d,(Ceb(),ffb,'pt'),a);}else{gY(e,b,e.m.a,d,(Ceb(),ffb,'pt'));}}
...
function uX(b,a){if(b.a.h.p){vMb(b.a.c);}c_((Ceb(),ffb,'ERRO'),(Ceb(),ffb,'N\xE3o se p\xF4de ligar com o servidor'),(Ceb(),ffb,'Aceitar'),null,null,null);}
function vX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&rjb(e.c)>0){c='';try{if(lQ(zY,e.c)!==null&&rjb(lQ(zY,e.c))>0){c=lQ(zY,e.c);}else{c=h7((Ceb(),ffb),e.c);}if(mjb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}c_((Ceb(),ffb,'ERRO'),c,(Ceb(),ffb,'Aceitar'),null,null,null);}else{tY(f.b,e);}if(f.a.h.p){vMb(f.a.c);}}
...
function BX(b,a){if(b.a.h.p){vMb(b.a.c);}c_((Ceb(),ffb,'ERRO'),(Ceb(),ffb,'N\xE3o se p\xF4de ligar com o servidor')+': '+rkb(a),(Ceb(),ffb,'Aceitar'),null,null,null);}
...
function c4(d,a){var b,c;icb(d,a);b4(d);d.b=null.Dg;kcb(d,d);dx(d.e,d);i8(d.k,'mapa',d.a);if(null.Dg==true){if(null.Dg){d.g=bGb(new iFb(),192,'my-cpanel-small');if(null.Dg){hGb(d.g,false);}}else{d.g=bGb(new iFb(),128,'my-cpanel-small');}kGb(d.g,null.Dg);jCb(d.g,'criterionContentPanel');}else{d.g=bGb(new iFb(),0,'internal-compound-cpanel-small');jCb(d.g,'internalCompoundCriterionContentPanel');}d.d.kg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',367,14,[])));nb(c,null.Dg);if(null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN){d.a=gW(new fW(),d.b,(Ceb(),ffb,'pt'),null.Dg,null.Dg,null.Dg,null.Dg,null.Dg,gkb(null.Dg),gkb(null.Dg));}else{d.a=hW(new fW(),d.b,(Ceb(),ffb,'pt'),gkb(null.Dg),gkb(null.Dg));}eK(d.d,8);zu(d.d,d.a);if(null.Dg==true){d.l=vv(new sv(),' '+(Ceb(),ffb,'Usar mapa'));d.l.Fb(B3(new A3(),d));DK(d.i,d.l);if(null.Dg){yv(d.l,true);}else{yv(d.l,false);iV(d.a);}if(null.Dg){e4(d);}if(null.Dg){d.qg(false);}}DF(d.e,d.d);DK(d.i,d.e);iGb(d.g,'icon-text');d.i.dc('criterionPanel');APb(d.g,d.i);if(null.Dg){b=new E3();d.h=yBb(new dBb(),(Ceb(),ffb,'Nomenclatura'),b);rDb(d.h,false);xDb(d.h,'coordinatesCCBGazetteerButton');APb(d.g,d.h);}vw(d,d.g);return d;}
...
function A3(){}
_=A3.prototype=new pib();_.ie=D3;_.tN=FTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=192;function a4(a){yo((Ceb(),efb,''),(Ceb(),ffb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function E3(){}
...
function d7(){}
_=d7.prototype=new pib();_.tN=bUb+'Messages_pt';_.tI=197;function j7(a){a.a=Fmb(new Dmb());}
...
function qdb(c,a,b){pdb(c);c.c=yBb(new dBb(),'',a);c.a=yBb(new dBb(),'',b);lBb(c.b,c.c);lBb(c.b,c.a);rIb(c.c,(Ceb(),ffb,'REFINAR '));rIb(c.a,(Ceb(),ffb,'NOVA'));CBb(c.c,'icon-refine');CBb(c.a,'icon-new');vw(c,c.b);return c;}
function odb(){}
...
function beb(c,b,a){aeb(c);c.a=yBb(new dBb(),'',b);c.b=yBb(new dBb(),'',a);lBb(c.c,c.a);lBb(c.c,c.b);xDb(c.c,'searchButtonsPanel');rIb(c.a,(Ceb(),ffb,'Pesquisar'));rIb(c.b,(Ceb(),ffb,'Limpar'));CBb(c.a,'icon-search');CBb(c.b,'icon-clear');vw(c,c.c);return c;}
...
function Deb(d){var a,b,c;if(d.h!==null){cOb(d.p,d.h);}d.h=sOb(new mOb(),2);a=d.h.b;if(d.a.h){um(zCb(a),'height',d.a.l);}rIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");iCb(d.h,710,d.f);ANb(d.p,d.h);if(d.a.h){um(ul(zCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=CNb(d.p,c).b;um(zCb(b),'height',d.a.l);}}}
...
function Feb(d,b){var a,c;APb(d.h.b,b);rIb(d.h,'Pormenor');fOb(d.p,d.h);if(d.a.h){um(ul(zCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=CNb(d.p,c).b;um(zCb(a),'height',d.a.l);}}}
...
function ifb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;hfb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;cy(p.d,p.e.b,2);if(p.i){cy(p.d,p.e.b+3,2);h=DE(new CE(),'myRadioGroup');yv(h,false);fA(p.d,0,0,h);f=vC(new tC(),(Ceb(),ffb,'New source'));fA(p.d,0,1,f);o=dB(new bB());m=vC(new tC(),(Ceb(),ffb,'URL')+':  ');eB(o,m);p.h.kg('sourcesListTextBox');eB(o,p.h);fA(p.d,1,1,o);c=dB(new bB());l=vC(new tC(),(Ceb(),ffb,'Type')+':  ');eB(c,l);p.a.kg('sourcesListListBox');eB(c,p.a);for(b=0;b<p.c.b;b++){fD(p.a,ri(gnb(p.c,b),1));}fA(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=tv(new sv());fA(p.d,b+e,0,a);yv(a,ri(gnb(p.e,b),45).b);j=vC(new tC(),ri(gnb(p.e,b),45).g);fA(p.d,b+e,1,j);}else{h=DE(new CE(),'myRadioGroup');if(!i&&ri(gnb(p.e,b),45).b){yv(h,true);i=true;}fA(p.d,b+e,0,h);k=vC(new tC(),ri(gnb(p.e,b),45).g);fA(p.d,b+e,1,k);}}if(!p.b){if(!i){yv(ri(Az(p.d,0,0),72),true);}}if(lQ(zY,'sourcesListTitle')!==null&& !njb(lQ(zY,'sourcesListTitle'),'')){kGb(p.f,lQ(zY,'sourcesListTitle'));}else{kGb(p.f,(Ceb(),ffb,'Fontes dispon\xEDveis'));}jGb(p.f,5);jCb(p.f,'sourcesListPanel');iGb(p.f,'icon-text');bA(p.d,4);DF(p.g,p.d);p.g.kg('sourcesGrid');APb(p.f,p.g);vw(p,p.f);return p;}
...
function zSb(){}
_=zSb.prototype=new pib();_.tN=sUb+'DateLocale_pt_BR';_.tI=362;function aTb(a,b){return aob(new Enb(),mob(a),iob(a),eob(a)+b);}
