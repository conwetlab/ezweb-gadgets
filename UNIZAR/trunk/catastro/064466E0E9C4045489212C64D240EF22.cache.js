...
/* The Original Code is 064466E0E9C4045489212C64D240EF22.cache.js
...
function th(b){var a,c;a=Dk(brb(b.a,'eraNames'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['a.C.','d.C.']);drb(b.a,'eraNames',c);return c;}else return a;}
function uh(b){var a,c;a=Dk(brb(b.a,'eras'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['a.C.','d.C.']);drb(b.a,'eras',c);return c;}else return a;}
function vh(b){var a,c;a=Dk(brb(b.a,'months'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);drb(b.a,'months',c);return c;}else return a;}
...
function xh(b){var a,c;a=Dk(brb(b.a,'quarters'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);drb(b.a,'quarters',c);return c;}else return a;}
function yh(b){var a,c;a=Dk(brb(b.a,'shortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);drb(b.a,'shortMonths',c);return c;}else return a;}
...
function Ah(b){var a,c;a=Dk(brb(b.a,'shortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);drb(b.a,'shortWeekdays',c);return c;}else return a;}
function Bh(b){var a,c;a=Dk(brb(b.a,'standaloneMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);drb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Dh(b){var a,c;a=Dk(brb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['D','S','T','Q','Q','S','S']);drb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Dk(brb(b.a,'standaloneShortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);drb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Fh(b){var a,c;a=Dk(brb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);drb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function ai(b){var a,c;a=Dk(brb(b.a,'standaloneWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);drb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function bi(b){var a,c;a=Dk(brb(b.a,'weekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',363,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);drb(b.a,'weekdays',c);return c;}else return a;}
function oh(){}
_=oh.prototype=new ijb();_.tN=iUb+'DateTimeConstants_pt_BR';_.tI=28;function ik(){return null;}
...
function vX(d,a,b,c){if(gkb(a,'viewDetails'))fZ(d.a,b,c);else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'Comportamento n\xE3o definido'),(vfb(),Efb,'Aceitar'),null,null,null);}}
...
function CW(){}
_=CW.prototype=new ijb();_.tN=wUb+'AVOFilterBuilder';_.tI=160;_.c=null;_.d='CONTAINS WORD';_.g=false;function jX(e,a,f,c){var b,d;b=null;if(fkb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(fkb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(fkb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(fkb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(fkb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(fkb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(fkb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!fkb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(vfb(),Efb,'Aceitar'),null,null,null);}return b;}
function kX(e,b,d,c){var a;a=null;if(fkb(c,e.c)){a=e.b+b+d+e.a;}else if(fkb(c,e.eb)){a=e.db+b+d+e.cb;}else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(vfb(),Efb,'Aceitar'),null,null,null);}return a;}
...
function CX(){}
_=CX.prototype=new ijb();_.tN=yUb+'CriterionsListElement';_.tI=164;_.a=null;_.b=null;function sY(a){a.p=zZ(new oZ());a.j=a.p;a.n=le()+'SearchControllerServer';a.e=znb(new xnb());a.g=znb(new xnb());a.a=znb(new xnb());a.c=iKb(new dKb(),(vfb(),Efb,'Pesquisando...'));}
...
function AY(e,b,d,c){var a;if(e.h.p){tNb(e.c);}a=mY(new lY(),e,b,d);wfb(e.k);if(e.h.q){DZ(e.p,b.a,f9(b),e.m.a,d,(vfb(),Efb,'pt'),a);}else{zY(e,b,e.m.a,d,(vfb(),Efb,'pt'));}}
...
function FY(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=A$(new r$());t=new k1();e=ihb(jj(s,'totalLength').tS());d_(q,bhb(e));a_(q,oab(jj(s,'queryErrorCode').Cd().a));b_(q,oab(jj(s,'queryErrorMessage').Cd().a));if(q.c!==null&&kkb(q.c)>0){g='';try{if(rS(mZ,q.c)!==null&&kkb(rS(mZ,q.c))>0){g=rS(mZ,q.c);}else{g=A7((vfb(),Efb),q.c);}if(fkb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=jl(a);if(Ek(a,38)){a;g=q.d;}else throw a;}v_((vfb(),Efb,'ERRO'),g,(vfb(),Efb,'Aceitar'),null,null,null);}else{n1(t,jj(s,'initiallySelectedSource').Ad().a);o1(t,oab(jj(s,'sourceName').Cd().a));p1(t,oab(jj(s,'sourceRDF').Cd().a));s1(t,oab(jj(s,'sourceTitle').Cd().a));u1(t,jj(s,'useSourceRDF').Ad().a);t1(t,jj(s,'useRDFMetadata').Ad().a);m1(t,jj(s,'createRDF').Ad().a);r1(t,oab(jj(s,'sourceServiceURL').Cd().a));q1(t,oab(jj(s,'sourceServiceType').Cd().a));for(h=0;h<li(r);h++){p=t$(new s$());o=hi(r,h);n=di(new ci());if((n=o.yd())!==null){k=hi(n,0).Bd();g9(p.a,oab(jj(k,'fileIdentifier').Cd().a));h9(p.a,oab(jj(k,'metadataLanguage').Cd().a));m=znb(new xnb());d=hi(n,1);c=di(new ci());if((c=d.yd())!==null){for(i=0;i<li(c);i++){j=hi(c,i).Bd();l=new B9();a$(l,oab(jj(j,'text').Cd().a));D9(l,oab(jj(j,'alternativeText').Cd().a));f=ihb(jj(j,'type').tS());c$(l,bhb(f));b$(l,oab(jj(j,'tooltip').Cd().a));E9(l,oab(jj(j,'condition').Cd().a));F9(l,oab(jj(j,'function').Cd().a));Anb(m,i,l);}}v$(p,m);}B$(q,p);}c_(q,t);F$(q,u.l);e_(q,u.r);if(u.h.p){pNb(u.c);}gZ(u,q);}}
function bZ(f,c,d,e){var a,b;if(f.h.s){tab(f.h.j,f.h.i);f.h.k.rg(true);}a=fY(new eY(),f,c);if(d){f.d=f.m.a;}else{f.d=DY(f);n_(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&kkb(f.d.a)>0){if(d){if(e!==null&& !gkb(e.c,'')){xfb(f.k,e);if(f.h.p){tNb(f.c);}if(f.h.q){EZ(f.p,f.d,f.l,f.r,e,a);}else{aZ(f,f.l,f.r,e);}}else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(vfb(),Efb,'Aceitar'),null,null,null);}}else{if(f.h.u){f.e=dgb(f.k.b);}for(b=0;b<f.e.b;b++){if(Dk(aob(f.e,b),46)!==null&& !gkb(Dk(aob(f.e,b),46).c,'')){xfb(f.k,Dk(aob(f.e,b),46));if(f.h.p){tNb(f.c);}if(f.h.q){EZ(f.p,f.d,f.l,f.r,Dk(aob(f.e,b),46),a);}else{aZ(f,f.l,f.r,Dk(aob(f.e,b),46));}}else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Dk(aob(f.e,b),46).c,(vfb(),Efb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&kkb(f.d.a)==0){w_(null,(vfb(),Efb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(vfb(),Efb,'Aceitar'),null,null,null);}}
...
function lZ(a,c,b){if(b!==null&& !gkb(b.c,'')){eZ(this,a,c);bZ(this,this,true,b);}else{v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(vfb(),Efb,'Aceitar'),null,null,null);}}
function dY(){}
...
function hY(b,a){if(b.a.h.p){pNb(b.a.c);}v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'N\xE3o se p\xF4de ligar com o servidor'),(vfb(),Efb,'Aceitar'),null,null,null);}
function iY(f,d){var a,c,e;e=Dk(d,49);if(e.c!==null&&kkb(e.c)>0){c='';try{if(rS(mZ,e.c)!==null&&kkb(rS(mZ,e.c))>0){c=rS(mZ,e.c);}else{c=A7((vfb(),Efb),e.c);}if(fkb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=jl(a);if(Ek(a,38)){a;c=e.d;}else throw a;}v_((vfb(),Efb,'ERRO'),c,(vfb(),Efb,'Aceitar'),null,null,null);}else{gZ(f.b,e);}if(f.a.h.p){pNb(f.a.c);}}
...
function oY(b,a){if(b.a.h.p){pNb(b.a.c);}v_((vfb(),Efb,'ERRO'),(vfb(),Efb,'N\xE3o se p\xF4de ligar com o servidor')+': '+llb(a),(vfb(),Efb,'Aceitar'),null,null,null);}
...
function n4(){}
_=n4.prototype=new ijb();_.ie=q4;_.tN=AUb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=189;function t4(a){ar((vfb(),Dfb,''),(vfb(),Efb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function r4(){}
...
function A7(d,b){var a,c;c=Dk(brb(d.a,b),1);if(c!==null)return c;if(gkb(b,'OuterServiceException')){a='Outer service reported an exception';drb(d.a,'OuterServiceException',a);return a;}if(gkb(b,'UnableToInitIndex')){a='Unable to init an index';drb(d.a,'UnableToInitIndex',a);return a;}if(gkb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';drb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(gkb(b,'usarMapa')){a='Usar mapa';drb(d.a,'usarMapa',a);return a;}if(gkb(b,'hasta')){a='a';drb(d.a,'hasta',a);return a;}if(gkb(b,'resultados')){a='Resultados';drb(d.a,'resultados',a);return a;}if(gkb(b,'valueErrors')){a='Error entering search criteria';drb(d.a,'valueErrors',a);return a;}if(gkb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';drb(d.a,'ningunCriterioIntroducido',a);return a;}if(gkb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';drb(d.a,'requiredCriterionError',a);return a;}if(gkb(b,'gazetteerTitle')){a='Nomenclatura';drb(d.a,'gazetteerTitle',a);return a;}if(gkb(b,'sourceURLTitle')){a='URL';drb(d.a,'sourceURLTitle',a);return a;}if(gkb(b,'UnknownFaliure')){a='Unknown service failure';drb(d.a,'UnknownFaliure',a);return a;}if(gkb(b,'okButtonLabel')){a='Aceitar';drb(d.a,'okButtonLabel',a);return a;}if(gkb(b,'nuevaBusqueda')){a='NOVA';drb(d.a,'nuevaBusqueda',a);return a;}if(gkb(b,'refinar')){a='REFINAR ';drb(d.a,'refinar',a);return a;}if(gkb(b,'newSourceTitle')){a='New source';drb(d.a,'newSourceTitle',a);return a;}if(gkb(b,'anterior')){a='Anterior';drb(d.a,'anterior',a);return a;}if(gkb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";drb(d.a,'UnableToReadSourceResponse',a);return a;}if(gkb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';drb(d.a,'UnableToSynchroniseSource',a);return a;}if(gkb(b,'siguiente')){a='Seguinte';drb(d.a,'siguiente',a);return a;}if(gkb(b,'UnsupportedEncoding')){a='Unsupported Encoding';drb(d.a,'UnsupportedEncoding',a);return a;}if(gkb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';drb(d.a,'connection_error',a);return a;}if(gkb(b,'limpiar')){a='Limpar';drb(d.a,'limpiar',a);return a;}if(gkb(b,'NoReachableOuterService')){a='Could not connect with the outer service';drb(d.a,'NoReachableOuterService',a);return a;}if(gkb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';drb(d.a,'UnableToRemoveFromIndex',a);return a;}if(gkb(b,'sourcesListTitle')){a='Sources list';drb(d.a,'sourcesListTitle',a);return a;}if(gkb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';drb(d.a,'UnableToInitSource',a);return a;}if(gkb(b,'ayuda')){a='Ajuda';drb(d.a,'ayuda',a);return a;}if(gkb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";drb(d.a,'NoReachableRDF',a);return a;}if(gkb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';drb(d.a,'UnableToPerformInsertion',a);return a;}if(gkb(b,'deUnTotalDe')){a='de um total de';drb(d.a,'deUnTotalDe',a);return a;}if(gkb(b,'invalidDate')){a='Invalid date';drb(d.a,'invalidDate',a);return a;}if(gkb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';drb(d.a,'sinResultados',a);return a;}if(gkb(b,'aceptar')){a='Aceitar';drb(d.a,'aceptar',a);return a;}if(gkb(b,'buscar')){a='Pesquisar';drb(d.a,'buscar',a);return a;}if(gkb(b,'ResultList_Title')){a='Lista de resultados';drb(d.a,'ResultList_Title',a);return a;}if(gkb(b,'buscando')){a='Pesquisando...';drb(d.a,'buscando',a);return a;}if(gkb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';drb(d.a,'NoReachablePool',a);return a;}if(gkb(b,'sourceTypeTitle')){a='Type';drb(d.a,'sourceTypeTitle',a);return a;}if(gkb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';drb(d.a,'SearchInfo_Title',a);return a;}if(gkb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';drb(d.a,'undefinedBehaviour',a);return a;}if(gkb(b,'detalle')){a='Pormenor';drb(d.a,'detalle',a);return a;}if(gkb(b,'error')){a='ERRO';drb(d.a,'error',a);return a;}if(gkb(b,'loading')){a='Carregando...';drb(d.a,'loading',a);return a;}if(gkb(b,'resultComponentVoid')){a='-';drb(d.a,'resultComponentVoid',a);return a;}if(gkb(b,'busquedaAnterior')){a='ANTERIOR';drb(d.a,'busquedaAnterior',a);return a;}if(gkb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';drb(d.a,'wrongSourceDescriptionFile',a);return a;}if(gkb(b,'locale')){a='pt';drb(d.a,'locale',a);return a;}if(gkb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";drb(d.a,'NotAValidQuery',a);return a;}if(gkb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';drb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw Brb(new Arb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function w7(){}
_=w7.prototype=new ijb();_.tN=CUb+'Messages_pt';_.tI=194;function C7(a){a.a=znb(new xnb());}
...
function qdb(j,h){var a,b,c,d,e,f,g,i;BB(j.c);f=hsb(new gsb());j.h=h.e;j.f=bl((h.g+1)/j.g);j.a=bl((j.f-1)/j.d);if(j.a!=0){d=Bab(new Aab());aF(d,'<<');CE(d,j);Dab(Dk(d,61),1+j.a*j.d-j.d);}else{d=AE(new zE());aF(d,' ');}d.dc('navigationArrowsLeft');jsb(f,d);if(h.b!=0){b=Bab(new Aab());aF(b,(vfb(),Efb,'Anterior'));CE(b,j);Dab(Dk(b,61),j.f-1);}else{b=AE(new zE());aF(b,' ');}b.dc('navigationPrevious');jsb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=pib(h.f/j.g);e++){g=Bab(new Aab());if(e==j.f){g.dc('navigationCurrentPage');}else{CE(g,j);Dab(g,e);}aF(g,''+e);jsb(f,g);}if(j.f<pib(h.f/j.g)){i=Bab(new Aab());aF(i,(vfb(),Efb,'Seguinte'));CE(i,j);Dab(Dk(i,61),j.f+1);}else{i=AE(new zE());aF(i,' ');}i.dc('navigationNext');jsb(f,i);if((j.a+1)*j.g*j.d<h.f){c=Bab(new Aab());aF(c,'>>');CE(c,j);Dab(Dk(c,61),e);}else{c=AE(new zE());aF(c,' ');}c.dc('navigationArrowsRight');jsb(f,c);iA(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){lC(j.c,0,a,Dk(lsb(f,a),62));}}
...
function jeb(c,a,b){ieb(c);c.c=sCb(new DBb(),'',a);c.a=sCb(new DBb(),'',b);fCb(c.b,c.c);fCb(c.b,c.a);lJb(c.c,(vfb(),Efb,'REFINAR '));lJb(c.a,(vfb(),Efb,'NOVA'));wCb(c.c,'icon-refine');wCb(c.a,'icon-new');Fy(c,c.b);return c;}
function heb(){}
...
function Aeb(c,b,a){zeb(c);c.a=sCb(new DBb(),'',b);c.b=sCb(new DBb(),'',a);fCb(c.c,c.a);fCb(c.c,c.b);rEb(c.c,'searchButtonsPanel');lJb(c.a,(vfb(),Efb,'Pesquisar'));lJb(c.b,(vfb(),Efb,'Limpar'));wCb(c.a,'icon-search');wCb(c.b,'icon-clear');Fy(c,c.c);return c;}
...
function wfb(d){var a,b,c;if(d.h!==null){COb(d.p,d.h);}d.h=mPb(new gPb(),2);a=d.h.b;if(d.a.h){cp(tDb(a),'height',d.a.l);}lJb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");cDb(d.h,710,d.f);uOb(d.p,d.h);if(d.a.h){cp(bo(tDb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=wOb(d.p,c).b;cp(tDb(b),'height',d.a.l);}}}
...
function yfb(d,b){var a,c;uQb(d.h.b,b);lJb(d.h,'Pormenor');FOb(d.p,d.h);if(d.a.h){cp(bo(tDb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=wOb(d.p,c).b;cp(tDb(a),'height',d.a.l);}}}
...
function tTb(){}
_=tTb.prototype=new ijb();_.tN=nVb+'DateLocale_pt_BR';_.tI=360;function ATb(a,b){return Aob(new yob(),gpb(a),cpb(a),Eob(a)+b);}
