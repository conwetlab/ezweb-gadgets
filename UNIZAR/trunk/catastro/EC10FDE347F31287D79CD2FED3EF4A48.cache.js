...
/* The Original Code is EC10FDE347F31287D79CD2FED3EF4A48.cache.js
...
function gf(b){var a,c;a=ri(zpb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['a.C.','d.C.']);Bpb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(zpb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['a.C.','d.C.']);Bpb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(zpb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);Bpb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(zpb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);Bpb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(zpb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);Bpb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(zpb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);Bpb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(zpb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);Bpb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(zpb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['D','S','T','Q','Q','S','S']);Bpb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(zpb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);Bpb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(zpb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);Bpb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(zpb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);Bpb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(zpb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',362,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);Bpb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new bib();_.tN=BSb+'DateTimeConstants_pt_BR';_.tI=18;function Ch(){return null;}
...
function uW(d,a,b,c){if(Fib(a,'viewDetails'))eY(d.a,b,c);else{u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'Comportamento n\xE3o definido'),(oeb(),xeb,'Aceitar'),null,null,null);}}
...
function BV(){}
_=BV.prototype=new bib();_.tN=lTb+'AVOFilterBuilder';_.tI=162;_.c=null;_.d='CONTAINS WORD';_.g=false;function iW(e,a,f,c){var b,d;b=null;if(Eib(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(Eib(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(Eib(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(Eib(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(Eib(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(Eib(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(Eib(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!Eib(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(oeb(),xeb,'Aceitar'),null,null,null);}return b;}
function jW(e,b,d,c){var a;a=null;if(Eib(c,e.c)){a=e.b+b+d+e.a;}else if(Eib(c,e.eb)){a=e.db+b+d+e.cb;}else{u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(oeb(),xeb,'Aceitar'),null,null,null);}return a;}
...
function BW(){}
_=BW.prototype=new bib();_.tN=nTb+'CriterionsListElement';_.tI=166;_.a=null;_.b=null;function rX(a){a.p=yY(new nY());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=rmb(new pmb());a.g=rmb(new pmb());a.a=rmb(new pmb());a.c=EIb(new zIb(),(oeb(),xeb,'Pesquisando...'));}
...
function zX(e,b,d,c){var a;if(e.h.p){jMb(e.c);}a=lX(new kX(),e,b,d);peb(e.k);if(e.h.q){CY(e.p,b.a,e8(b),e.m.a,d,(oeb(),xeb,'pt'),a);}else{yX(e,b,e.m.a,d,(oeb(),xeb,'pt'));}}
...
function kY(a,c,b){if(b!==null&& !Fib(b.c,'')){dY(this,a,c);aY(this,this,true,b);}else{u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(oeb(),xeb,'Aceitar'),null,null,null);}}
function cX(){}
...
function gX(b,a){if(b.a.h.p){fMb(b.a.c);}u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'N\xE3o se p\xF4de ligar com o servidor'),(oeb(),xeb,'Aceitar'),null,null,null);}
function hX(f,d){var a,c,e;e=ri(d,48);if(e.c!==null&&djb(e.c)>0){c='';try{if(DP(lY,e.c)!==null&&djb(DP(lY,e.c))>0){c=DP(lY,e.c);}else{c=z6((oeb(),xeb),e.c);}if(Eib(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,37)){a;c=e.d;}else throw a;}u$((oeb(),xeb,'ERRO'),c,(oeb(),xeb,'Aceitar'),null,null,null);}else{fY(f.b,e);}if(f.a.h.p){fMb(f.a.c);}}
...
function nX(b,a){if(b.a.h.p){fMb(b.a.c);}u$((oeb(),xeb,'ERRO'),(oeb(),xeb,'N\xE3o se p\xF4de ligar com o servidor')+': '+dkb(a),(oeb(),xeb,'Aceitar'),null,null,null);}
...
function u3(d,a){var b,c;Abb(d,a);t3(d);d.b=null.Eg;Cbb(d,d);yw(d.e,d);A7(d.k,'mapa',d.a);if(null.Eg==true){if(null.Eg){d.g=rFb(new yEb(),192,'my-cpanel-small');if(null.Eg){xFb(d.g,false);}}else{d.g=rFb(new yEb(),128,'my-cpanel-small');}AFb(d.g,null.Eg);zBb(d.g,'criterionContentPanel');}else{d.g=rFb(new yEb(),0,'internal-compound-cpanel-small');zBb(d.g,'internalCompoundCriterionContentPanel');}d.d.lg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',365,14,[])));nb(c,null.Eg);if(null.Eg!=NaN&&null.Eg!=NaN&&null.Eg!=NaN&&null.Eg!=NaN){d.a=yV(new xV(),d.b,(oeb(),xeb,'pt'),null.Eg,null.Eg,null.Eg,null.Eg,null.Eg,yjb(null.Eg),yjb(null.Eg));}else{d.a=zV(new xV(),d.b,(oeb(),xeb,'pt'),yjb(null.Eg),yjb(null.Eg));}zJ(d.d,8);ou(d.d,d.a);if(null.Eg==true){d.l=kv(new hv(),' '+(oeb(),xeb,'Usar mapa'));d.l.Fb(n3(new m3(),d));sK(d.i,d.l);if(null.Eg){nv(d.l,true);}else{nv(d.l,false);AU(d.a);}if(null.Eg){w3(d);}if(null.Eg){d.rg(false);}}sF(d.e,d.d);sK(d.i,d.e);yFb(d.g,'icon-text');d.i.dc('criterionPanel');kPb(d.g,d.i);if(null.Eg){b=new q3();d.h=iBb(new tAb(),(oeb(),xeb,'Nomenclatura'),b);bDb(d.h,false);hDb(d.h,'coordinatesCCBGazetteerButton');kPb(d.g,d.h);}kw(d,d.g);return d;}
...
function m3(){}
_=m3.prototype=new bib();_.je=p3;_.tN=pTb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=191;function s3(a){yo((oeb(),web,''),(oeb(),xeb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function q3(){}
...
function cdb(c,a,b){bdb(c);c.c=iBb(new tAb(),'',a);c.a=iBb(new tAb(),'',b);BAb(c.b,c.c);BAb(c.b,c.a);bIb(c.c,(oeb(),xeb,'REFINAR '));bIb(c.a,(oeb(),xeb,'NOVA'));mBb(c.c,'icon-refine');mBb(c.a,'icon-new');kw(c,c.b);return c;}
function adb(){}
...
function tdb(c,b,a){sdb(c);c.a=iBb(new tAb(),'',b);c.b=iBb(new tAb(),'',a);BAb(c.c,c.a);BAb(c.c,c.b);hDb(c.c,'searchButtonsPanel');bIb(c.a,(oeb(),xeb,'Pesquisar'));bIb(c.b,(oeb(),xeb,'Limpar'));mBb(c.a,'icon-search');mBb(c.b,'icon-clear');kw(c,c.c);return c;}
...
function peb(d){var a,b,c;if(d.h!==null){sNb(d.p,d.h);}d.h=cOb(new CNb(),2);a=d.h.b;if(d.a.h){um(jCb(a),'height',d.a.l);}bIb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");yBb(d.h,710,d.f);kNb(d.p,d.h);if(d.a.h){um(ul(jCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=mNb(d.p,c).b;um(jCb(b),'height',d.a.l);}}}
...
function reb(d,b){var a,c;kPb(d.h.b,b);bIb(d.h,'Pormenor');vNb(d.p,d.h);if(d.a.h){um(ul(jCb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=mNb(d.p,c).b;um(jCb(a),'height',d.a.l);}}}
...
function jSb(){}
_=jSb.prototype=new bib();_.tN=cUb+'DateLocale_pt_BR';_.tI=360;function qSb(a,b){return snb(new qnb(),Enb(a),Anb(a),wnb(a)+b);}
