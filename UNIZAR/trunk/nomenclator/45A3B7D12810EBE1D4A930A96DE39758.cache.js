...
/* The Original Code is 45A3B7D12810EBE1D4A930A96DE39758.cache.js
...
function ef(b){var a,c;a=ri(omb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['DE','DU']);qmb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(omb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['id\u0151sz\xE1m\xEDt\xE1sunk el\u0151tt','id\u0151sz\xE1m\xEDt\xE1sunk szerint']);qmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(omb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['i. e.','i. sz.']);qmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(omb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['janu\xE1r','febru\xE1r','m\xE1rcius','\xE1prilis','m\xE1jus','j\xFAnius','j\xFAlius','augusztus','szeptember','okt\xF3ber','november','december']);qmb(b.a,'months',c);return c;}else return a;}
function kf(b){var a,c;a=ri(omb(b.a,'narrowMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['J','F','M','\xC1','M','J','J','A','S','O','N','D']);qmb(b.a,'narrowMonths',c);return c;}else return a;}
function lf(b){var a,c;a=ri(omb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['I. negyed\xE9v','II. negyed\xE9v','III. negyed\xE9v','IV. negyed\xE9v']);qmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(omb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['jan.','febr.','m\xE1rc.','\xE1pr.','m\xE1j.','j\xFAn.','j\xFAl.','aug.','szept.','okt.','nov.','dec.']);qmb(b.a,'shortMonths',c);return c;}else return a;}
function nf(b){var a,c;a=ri(omb(b.a,'shortQuarters'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['N1','N2','N3','N4']);qmb(b.a,'shortQuarters',c);return c;}else return a;}
function of(b){var a,c;a=ri(omb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['V','H','K','Sze','Cs','P','Szo']);qmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(omb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['janu\xE1r','febru\xE1r','m\xE1rcius','\xE1prilis','m\xE1jus','j\xFAnius','j\xFAlius','augusztus','szeptember','okt\xF3ber','november','december']);qmb(b.a,'standaloneMonths',c);return c;}else return a;}
function qf(b){var a,c;a=ri(omb(b.a,'standaloneNarrowMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['J','F','M','\xC1','M','J','J','A','S','O','N','D']);qmb(b.a,'standaloneNarrowMonths',c);return c;}else return a;}
function rf(b){var a,c;a=ri(omb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['V','H','K','S','C','P','S']);qmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(omb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['jan.','febr.','m\xE1rc.','\xE1pr.','m\xE1j.','j\xFAn.','j\xFAl.','aug.','szept.','okt.','nov.','dec.']);qmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(omb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['V','H','K','Sze','Cs','P','Szo']);qmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(omb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['vas\xE1rnap','h\xE9tf\u0151','kedd','szerda','cs\xFCt\xF6rt\xF6k','p\xE9ntek','szombat']);qmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(omb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['vas\xE1rnap','h\xE9tf\u0151','kedd','szerda','cs\xFCt\xF6rt\xF6k','p\xE9ntek','szombat']);qmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new zeb();_.tN=sPb+'DateTimeConstants_hu_HU';_.tI=18;function Ch(){return null;}
...
function hT(){}
_=hT.prototype=new zeb();_.tN=cQb+'AVOFilterBuilder';_.tI=150;_.c=null;_.d='CONTAINS WORD';_.g=false;function uT(e,a,f,c){var b,d;b=null;if(wfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(wfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(wfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(wfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(wfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(wfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(wfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!wfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{r7((jbb(),sbb,'ERROR'),(jbb(),sbb,'FilterBuilderToolkitObject: operaci\xF3n inv\xE1lida'),(jbb(),sbb,'Aceptar'),null,null,null);}return b;}
function vT(e,b,d,c){var a;a=null;if(wfb(c,e.c)){a=e.b+b+d+e.a;}else if(wfb(c,e.eb)){a=e.db+b+d+e.cb;}else{r7((jbb(),sbb,'ERROR'),(jbb(),sbb,'FilterBuilderToolkitObject: operaci\xF3n l\xF3gica inv\xE1lida')+': '+c,(jbb(),sbb,'Aceptar'),null,null,null);}return a;}
...
function hU(){}
_=hU.prototype=new zeb();_.tN=eQb+'CriterionsListElement';_.tI=154;_.a=null;_.b=null;function DU(a){a.p=dW(new yV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=jjb(new hjb());a.g=jjb(new hjb());a.a=jjb(new hjb());a.c=vFb(new qFb(),(jbb(),sbb,'Buscando...'));}
...
function fV(e,b,d,c){var a;if(e.h.q){aJb(e.c);}a=xU(new wU(),e,b,d);kbb(e.k);if(e.h.r){hW(e.p,b.a,b5(b),e.m.a,d,(jbb(),sbb,'es'),a);}else{eV(e,b,e.m.a,d,(jbb(),sbb,'es'));}}
...
function zU(b,a){if(b.a.h.q){CIb(b.a.c);}r7((jbb(),sbb,'ERROR'),(jbb(),sbb,'No se pudo conectar con el servidor')+': '+Bgb(a),(jbb(),sbb,'Aceptar'),null,null,null);}
...
function F0(d,a){var b,c;x$(d,a);E0(d);d.b=null.Cg;y$(d,d);dx(d.e,d);x4(d.j,'mapa',d.a);if(null.Cg==true){if(null.Cg){d.g=iCb(new pBb(),192,'my-cpanel-small');if(null.Cg){oCb(d.g,false);}}else{d.g=iCb(new pBb(),128,'my-cpanel-small');}rCb(d.g,null.Cg);qyb(d.g,'criterionContentPanel');}else{d.g=iCb(new pBb(),0,'internal-compound-cpanel-small');qyb(d.g,'internalCompoundCriterionContentPanel');}d.d.kg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',352,12,[])));nb(c,null.Cg);if(null.Cg!=NaN&&null.Cg!=NaN&&null.Cg!=NaN&&null.Cg!=NaN){d.a=eT(new dT(),d.b,(jbb(),sbb,'es'),null.Cg,null.Cg,null.Cg,null.Cg,null.Cg,qgb(null.Cg),qgb(null.Cg));}else{d.a=fT(new dT(),d.b,(jbb(),sbb,'es'),qgb(null.Cg),qgb(null.Cg));}eK(d.d,8);zu(d.d,d.a);if(null.Cg==true){d.k=vv(new sv(),' '+(jbb(),sbb,'Usar mapa'));d.k.Fb(y0(new x0(),d));DK(d.i,d.k);if(null.Cg){yv(d.k,true);}else{yv(d.k,false);gS(d.a);}if(null.Cg){b1(d);}if(null.Cg){d.qg(false);}}DF(d.e,d.d);DK(d.i,d.e);pCb(d.g,'icon-text');d.i.dc('criterionPanel');bMb(d.g,d.i);if(null.Cg){b=new B0();d.h=Fxb(new kxb(),(jbb(),sbb,'Nomencl\xE1tor'),b);yzb(d.h,false);Ezb(d.h,'coordinatesCCBGazetteerButton');bMb(d.g,d.h);}vw(d,d.g);return d;}
...
function x0(){}
_=x0.prototype=new zeb();_.ie=A0;_.tN=gQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=179;function D0(a){yo((jbb(),rbb,''),(jbb(),sbb,'Nomencl\xE1tor'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function B0(){}
...
function r1(){p1(this);}
function s1(){var a,b;a=z4(new C3());this.c=n4(new l4());C4(a,this.c);if(!(CG(this.a),true)){B4(a,(jbb(),sbb,'Fecha no v\xE1lida'));}else{if(this.a.d!==null){b=F3(new D3());b4(b,null.Cg);c4(b,null.Cg);d4(b,null.Dg());r4(this.c,0,b);q4(this.c,null.Cg);s4(this.c,null.Cg);E4(a,null.Cg+': '+null.Dg());}else{a=null;}}return a;}
...
function s3(){}
_=s3.prototype=new zeb();_.tN=iQb+'Messages_';_.tI=184;function y3(a){a.a=jjb(new hjb());}
...
function f_(j,h){var a,b,c,d,e,f,g,i;vz(j.c);f=unb(new tnb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=y8(new x8());AC(d,'<<');wC(d,j);A8(ri(d,54),1+j.a*j.d-j.d);}else{d=uC(new tC());AC(d,' ');}d.dc('navigationArrowsLeft');wnb(f,d);if(h.b!=0){b=y8(new x8());AC(b,(jbb(),sbb,'Anterior'));wC(b,j);A8(ri(b,54),j.f-1);}else{b=uC(new tC());AC(b,' ');}b.dc('navigationPrevious');wnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=aeb(h.f/j.g);e++){g=y8(new x8());if(e==j.f){g.dc('navigationCurrentPage');}else{wC(g,j);A8(g,e);}AC(g,''+e);wnb(f,g);}if(j.f<aeb(h.f/j.g)){i=y8(new x8());AC(i,(jbb(),sbb,'Siguiente'));wC(i,j);A8(ri(i,54),j.f+1);}else{i=uC(new tC());AC(i,' ');}i.dc('navigationNext');wnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=y8(new x8());AC(c,'>>');wC(c,j);A8(ri(c,54),e);}else{c=uC(new tC());AC(c,' ');}c.dc('navigationArrowsRight');wnb(f,c);cy(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){fA(j.c,0,a,ri(ynb(f,a),55));}}
...
function E_(c,a,b){D_(c);c.c=Fxb(new kxb(),'',a);c.a=Fxb(new kxb(),'',b);sxb(c.b,c.c);sxb(c.b,c.a);yEb(c.c,(jbb(),sbb,'REFINAR '));yEb(c.a,(jbb(),sbb,'NUEVA'));dyb(c.c,'icon-refine');dyb(c.a,'icon-new');vw(c,c.b);return c;}
function C_(){}
...
function pab(c,b,a){oab(c);c.a=Fxb(new kxb(),'',b);c.b=Fxb(new kxb(),'',a);sxb(c.c,c.a);sxb(c.c,c.b);Ezb(c.c,'searchButtonsPanel');yEb(c.a,(jbb(),sbb,'Buscar'));yEb(c.b,(jbb(),sbb,'Limpiar'));dyb(c.a,'icon-search');dyb(c.b,'icon-clear');vw(c,c.c);return c;}
function nab(){}
...
function kbb(d){var a,b,c;if(d.h!==null){jKb(d.p,d.h);}d.h=zKb(new tKb(),2);a=d.h.b;if(d.a.h){um(azb(a),'height',d.a.l);}yEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Detalle");pyb(d.h,710,d.f);bKb(d.p,d.h);if(d.a.h){um(ul(azb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=dKb(d.p,c).b;um(azb(b),'height',d.a.l);}}}
...
function mbb(d,b){var a,c;bMb(d.h.b,b);yEb(d.h,'Detalle');mKb(d.p,d.h);if(d.a.h){um(ul(azb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=dKb(d.p,c).b;um(azb(a),'height',d.a.l);}}}
...
function vbb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;ubb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;cy(p.d,p.e.b,2);if(p.i){cy(p.d,p.e.b+3,2);h=DE(new CE(),'myRadioGroup');yv(h,false);fA(p.d,0,0,h);f=vC(new tC(),(jbb(),sbb,'Nueva fuente'));fA(p.d,0,1,f);o=dB(new bB());m=vC(new tC(),(jbb(),sbb,'URL')+':  ');eB(o,m);p.h.kg('sourcesListTextBox');eB(o,p.h);fA(p.d,1,1,o);c=dB(new bB());l=vC(new tC(),(jbb(),sbb,'Tipo')+':  ');eB(c,l);p.a.kg('sourcesListListBox');eB(c,p.a);for(b=0;b<p.c.b;b++){fD(p.a,ri(qjb(p.c,b),1));}fA(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=tv(new sv());fA(p.d,b+e,0,a);yv(a,ri(qjb(p.e,b),40).b);j=vC(new tC(),ri(qjb(p.e,b),40).g);fA(p.d,b+e,1,j);}else{h=DE(new CE(),'myRadioGroup');if(!i&&ri(qjb(p.e,b),40).b){yv(h,true);i=true;}fA(p.d,b+e,0,h);k=vC(new tC(),ri(qjb(p.e,b),40).g);fA(p.d,b+e,1,k);}}if(!p.b){if(!i){yv(ri(Az(p.d,0,0),65),true);}}if(yO(wV,'sourcesListTitle')!==null&& !xfb(yO(wV,'sourcesListTitle'),'')){rCb(p.f,yO(wV,'sourcesListTitle'));}else{rCb(p.f,(jbb(),sbb,'Fuentes disponibles'));}qCb(p.f,5);qyb(p.f,'sourcesListPanel');pCb(p.f,'icon-text');bA(p.d,4);DF(p.g,p.d);p.g.kg('sourcesGrid');bMb(p.f,p.g);vw(p,p.f);return p;}
...
function aPb(){}
_=aPb.prototype=new zeb();_.tN=zQb+'DateLocale_hu_HU';_.tI=349;function hPb(a,b){return hkb(new fkb(),tkb(a),pkb(a),lkb(a)+b);}
