...
/* The Original Code is ADFD3CCA4F69B1AC552E15B588773412.cache.js
...
function ph(b){var a,c;a=Bk(wmb(b.a,'ampms'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['a.m.','p.m.']);ymb(b.a,'ampms',c);return c;}else return a;}
function rh(b){var a,c;a=Bk(wmb(b.a,'eraNames'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['a.C.','d.C.']);ymb(b.a,'eraNames',c);return c;}else return a;}
function sh(b){var a,c;a=Bk(wmb(b.a,'eras'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['a.C.','d.C.']);ymb(b.a,'eras',c);return c;}else return a;}
function th(b){var a,c;a=Bk(wmb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre']);ymb(b.a,'months',c);return c;}else return a;}
function uh(b){var a,c;a=Bk(wmb(b.a,'narrowMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['E','F','M','A','M','J','J','A','S','O','N','D']);ymb(b.a,'narrowMonths',c);return c;}else return a;}
function vh(b){var a,c;a=Bk(wmb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['1er trimestre','2\xBA trimestre','3er trimestre','4\xBA trimestre']);ymb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(wmb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['ene','feb','mar','abr','may','jun','jul','ago','sep','oct','nov','dic']);ymb(b.a,'shortMonths',c);return c;}else return a;}
function xh(b){var a,c;a=Bk(wmb(b.a,'shortQuarters'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['T1','T2','T3','T4']);ymb(b.a,'shortQuarters',c);return c;}else return a;}
function yh(b){var a,c;a=Bk(wmb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['dom','lun','mar','mi\xE9','jue','vie','s\xE1b']);ymb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(wmb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre']);ymb(b.a,'standaloneMonths',c);return c;}else return a;}
function Ah(b){var a,c;a=Bk(wmb(b.a,'standaloneNarrowMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['E','F','M','A','M','J','J','A','S','O','N','D']);ymb(b.a,'standaloneNarrowMonths',c);return c;}else return a;}
function Bh(b){var a,c;a=Bk(wmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['D','L','M','M','J','V','S']);ymb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(wmb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['ene','feb','mar','abr','may','jun','jul','ago','sep','oct','nov','dic']);ymb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(wmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['dom','lun','mar','mi\xE9','jue','vie','s\xE1b']);ymb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(wmb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['domingo','lunes','martes','mi\xE9rcoles','jueves','viernes','s\xE1bado']);ymb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(wmb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',350,1,['domingo','lunes','martes','mi\xE9rcoles','jueves','viernes','s\xE1bado']);ymb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new afb();_.tN=BPb+'DateTimeConstants_es';_.tI=28;function gk(){return null;}
...
function k3(){}
_=k3.prototype=new g3();_.tN=oQb+'TextCQBConfiguration';_.tI=125;_.a=false;_.b=null;_.c=null;function mP(a){l3(a);a.a=false;a.l=(tP(),AP,'Top\xF3nimo');tjb(a.i,'mne:Entidad/mne:nombreEntidad/mne:NombreEntidad/mne:nombre');a.c='FeatureNameCQB';a.p=false;return a;}
function lP(){}
...
function bU(d,a,b,c){if(Efb(a,'viewDetails'))qV(d.a,b,c);else{s7((qbb(),zbb,'ERROR'),(qbb(),zbb,'Comportamiento no definido'),(qbb(),zbb,'Aceptar'),null,null,null);}}
...
function mQ(b,a){if(Efb(a,'locale')){return 'es';}else if(Efb(a,'FeatureNameCQB_Title')){return 'Top\xF3nimo';}else if(Efb(a,'withoutTitle')){return '***** Sin nombre *****';}else if(Efb(a,'withoutType')){return '***** Sin tipo *****';}else if(Efb(a,'serviceNG')){return 'Base de Datos (IGN)';}else if(Efb(a,'serviceNGC')){return 'Nomencl\xE1tor Conciso';}else if(Efb(a,'serviceEurogeonames')){return 'Nomencl\xE1tor EuroGeonames';}else if(Efb(a,'servicePortugal')){return 'Nomencl\xE1tor del IGP (Portugal)';}else if(Efb(a,'tooltip_add_to_wms_client')){return 'Centrar en el visualizador';}else if(Efb(a,'tooltip_highlight')){return 'Situar en el mapa';}else if(Efb(a,'tooltip_title')){return 'Ver en detalle';}else if(Efb(a,'error')){return 'ERROR';}else if(Efb(a,'centerWithMarkerError')){return 'Fallo al centrar el mapa';}else if(Efb(a,'okButtonLabel')){return 'Aceptar';}else if(Efb(a,'invalidCoordinatesError')){return 'Fallo al centrar el mapa: Coordenadas no v\xE1lidas';}else{return '';}}
function jQ(){}
_=jQ.prototype=new afb();_.tN=hQb+'MessagesSpecific';_.tI=132;function pQ(a){pmb(new rlb());}
function qQ(a){pQ(a);return a;}
function oQ(){}
_=oQ.prototype=new afb();_.tN=hQb+'Messages_';_.tI=133;function sQ(){}
...
function iU(){}
_=iU.prototype=new afb();_.tN=lQb+'CriterionsListElement';_.tI=149;_.a=null;_.b=null;function EU(a){a.p=eW(new zV());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=rjb(new pjb());a.g=rjb(new pjb());a.a=rjb(new pjb());a.c=BFb(new wFb(),(qbb(),zbb,'Buscando...'));}
...
function gV(e,b,d,c){var a;if(e.h.q){gJb(e.c);}a=yU(new xU(),e,b,d);rbb(e.k);if(e.h.r){iW(e.p,b.a,c5(b),e.m.a,d,(qbb(),zbb,'es'),a);}else{fV(e,b,e.m.a,d,(qbb(),zbb,'es'));}}
...
function wV(a,c,b){if(b!==null&& !Efb(b.c,'')){pV(this,a,c);mV(this,this,true,b);}else{s7((qbb(),zbb,'ERROR'),(qbb(),zbb,'Fichero de descripci\xF3n de fuente incorrecto')+': '+b.c,(qbb(),zbb,'Aceptar'),null,null,null);}}
function pU(){}
...
function tU(b,a){if(b.a.h.q){cJb(b.a.c);}s7((qbb(),zbb,'ERROR'),(qbb(),zbb,'No se pudo conectar con el servidor'),(qbb(),zbb,'Aceptar'),null,null,null);}
function uU(f,d){var a,c,e;e=Bk(d,43);if(e.c!==null&&cgb(e.c)>0){c='';try{if(mQ(xV,e.c)!==null&&cgb(mQ(xV,e.c))>0){c=mQ(xV,e.c);}else{c=x3((qbb(),zbb),e.c);}if(Dfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,33)){a;c=e.d;}else throw a;}s7((qbb(),zbb,'ERROR'),c,(qbb(),zbb,'Aceptar'),null,null,null);}else{rV(f.b,e);}if(f.a.h.q){cJb(f.a.c);}}
...
function AU(b,a){if(b.a.h.q){cJb(b.a.c);}s7((qbb(),zbb,'ERROR'),(qbb(),zbb,'No se pudo conectar con el servidor')+': '+dhb(a),(qbb(),zbb,'Aceptar'),null,null,null);}
...
function y0(){}
_=y0.prototype=new afb();_.me=B0;_.tN=nQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=174;function E0(a){Eq((qbb(),ybb,''),(qbb(),zbb,'Nomencl\xE1tor'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function C0(){}
...
function s1(){q1(this);}
function t1(){var a,b;a=A4(new D3());this.c=o4(new m4());D4(a,this.c);if(!(rI(this.a),true)){C4(a,(qbb(),zbb,'Fecha no v\xE1lida'));}else{if(this.a.d!==null){b=a4(new E3());c4(b,null.bh);d4(b,null.bh);e4(b,null.ch());s4(this.c,0,b);r4(this.c,null.bh);t4(this.c,null.bh);F4(a,null.bh+': '+null.ch());}else{a=null;}}return a;}
...
function x3(d,b){var a,c;c=Bk(wmb(d.a,b),1);if(c!==null)return c;if(Efb(b,'OuterServiceException')){a='El servicio externo ha devuelto una excepci\xF3n';ymb(d.a,'OuterServiceException',a);return a;}if(Efb(b,'UnableToInitIndex')){a='No se pudo inicializar un \xEDndice';ymb(d.a,'UnableToInitIndex',a);return a;}if(Efb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: operaci\xF3n l\xF3gica inv\xE1lida';ymb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(Efb(b,'usarMapa')){a='Usar mapa';ymb(d.a,'usarMapa',a);return a;}if(Efb(b,'hasta')){a='a';ymb(d.a,'hasta',a);return a;}if(Efb(b,'resultados')){a='Resultados';ymb(d.a,'resultados',a);return a;}if(Efb(b,'valueErrors')){a='Se han producido los siguientes errores al introducir los criterios de b\xFAsqueda';ymb(d.a,'valueErrors',a);return a;}if(Efb(b,'ningunCriterioIntroducido')){a='Debe introducir alg\xFAn criterio para realizar la b\xFAsqueda';ymb(d.a,'ningunCriterioIntroducido',a);return a;}if(Efb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';ymb(d.a,'requiredCriterionError',a);return a;}if(Efb(b,'gazetteerTitle')){a='Nomencl\xE1tor';ymb(d.a,'gazetteerTitle',a);return a;}if(Efb(b,'sourceURLTitle')){a='URL';ymb(d.a,'sourceURLTitle',a);return a;}if(Efb(b,'UnknownFaliure')){a='Error desconocido en el servidor';ymb(d.a,'UnknownFaliure',a);return a;}if(Efb(b,'okButtonLabel')){a='Aceptar';ymb(d.a,'okButtonLabel',a);return a;}if(Efb(b,'nuevaBusqueda')){a='NUEVA';ymb(d.a,'nuevaBusqueda',a);return a;}if(Efb(b,'refinar')){a='REFINAR ';ymb(d.a,'refinar',a);return a;}if(Efb(b,'newSourceTitle')){a='Nueva fuente';ymb(d.a,'newSourceTitle',a);return a;}if(Efb(b,'anterior')){a='Anterior';ymb(d.a,'anterior',a);return a;}if(Efb(b,'UnableToReadSourceResponse')){a='La respuesta que dio el servicio externo no se pudo interpretar';ymb(d.a,'UnableToReadSourceResponse',a);return a;}if(Efb(b,'UnableToSynchroniseSource')){a='No se pudo iniciar el \xEDndice. No se podr\xE1n realizar b\xFAsquedas sobre el nuevo dato';ymb(d.a,'UnableToSynchroniseSource',a);return a;}if(Efb(b,'siguiente')){a='Siguiente';ymb(d.a,'siguiente',a);return a;}if(Efb(b,'UnsupportedEncoding')){a='Codificaci\xF3n de la respuesta no es v\xE1lido';ymb(d.a,'UnsupportedEncoding',a);return a;}if(Efb(b,'connection_error')){a='No se pudo conectar con el servidor';ymb(d.a,'connection_error',a);return a;}if(Efb(b,'limpiar')){a='Limpiar';ymb(d.a,'limpiar',a);return a;}if(Efb(b,'NoReachableOuterService')){a='No se ha podido conectar con el servicio externo';ymb(d.a,'NoReachableOuterService',a);return a;}if(Efb(b,'UnableToRemoveFromIndex')){a='No se pudo eliminar una entrada de un \xEDndice';ymb(d.a,'UnableToRemoveFromIndex',a);return a;}if(Efb(b,'sourcesListTitle')){a='Fuentes disponibles';ymb(d.a,'sourcesListTitle',a);return a;}if(Efb(b,'UnableToInitSource')){a='Fallo al inicializar la conexi\xF3n con el servicio externo';ymb(d.a,'UnableToInitSource',a);return a;}if(Efb(b,'ayuda')){a='Ayuda';ymb(d.a,'ayuda',a);return a;}if(Efb(b,'NoReachableRDF')){a='No se pudo obtener la descripci\xF3n del servicio externo';ymb(d.a,'NoReachableRDF',a);return a;}if(Efb(b,'UnableToPerformInsertion')){a='No se pudo terminar la inserci\xF3n';ymb(d.a,'UnableToPerformInsertion',a);return a;}if(Efb(b,'deUnTotalDe')){a='de un total de';ymb(d.a,'deUnTotalDe',a);return a;}if(Efb(b,'invalidDate')){a='Fecha no v\xE1lida';ymb(d.a,'invalidDate',a);return a;}if(Efb(b,'sinResultados')){a='No se han encontrado resultados a la consulta';ymb(d.a,'sinResultados',a);return a;}if(Efb(b,'aceptar')){a='Aceptar';ymb(d.a,'aceptar',a);return a;}if(Efb(b,'buscar')){a='Buscar';ymb(d.a,'buscar',a);return a;}if(Efb(b,'ResultList_Title')){a='Lista de resultados';ymb(d.a,'ResultList_Title',a);return a;}if(Efb(b,'buscando')){a='Buscando...';ymb(d.a,'buscando',a);return a;}if(Efb(b,'NoReachablePool')){a='No se pudo establecer conexi\xF3n con el servicio';ymb(d.a,'NoReachablePool',a);return a;}if(Efb(b,'sourceTypeTitle')){a='Tipo';ymb(d.a,'sourceTypeTitle',a);return a;}if(Efb(b,'SearchInfo_Title')){a='Informaci\xF3n de la consulta';ymb(d.a,'SearchInfo_Title',a);return a;}if(Efb(b,'undefinedBehaviour')){a='Comportamiento no definido';ymb(d.a,'undefinedBehaviour',a);return a;}if(Efb(b,'detalle')){a='Detalle';ymb(d.a,'detalle',a);return a;}if(Efb(b,'error')){a='ERROR';ymb(d.a,'error',a);return a;}if(Efb(b,'loading')){a='Cargando...';ymb(d.a,'loading',a);return a;}if(Efb(b,'resultComponentVoid')){a='-';ymb(d.a,'resultComponentVoid',a);return a;}if(Efb(b,'busquedaAnterior')){a='ANTERIOR';ymb(d.a,'busquedaAnterior',a);return a;}if(Efb(b,'wrongSourceDescriptionFile')){a='Fichero de descripci\xF3n de fuente incorrecto';ymb(d.a,'wrongSourceDescriptionFile',a);return a;}if(Efb(b,'locale')){a='es';ymb(d.a,'locale',a);return a;}if(Efb(b,'NotAValidQuery')){a='La consulta no est\xE1 bien formada';ymb(d.a,'NotAValidQuery',a);return a;}if(Efb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: operaci\xF3n inv\xE1lida';ymb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw qnb(new pnb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function t3(){}
_=t3.prototype=new afb();_.tN=pQb+'Messages_';_.tI=179;function z3(a){a.a=rjb(new pjb());}
...
function eDb(b,a){gDb();DIb(b,a);b.c=xxb(new rxb(),67108864);if((a&16777216)!=0){hDb(b,0,'Ok');}if((a&67108864)!=0){hDb(b,0,'Ok');hDb(b,1,'Cancelar');}if((a&268435456)!=0){hDb(b,2,'S&#237;');hDb(b,3,'No');}if((a&1073741824)!=0){hDb(b,2,'S&#237;');hDb(b,3,'No');hDb(b,1,'Cancelar');}return b;}
...
function m_(j,h){var a,b,c,d,e,f,g,i;kB(j.c);f=Cnb(new Bnb());j.h=h.e;j.f=Fk((h.g+1)/j.g);j.a=Fk((j.f-1)/j.d);if(j.a!=0){d=y8(new x8());pE(d,'<<');lE(d,j);A8(Bk(d,55),1+j.a*j.d-j.d);}else{d=jE(new iE());pE(d,' ');}d.dc('navigationArrowsLeft');Enb(f,d);if(h.b!=0){b=y8(new x8());pE(b,(qbb(),zbb,'Anterior'));lE(b,j);A8(Bk(b,55),j.f-1);}else{b=jE(new iE());pE(b,' ');}b.dc('navigationPrevious');Enb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=heb(h.f/j.g);e++){g=y8(new x8());if(e==j.f){g.dc('navigationCurrentPage');}else{lE(g,j);A8(g,e);}pE(g,''+e);Enb(f,g);}if(j.f<heb(h.f/j.g)){i=y8(new x8());pE(i,(qbb(),zbb,'Siguiente'));lE(i,j);A8(Bk(i,55),j.f+1);}else{i=jE(new iE());pE(i,' ');}i.dc('navigationNext');Enb(f,i);if((j.a+1)*j.g*j.d<h.f){c=y8(new x8());pE(c,'>>');lE(c,j);A8(Bk(c,55),e);}else{c=jE(new iE());pE(c,' ');}c.dc('navigationArrowsRight');Enb(f,c);xz(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){AB(j.c,0,a,Bk(aob(f,a),56));}}
...
function fab(c,a,b){eab(c);c.c=fyb(new qxb(),'',a);c.a=fyb(new qxb(),'',b);yxb(c.b,c.c);yxb(c.b,c.a);EEb(c.c,(qbb(),zbb,'REFINAR '));EEb(c.a,(qbb(),zbb,'NUEVA'));jyb(c.c,'icon-refine');jyb(c.a,'icon-new');oy(c,c.b);return c;}
function dab(){}
...
function wab(c,b,a){vab(c);c.a=fyb(new qxb(),'',b);c.b=fyb(new qxb(),'',a);yxb(c.c,c.a);yxb(c.c,c.b);eAb(c.c,'searchButtonsPanel');EEb(c.a,(qbb(),zbb,'Buscar'));EEb(c.b,(qbb(),zbb,'Limpiar'));jyb(c.a,'icon-search');jyb(c.b,'icon-clear');oy(c,c.c);return c;}
function uab(){}
...
function rbb(d){var a,b,c;if(d.h!==null){pKb(d.p,d.h);}d.h=FKb(new zKb(),2);a=d.h.b;if(d.a.h){ap(gzb(a),'height',d.a.l);}EEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Detalle");vyb(d.h,710,d.f);hKb(d.p,d.h);if(d.a.h){ap(Fn(gzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=jKb(d.p,c).b;ap(gzb(b),'height',d.a.l);}}}
function sbb(g,d){var a,b,c,e,f;vyb(g.p,600,gbb(new fbb(),g));e=FKb(new zKb(),0);if(wmb(g.n,d.c)!==null){f=kKb(g.p,Bk(wmb(g.n,d.c),62));pKb(g.p,Bk(wmb(g.n,d.c),62));if(d.g!==null&& !Efb(d.g,'')){EEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{EEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Resultados");}eAb(e,'resultsTabItem');a=e.b;EGb(a,true);if(g.a.h){ap(gzb(a),'height',g.a.l);}ymb(g.n,d.c,e);lKb(g.p,Bk(wmb(g.n,d.c),62),f);sKb(g.p,e);}else{if(d.g!==null&& !Efb(d.g,'')){EEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{EEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Resultados");}eAb(e,'resultsTabItem');a=e.b;EGb(a,true);if(g.a.h){ap(gzb(a),'height',g.a.l);}ymb(g.n,d.c,e);hKb(g.p,Bk(wmb(g.n,d.c),62));}ymb(g.d,izb(e),lcb(new jcb(),false));sKb(g.p,Bk(wmb(g.n,d.c),62));if(g.a.h){ap(Fn(gzb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=jKb(g.p,c).b;ap(gzb(b),'height',g.a.l);}}}
function tbb(d,b){var a,c;hMb(d.h.b,b);EEb(d.h,'Detalle');sKb(d.p,d.h);if(d.a.h){ap(Fn(gzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=jKb(d.p,c).b;ap(gzb(a),'height',d.a.l);}}}
function ubb(g,c,d){var a,b,e,f;e=Bk(wmb(g.n,d.c),62);ymb(g.c,izb(e),c);vyb(e,8,kbb(new jbb(),g));if(d.g!==null&& !Efb(d.g,'')){EEb(Bk(wmb(g.n,d.c),62),d.g);}else{EEb(Bk(wmb(g.n,d.c),62),'Resultados');}if(g.o==false||g.p.d.eQ(wmb(g.n,d.c))){g.o=true;sKb(g.p,g.i);f=kKb(g.p,Bk(wmb(g.n,d.c),62));oMb(jKb(g.p,f).b);hMb(jKb(g.p,f).b,c);if(g.a.h){aAb(jKb(g.p,f),g.a.l);ap(Fn(gzb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=jKb(g.p,b).b;ap(gzb(a),'height',g.a.l);}}ymb(g.d,izb(e),lcb(new jcb(),true));sKb(g.p,Bk(wmb(g.n,d.c),62));}}
...
function gPb(){}
_=gPb.prototype=new afb();_.tN=aRb+'DateLocale_es';_.tI=344;function nPb(a,b){return pkb(new nkb(),Bkb(a),xkb(a),tkb(a)+b);}
