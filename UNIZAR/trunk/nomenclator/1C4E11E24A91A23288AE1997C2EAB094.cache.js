...
/* The Original Code is 1C4E11E24A91A23288AE1997C2EAB094.cache.js
...
function ph(b){var a,c;a=Bk(Emb(b.a,'ampms'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['vorm.','nachm.']);anb(b.a,'ampms',c);return c;}else return a;}
function rh(b){var a,c;a=Bk(Emb(b.a,'eraNames'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['v. Chr.','n. Chr.']);anb(b.a,'eraNames',c);return c;}else return a;}
function sh(b){var a,c;a=Bk(Emb(b.a,'eras'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['v. Chr.','n. Chr.']);anb(b.a,'eras',c);return c;}else return a;}
function th(b){var a,c;a=Bk(Emb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);anb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(Emb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);anb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(Emb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);anb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(Emb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['So','Mo','Di','Mi','Do','Fr','Sa']);anb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(Emb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);anb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(Emb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['S','M','D','M','D','F','S']);anb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(Emb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);anb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(Emb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['So','Mo','Di','Mi','Do','Fr','Sa']);anb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(Emb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);anb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(Emb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',352,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);anb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new ifb();_.tN=dQb+'DateTimeConstants_de_CH';_.tI=28;function gk(){return null;}
...
function mDb(b,a){oDb();fJb(b,a);b.c=Fxb(new zxb(),67108864);if((a&16777216)!=0){pDb(b,0,'OK');}if((a&67108864)!=0){pDb(b,0,'OK');pDb(b,1,'Abbrechen');}if((a&268435456)!=0){pDb(b,2,'Ja');pDb(b,3,'Nein');}if((a&1073741824)!=0){pDb(b,2,'Ja');pDb(b,3,'Nein');pDb(b,1,'Abbrechen');}return b;}
...
function oPb(){}
_=oPb.prototype=new ifb();_.tN=iRb+'DateLocale_de_CH';_.tI=346;function vPb(a,b){return xkb(new vkb(),dlb(a),Fkb(a),Bkb(a)+b);}
