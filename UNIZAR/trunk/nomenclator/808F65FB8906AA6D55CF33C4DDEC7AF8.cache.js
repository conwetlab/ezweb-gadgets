...
/* The Original Code is 808F65FB8906AA6D55CF33C4DDEC7AF8.cache.js
...
function ef(b){var a,c;a=ri(Elb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['vorm.','nachm.']);amb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(Elb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['v. Chr.','n. Chr.']);amb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(Elb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['v. Chr.','n. Chr.']);amb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(Elb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);amb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(Elb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);amb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(Elb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);amb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(Elb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['So','Mo','Di','Mi','Do','Fr','Sa']);amb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(Elb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);amb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(Elb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['S','M','D','M','D','F','S']);amb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(Elb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);amb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(Elb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['So','Mo','Di','Mi','Do','Fr','Sa']);amb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(Elb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);amb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(Elb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);amb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new jeb();_.tN=aPb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function mCb(b,a){oCb();fIb(b,a);b.c=Fwb(new zwb(),67108864);if((a&16777216)!=0){pCb(b,0,'OK');}if((a&67108864)!=0){pCb(b,0,'OK');pCb(b,1,'Abbrechen');}if((a&268435456)!=0){pCb(b,2,'Ja');pCb(b,3,'Nein');}if((a&1073741824)!=0){pCb(b,2,'Ja');pCb(b,3,'Nein');pCb(b,1,'Abbrechen');}return b;}
...
function oOb(){}
_=oOb.prototype=new jeb();_.tN=hQb+'DateLocale_de_CH';_.tI=346;function vOb(a,b){return xjb(new vjb(),dkb(a),Fjb(a),Bjb(a)+b);}
