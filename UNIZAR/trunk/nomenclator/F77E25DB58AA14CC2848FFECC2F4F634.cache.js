...
/* The Original Code is F77E25DB58AA14CC2848FFECC2F4F634.cache.js
...
function bf(){}
_=bf.prototype=new zeb();_.tN=qPb+'DateTimeConstants_fr_CA';_.tI=18;function Ch(){return null;}
...
function hT(){}
_=hT.prototype=new zeb();_.tN=aQb+'AVOFilterBuilder';_.tI=151;_.c=null;_.d='CONTAINS WORD';_.g=false;function uT(e,a,f,c){var b,d;b=null;if(wfb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(wfb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(wfb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(wfb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(wfb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(wfb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(wfb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!wfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{r7((jbb(),sbb,'ERREUR'),(jbb(),sbb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(jbb(),sbb,'Accepter'),null,null,null);}return b;}
function vT(e,b,d,c){var a;a=null;if(wfb(c,e.c)){a=e.b+b+d+e.a;}else if(wfb(c,e.gb)){a=e.fb+b+d+e.eb;}else{r7((jbb(),sbb,'ERREUR'),(jbb(),sbb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(jbb(),sbb,'Accepter'),null,null,null);}return a;}
...
function hU(){}
_=hU.prototype=new zeb();_.tN=cQb+'CriterionsListElement';_.tI=155;_.a=null;_.b=null;function DU(a){a.p=dW(new yV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=jjb(new hjb());a.g=jjb(new hjb());a.a=jjb(new hjb());a.c=tFb(new oFb(),(jbb(),sbb,'Recherche en cours\u2026'));}
...
function fV(e,b,d,c){var a;if(e.h.q){EIb(e.c);}a=xU(new wU(),e,b,d);kbb(e.k);if(e.h.r){hW(e.p,b.a,b5(b),e.m.a,d,(jbb(),sbb,'fr'),a);}else{eV(e,b,e.m.a,d,(jbb(),sbb,'fr'));}}
...
function zU(b,a){if(b.a.h.q){AIb(b.a.c);}r7((jbb(),sbb,'ERREUR'),(jbb(),sbb,'Impossible de connecter au serveur')+': '+Bgb(a),(jbb(),sbb,'Accepter'),null,null,null);}
...
function F0(d,a){var b,c;x$(d,a);E0(d);d.b=null.ch;y$(d,d);Aw(d.e,d);x4(d.j,'mapa',d.a);if(null.ch==true){if(null.ch){d.g=gCb(new nBb(),192,'my-cpanel-small');if(null.ch){mCb(d.g,false);}}else{d.g=gCb(new nBb(),128,'my-cpanel-small');}pCb(d.g,null.ch);oyb(d.g,'criterionContentPanel');}else{d.g=gCb(new nBb(),0,'internal-compound-cpanel-small');oyb(d.g,'internalCompoundCriterionContentPanel');}d.d.qg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',352,12,[])));nb(c,null.ch);if(null.ch!=NaN&&null.ch!=NaN&&null.ch!=NaN&&null.ch!=NaN){d.a=eT(new dT(),d.b,(jbb(),sbb,'fr'),null.ch,null.ch,null.ch,null.ch,null.ch,qgb(null.ch),qgb(null.ch));}else{d.a=fT(new dT(),d.b,(jbb(),sbb,'fr'),qgb(null.ch),qgb(null.ch));}BJ(d.d,8);qu(d.d,d.a);if(null.ch==true){d.k=mv(new jv(),' '+(jbb(),sbb,'Utiliser la carte'));d.k.bc(y0(new x0(),d));uK(d.i,d.k);if(null.ch){pv(d.k,true);}else{pv(d.k,false);gS(d.a);}if(null.ch){b1(d);}if(null.ch){d.wg(false);}}uF(d.e,d.d);uK(d.i,d.e);nCb(d.g,'icon-text');d.i.fc('criterionPanel');FLb(d.g,d.i);if(null.ch){b=new B0();d.h=Dxb(new ixb(),(jbb(),sbb,'Nomenclature'),b);wzb(d.h,false);Czb(d.h,'coordinatesCCBGazetteerButton');FLb(d.g,d.h);}mw(d,d.g);return d;}
...
function x0(){}
_=x0.prototype=new zeb();_.oe=A0;_.tN=eQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=180;function D0(a){yo((jbb(),rbb,''),(jbb(),sbb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function B0(){}
...
function s3(){}
_=s3.prototype=new zeb();_.tN=gQb+'Messages_fr';_.tI=185;function y3(a){a.a=jjb(new hjb());}
...
function CCb(b,a){ECb();vIb(b,a);b.c=pxb(new jxb(),67108864);if((a&16777216)!=0){FCb(b,0,'OK');}if((a&67108864)!=0){FCb(b,0,'OK');FCb(b,1,'Annuler');}if((a&268435456)!=0){FCb(b,2,'Oui');FCb(b,3,'Non');}if((a&1073741824)!=0){FCb(b,2,'Oui');FCb(b,3,'Non');FCb(b,1,'Annuler');}return b;}
...
function f_(j,h){var a,b,c,d,e,f,g,i;mz(j.c);f=unb(new tnb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=y8(new x8());rC(d,'<<');nC(d,j);A8(ri(d,54),1+j.a*j.d-j.d);}else{d=lC(new kC());rC(d,' ');}d.fc('navigationArrowsLeft');wnb(f,d);if(h.b!=0){b=y8(new x8());rC(b,(jbb(),sbb,'Pr\xE9c\xE9dent'));nC(b,j);A8(ri(b,54),j.f-1);}else{b=lC(new kC());rC(b,' ');}b.fc('navigationPrevious');wnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=aeb(h.f/j.g);e++){g=y8(new x8());if(e==j.f){g.fc('navigationCurrentPage');}else{nC(g,j);A8(g,e);}rC(g,''+e);wnb(f,g);}if(j.f<aeb(h.f/j.g)){i=y8(new x8());rC(i,(jbb(),sbb,'Suivant'));nC(i,j);A8(ri(i,54),j.f+1);}else{i=lC(new kC());rC(i,' ');}i.fc('navigationNext');wnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=y8(new x8());rC(c,'>>');nC(c,j);A8(ri(c,54),e);}else{c=lC(new kC());rC(c,' ');}c.fc('navigationArrowsRight');wnb(f,c);zx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){Cz(j.c,0,a,ri(ynb(f,a),55));}}
...
function E_(c,a,b){D_(c);c.c=Dxb(new ixb(),'',a);c.a=Dxb(new ixb(),'',b);qxb(c.b,c.c);qxb(c.b,c.a);wEb(c.c,(jbb(),sbb,'AFFINER'));wEb(c.a,(jbb(),sbb,'NOUVELLE'));byb(c.c,'icon-refine');byb(c.a,'icon-new');mw(c,c.b);return c;}
function C_(){}
...
function pab(c,b,a){oab(c);c.a=Dxb(new ixb(),'',b);c.b=Dxb(new ixb(),'',a);qxb(c.c,c.a);qxb(c.c,c.b);Czb(c.c,'searchButtonsPanel');wEb(c.a,(jbb(),sbb,'Rechercher'));wEb(c.b,(jbb(),sbb,'Nettoyer'));byb(c.a,'icon-search');byb(c.b,'icon-clear');mw(c,c.c);return c;}
function nab(){}
...
function kbb(d){var a,b,c;if(d.h!==null){hKb(d.p,d.h);}d.h=xKb(new rKb(),2);a=d.h.b;if(d.a.h){um(Eyb(a),'height',d.a.l);}wEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");nyb(d.h,710,d.f);FJb(d.p,d.h);if(d.a.h){um(ul(Eyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=bKb(d.p,c).b;um(Eyb(b),'height',d.a.l);}}}
function lbb(g,d){var a,b,c,e,f;nyb(g.p,600,Fab(new Eab(),g));e=xKb(new rKb(),0);if(omb(g.n,d.c)!==null){f=cKb(g.p,ri(omb(g.n,d.c),61));hKb(g.p,ri(omb(g.n,d.c),61));if(d.g!==null&& !xfb(d.g,'')){wEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{wEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}Czb(e,'resultsTabItem');a=e.b;wGb(a,true);if(g.a.h){um(Eyb(a),'height',g.a.l);}qmb(g.n,d.c,e);dKb(g.p,ri(omb(g.n,d.c),61),f);kKb(g.p,e);}else{if(d.g!==null&& !xfb(d.g,'')){wEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{wEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}Czb(e,'resultsTabItem');a=e.b;wGb(a,true);if(g.a.h){um(Eyb(a),'height',g.a.l);}qmb(g.n,d.c,e);FJb(g.p,ri(omb(g.n,d.c),61));}qmb(g.d,azb(e),ecb(new ccb(),false));kKb(g.p,ri(omb(g.n,d.c),61));if(g.a.h){um(ul(Eyb(g.p),1),'height',g.a.l);for(c=0;c<g.p.B.b;c++){b=bKb(g.p,c).b;um(Eyb(b),'height',g.a.l);}}}
function mbb(d,b){var a,c;FLb(d.h.b,b);wEb(d.h,'D\xE9tail');kKb(d.p,d.h);if(d.a.h){um(ul(Eyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=bKb(d.p,c).b;um(Eyb(a),'height',d.a.l);}}}
function nbb(g,c,d){var a,b,e,f;e=ri(omb(g.n,d.c),61);qmb(g.c,azb(e),c);nyb(e,8,dbb(new cbb(),g));if(d.g!==null&& !xfb(d.g,'')){wEb(ri(omb(g.n,d.c),61),d.g);}else{wEb(ri(omb(g.n,d.c),61),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(omb(g.n,d.c))){g.o=true;kKb(g.p,g.i);f=cKb(g.p,ri(omb(g.n,d.c),61));gMb(bKb(g.p,f).b);FLb(bKb(g.p,f).b,c);if(g.a.h){yzb(bKb(g.p,f),g.a.l);um(ul(Eyb(g.p),1),'height',g.a.l);for(b=0;b<g.p.B.b;b++){a=bKb(g.p,b).b;um(Eyb(a),'height',g.a.l);}}qmb(g.d,azb(e),ecb(new ccb(),true));kKb(g.p,ri(omb(g.n,d.c),61));}}
...
function vbb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;ubb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;zx(p.d,p.e.b,2);if(p.i){zx(p.d,p.e.b+3,2);h=uE(new tE(),'myRadioGroup');pv(h,false);Cz(p.d,0,0,h);f=mC(new kC(),(jbb(),sbb,'New source'));Cz(p.d,0,1,f);o=AA(new yA());m=mC(new kC(),(jbb(),sbb,'URL')+':  ');BA(o,m);p.h.qg('sourcesListTextBox');BA(o,p.h);Cz(p.d,1,1,o);c=AA(new yA());l=mC(new kC(),(jbb(),sbb,'Type')+':  ');BA(c,l);p.a.qg('sourcesListListBox');BA(c,p.a);for(b=0;b<p.c.b;b++){CC(p.a,ri(qjb(p.c,b),1));}Cz(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=kv(new jv());Cz(p.d,b+e,0,a);pv(a,ri(qjb(p.e,b),40).b);j=mC(new kC(),ri(qjb(p.e,b),40).g);Cz(p.d,b+e,1,j);}else{h=uE(new tE(),'myRadioGroup');if(!i&&ri(qjb(p.e,b),40).b){pv(h,true);i=true;}Cz(p.d,b+e,0,h);k=mC(new kC(),ri(qjb(p.e,b),40).g);Cz(p.d,b+e,1,k);}}if(!p.b){if(!i){pv(ri(rz(p.d,0,0),65),true);}}if(yO(wV,'sourcesListTitle')!==null&& !xfb(yO(wV,'sourcesListTitle'),'')){pCb(p.f,yO(wV,'sourcesListTitle'));}else{pCb(p.f,(jbb(),sbb,'Sources disponibles'));}oCb(p.f,5);oyb(p.f,'sourcesListPanel');nCb(p.f,'icon-text');yz(p.d,4);uF(p.g,p.d);p.g.qg('sourcesGrid');FLb(p.f,p.g);mw(p,p.f);return p;}
...
function EOb(){}
_=EOb.prototype=new zeb();_.tN=xQb+'DateLocale_fr_CA';_.tI=349;function fPb(a,b){return hkb(new fkb(),tkb(a),pkb(a),lkb(a)+b);}
