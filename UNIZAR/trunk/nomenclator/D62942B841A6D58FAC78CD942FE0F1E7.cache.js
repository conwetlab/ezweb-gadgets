...
/* The Original Code is D62942B841A6D58FAC78CD942FE0F1E7.cache.js
...
function bf(){}
_=bf.prototype=new zeb();_.tN=qPb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function CCb(b,a){ECb();vIb(b,a);b.c=pxb(new jxb(),67108864);if((a&16777216)!=0){FCb(b,0,'OK');}if((a&67108864)!=0){FCb(b,0,'OK');FCb(b,1,'Abbrechen');}if((a&268435456)!=0){FCb(b,2,'Ja');FCb(b,3,'Nein');}if((a&1073741824)!=0){FCb(b,2,'Ja');FCb(b,3,'Nein');FCb(b,1,'Abbrechen');}return b;}
...
function EOb(){}
_=EOb.prototype=new zeb();_.tN=xQb+'DateLocale_de_CH';_.tI=349;function fPb(a,b){return hkb(new fkb(),tkb(a),pkb(a),lkb(a)+b);}
