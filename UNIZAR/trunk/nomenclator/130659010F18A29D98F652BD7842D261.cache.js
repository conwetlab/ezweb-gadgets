...
/* The Original Code is 130659010F18A29D98F652BD7842D261.cache.js
 * The Initial Developer of the Original Code is IAAA.
 *
 * Created on Tue May 04 10:15:45 CEST 2010 
 */
...
function gf(b){var a,c;a=ri(Elb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['av. J.-C.','ap. J.-C.']);amb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(Elb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['av. J.-C.','apr. J.-C.']);amb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(Elb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);amb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(Elb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);amb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(Elb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);amb(b.a,'shortMonths',c);return c;}else return a;}
function nf(b){var a,c;a=ri(Elb(b.a,'shortQuarters'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['T1','T2','T3','T4']);amb(b.a,'shortQuarters',c);return c;}else return a;}
function of(b){var a,c;a=ri(Elb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);amb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(Elb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);amb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(Elb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['D','L','M','M','J','V','S']);amb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(Elb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);amb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(Elb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);amb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(Elb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);amb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(Elb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);amb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new jeb();_.tN=aPb+'DateTimeConstants_fr_CH';_.tI=18;function Ch(){return null;}
...
function qT(d,a,b,c){if(hfb(a,'viewDetails'))FU(d.a,b,c);else{b7((zab(),cbb,'ERREUR'),(zab(),cbb,'Comportement non d\xE9fini'),(zab(),cbb,'Accepter'),null,null,null);}}
...
function xS(){}
_=xS.prototype=new jeb();_.tN=qPb+'AVOFilterBuilder';_.tI=148;_.c=null;_.d='CONTAINS WORD';_.g=false;function eT(e,a,f,c){var b,d;b=null;if(gfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(gfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(gfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(gfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(gfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(gfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(gfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!gfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{b7((zab(),cbb,'ERREUR'),(zab(),cbb,'FilterBuilderToolkitObject: op\xE9ration invalide'),(zab(),cbb,'Accepter'),null,null,null);}return b;}
function fT(e,b,d,c){var a;a=null;if(gfb(c,e.c)){a=e.b+b+d+e.a;}else if(gfb(c,e.eb)){a=e.db+b+d+e.cb;}else{b7((zab(),cbb,'ERREUR'),(zab(),cbb,'FilterBuilderToolkitObject: op\xE9ration logique valide')+': '+c,(zab(),cbb,'Accepter'),null,null,null);}return a;}
...
function xT(){}
_=xT.prototype=new jeb();_.tN=sPb+'CriterionsListElement';_.tI=152;_.a=null;_.b=null;function nU(a){a.p=tV(new iV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=zib(new xib());a.g=zib(new xib());a.a=zib(new xib());a.c=dFb(new EEb(),(zab(),cbb,'Recherche en cours\u2026'));}
...
function vU(e,b,d,c){var a;if(e.h.q){oIb(e.c);}a=hU(new gU(),e,b,d);Aab(e.k);if(e.h.r){xV(e.p,b.a,r4(b),e.m.a,d,(zab(),cbb,'fr'),a);}else{uU(e,b,e.m.a,d,(zab(),cbb,'fr'));}}
...
function fV(a,c,b){if(b!==null&& !hfb(b.c,'')){EU(this,a,c);BU(this,this,true,b);}else{b7((zab(),cbb,'ERREUR'),(zab(),cbb,'Dossier de description de source incorrect')+': '+b.c,(zab(),cbb,'Accepter'),null,null,null);}}
function ET(){}
...
function cU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERREUR'),(zab(),cbb,'Impossible de connecter au serveur'),(zab(),cbb,'Accepter'),null,null,null);}
function dU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&lfb(e.c)>0){c='';try{if(iO(gV,e.c)!==null&&lfb(iO(gV,e.c))>0){c=iO(gV,e.c);}else{c=g3((zab(),cbb),e.c);}if(gfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,32)){a;c=e.d;}else throw a;}b7((zab(),cbb,'ERREUR'),c,(zab(),cbb,'Accepter'),null,null,null);}else{aV(f.b,e);}if(f.a.h.q){kIb(f.a.c);}}
...
function jU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERREUR'),(zab(),cbb,'Impossible de connecter au serveur')+': '+lgb(a),(zab(),cbb,'Accepter'),null,null,null);}
...
function p0(d,a){var b,c;h$(d,a);o0(d);d.b=null.ah;i$(d,d);uw(d.e,d);h4(d.j,'mapa',d.a);if(null.ah==true){if(null.ah){d.g=wBb(new DAb(),192,'my-cpanel-small');if(null.ah){CBb(d.g,false);}}else{d.g=wBb(new DAb(),128,'my-cpanel-small');}FBb(d.g,null.ah);Exb(d.g,'criterionContentPanel');}else{d.g=wBb(new DAb(),0,'internal-compound-cpanel-small');Exb(d.g,'internalCompoundCriterionContentPanel');}d.d.og('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',349,12,[])));nb(c,null.ah);if(null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN){d.a=uS(new tS(),d.b,(zab(),cbb,'fr'),null.ah,null.ah,null.ah,null.ah,null.ah,agb(null.ah),agb(null.ah));}else{d.a=vS(new tS(),d.b,(zab(),cbb,'fr'),agb(null.ah),agb(null.ah));}vJ(d.d,8);ku(d.d,d.a);if(null.ah==true){d.k=gv(new dv(),' '+(zab(),cbb,'Utiliser la carte'));d.k.Fb(i0(new h0(),d));oK(d.i,d.k);if(null.ah){jv(d.k,true);}else{jv(d.k,false);wR(d.a);}if(null.ah){r0(d);}if(null.ah){d.ug(false);}}oF(d.e,d.d);oK(d.i,d.e);DBb(d.g,'icon-text');d.i.dc('criterionPanel');pLb(d.g,d.i);if(null.ah){b=new l0();d.h=nxb(new ywb(),(zab(),cbb,'Nomenclature'),b);gzb(d.h,false);mzb(d.h,'coordinatesCCBGazetteerButton');pLb(d.g,d.h);}gw(d,d.g);return d;}
...
function h0(){}
_=h0.prototype=new jeb();_.me=k0;_.tN=uPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=177;function n0(a){yo((zab(),bbb,''),(zab(),cbb,'Nomenclature'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function l0(){}
...
function b1(){F0(this);}
function c1(){var a,b;a=j4(new m3());this.c=D3(new B3());m4(a,this.c);if(!(nG(this.a),true)){l4(a,(zab(),cbb,'Invalid date'));}else{if(this.a.d!==null){b=p3(new n3());r3(b,null.ah);s3(b,null.ah);t3(b,null.bh());b4(this.c,0,b);a4(this.c,null.ah);c4(this.c,null.ah);o4(a,null.ah+': '+null.bh());}else{a=null;}}return a;}
...
function g3(d,b){var a,c;c=ri(Elb(d.a,b),1);if(c!==null)return c;if(hfb(b,'OuterServiceException')){a='Outer service reported an exception';amb(d.a,'OuterServiceException',a);return a;}if(hfb(b,'UnableToInitIndex')){a='Unable to init an index';amb(d.a,'UnableToInitIndex',a);return a;}if(hfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: op\xE9ration logique valide';amb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(hfb(b,'usarMapa')){a='Utiliser la carte';amb(d.a,'usarMapa',a);return a;}if(hfb(b,'hasta')){a='\xE0';amb(d.a,'hasta',a);return a;}if(hfb(b,'resultados')){a='R\xE9sultats';amb(d.a,'resultados',a);return a;}if(hfb(b,'valueErrors')){a='Error entering search criteria';amb(d.a,'valueErrors',a);return a;}if(hfb(b,'ningunCriterioIntroducido')){a='Vous devez saisir un crit\xE8re pour lancer la rechercher';amb(d.a,'ningunCriterioIntroducido',a);return a;}if(hfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';amb(d.a,'requiredCriterionError',a);return a;}if(hfb(b,'gazetteerTitle')){a='Nomenclature';amb(d.a,'gazetteerTitle',a);return a;}if(hfb(b,'sourceURLTitle')){a='URL';amb(d.a,'sourceURLTitle',a);return a;}if(hfb(b,'UnknownFaliure')){a='Unknown service failure';amb(d.a,'UnknownFaliure',a);return a;}if(hfb(b,'okButtonLabel')){a='Accepter';amb(d.a,'okButtonLabel',a);return a;}if(hfb(b,'nuevaBusqueda')){a='NOUVELLE';amb(d.a,'nuevaBusqueda',a);return a;}if(hfb(b,'refinar')){a='AFFINER';amb(d.a,'refinar',a);return a;}if(hfb(b,'newSourceTitle')){a='New source';amb(d.a,'newSourceTitle',a);return a;}if(hfb(b,'anterior')){a='Pr\xE9c\xE9dent';amb(d.a,'anterior',a);return a;}if(hfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";amb(d.a,'UnableToReadSourceResponse',a);return a;}if(hfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';amb(d.a,'UnableToSynchroniseSource',a);return a;}if(hfb(b,'siguiente')){a='Suivant';amb(d.a,'siguiente',a);return a;}if(hfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';amb(d.a,'UnsupportedEncoding',a);return a;}if(hfb(b,'connection_error')){a='Impossible de connecter au serveur';amb(d.a,'connection_error',a);return a;}if(hfb(b,'limpiar')){a='Nettoyer';amb(d.a,'limpiar',a);return a;}if(hfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';amb(d.a,'NoReachableOuterService',a);return a;}if(hfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';amb(d.a,'UnableToRemoveFromIndex',a);return a;}if(hfb(b,'sourcesListTitle')){a='Sources disponibles';amb(d.a,'sourcesListTitle',a);return a;}if(hfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';amb(d.a,'UnableToInitSource',a);return a;}if(hfb(b,'ayuda')){a='Aide';amb(d.a,'ayuda',a);return a;}if(hfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";amb(d.a,'NoReachableRDF',a);return a;}if(hfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';amb(d.a,'UnableToPerformInsertion',a);return a;}if(hfb(b,'deUnTotalDe')){a='sur un total de';amb(d.a,'deUnTotalDe',a);return a;}if(hfb(b,'invalidDate')){a='Invalid date';amb(d.a,'invalidDate',a);return a;}if(hfb(b,'sinResultados')){a="Aucun r\xE9sultat n'a \xE9t\xE9 trouv\xE9";amb(d.a,'sinResultados',a);return a;}if(hfb(b,'aceptar')){a='Accepter';amb(d.a,'aceptar',a);return a;}if(hfb(b,'buscar')){a='Rechercher';amb(d.a,'buscar',a);return a;}if(hfb(b,'ResultList_Title')){a='Liste de r\xE9sultats';amb(d.a,'ResultList_Title',a);return a;}if(hfb(b,'buscando')){a='Recherche en cours\u2026';amb(d.a,'buscando',a);return a;}if(hfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';amb(d.a,'NoReachablePool',a);return a;}if(hfb(b,'sourceTypeTitle')){a='Type';amb(d.a,'sourceTypeTitle',a);return a;}if(hfb(b,'SearchInfo_Title')){a='Information de la requ\xEAte';amb(d.a,'SearchInfo_Title',a);return a;}if(hfb(b,'undefinedBehaviour')){a='Comportement non d\xE9fini';amb(d.a,'undefinedBehaviour',a);return a;}if(hfb(b,'detalle')){a='D\xE9tail';amb(d.a,'detalle',a);return a;}if(hfb(b,'error')){a='ERREUR';amb(d.a,'error',a);return a;}if(hfb(b,'loading')){a='Chargement\u2026';amb(d.a,'loading',a);return a;}if(hfb(b,'resultComponentVoid')){a='-';amb(d.a,'resultComponentVoid',a);return a;}if(hfb(b,'busquedaAnterior')){a='PR\xC9C\xC9DENT';amb(d.a,'busquedaAnterior',a);return a;}if(hfb(b,'wrongSourceDescriptionFile')){a='Dossier de description de source incorrect';amb(d.a,'wrongSourceDescriptionFile',a);return a;}if(hfb(b,'locale')){a='fr';amb(d.a,'locale',a);return a;}if(hfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";amb(d.a,'NotAValidQuery',a);return a;}if(hfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: op\xE9ration invalide';amb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw ymb(new xmb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function c3(){}
_=c3.prototype=new jeb();_.tN=wPb+'Messages_fr';_.tI=182;function i3(a){a.a=zib(new xib());}
...
function mCb(b,a){oCb();fIb(b,a);b.c=Fwb(new zwb(),67108864);if((a&16777216)!=0){pCb(b,0,'OK');}if((a&67108864)!=0){pCb(b,0,'OK');pCb(b,1,'Annuler');}if((a&268435456)!=0){pCb(b,2,'Oui');pCb(b,3,'Non');}if((a&1073741824)!=0){pCb(b,2,'Oui');pCb(b,3,'Non');pCb(b,1,'Annuler');}return b;}
...
function v$(j,h){var a,b,c,d,e,f,g,i;gz(j.c);f=enb(new dnb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=i8(new h8());lC(d,'<<');hC(d,j);k8(ri(d,54),1+j.a*j.d-j.d);}else{d=fC(new eC());lC(d,' ');}d.dc('navigationArrowsLeft');gnb(f,d);if(h.b!=0){b=i8(new h8());lC(b,(zab(),cbb,'Pr\xE9c\xE9dent'));hC(b,j);k8(ri(b,54),j.f-1);}else{b=fC(new eC());lC(b,' ');}b.dc('navigationPrevious');gnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=qdb(h.f/j.g);e++){g=i8(new h8());if(e==j.f){g.dc('navigationCurrentPage');}else{hC(g,j);k8(g,e);}lC(g,''+e);gnb(f,g);}if(j.f<qdb(h.f/j.g)){i=i8(new h8());lC(i,(zab(),cbb,'Suivant'));hC(i,j);k8(ri(i,54),j.f+1);}else{i=fC(new eC());lC(i,' ');}i.dc('navigationNext');gnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=i8(new h8());lC(c,'>>');hC(c,j);k8(ri(c,54),e);}else{c=fC(new eC());lC(c,' ');}c.dc('navigationArrowsRight');gnb(f,c);tx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){wz(j.c,0,a,ri(inb(f,a),55));}}
...
function o_(c,a,b){n_(c);c.c=nxb(new ywb(),'',a);c.a=nxb(new ywb(),'',b);axb(c.b,c.c);axb(c.b,c.a);gEb(c.c,(zab(),cbb,'AFFINER'));gEb(c.a,(zab(),cbb,'NOUVELLE'));rxb(c.c,'icon-refine');rxb(c.a,'icon-new');gw(c,c.b);return c;}
function m_(){}
...
function F_(c,b,a){E_(c);c.a=nxb(new ywb(),'',b);c.b=nxb(new ywb(),'',a);axb(c.c,c.a);axb(c.c,c.b);mzb(c.c,'searchButtonsPanel');gEb(c.a,(zab(),cbb,'Rechercher'));gEb(c.b,(zab(),cbb,'Nettoyer'));rxb(c.a,'icon-search');rxb(c.b,'icon-clear');gw(c,c.c);return c;}
function D_(){}
...
function Aab(d){var a,b,c;if(d.h!==null){xJb(d.p,d.h);}d.h=hKb(new bKb(),2);a=d.h.b;if(d.a.h){um(oyb(a),'height',d.a.l);}gEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;D\xE9tail");Dxb(d.h,710,d.f);pJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=rJb(d.p,c).b;um(oyb(b),'height',d.a.l);}}}
function Bab(g,d){var a,b,c,e,f;Dxb(g.p,600,pab(new oab(),g));e=hKb(new bKb(),0);if(Elb(g.n,d.c)!==null){f=sJb(g.p,ri(Elb(g.n,d.c),61));xJb(g.p,ri(Elb(g.n,d.c),61));if(d.g!==null&& !hfb(d.g,'')){gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}mzb(e,'resultsTabItem');a=e.b;gGb(a,true);if(g.a.h){um(oyb(a),'height',g.a.l);}amb(g.n,d.c,e);tJb(g.p,ri(Elb(g.n,d.c),61),f);AJb(g.p,e);}else{if(d.g!==null&& !hfb(d.g,'')){gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;R\xE9sultats");}mzb(e,'resultsTabItem');a=e.b;gGb(a,true);if(g.a.h){um(oyb(a),'height',g.a.l);}amb(g.n,d.c,e);pJb(g.p,ri(Elb(g.n,d.c),61));}amb(g.d,qyb(e),ubb(new sbb(),false));AJb(g.p,ri(Elb(g.n,d.c),61));if(g.a.h){um(ul(oyb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=rJb(g.p,c).b;um(oyb(b),'height',g.a.l);}}}
function Cab(d,b){var a,c;pLb(d.h.b,b);gEb(d.h,'D\xE9tail');AJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=rJb(d.p,c).b;um(oyb(a),'height',d.a.l);}}}
function Dab(g,c,d){var a,b,e,f;e=ri(Elb(g.n,d.c),61);amb(g.c,qyb(e),c);Dxb(e,8,tab(new sab(),g));if(d.g!==null&& !hfb(d.g,'')){gEb(ri(Elb(g.n,d.c),61),d.g);}else{gEb(ri(Elb(g.n,d.c),61),'R\xE9sultats');}if(g.o==false||g.p.d.eQ(Elb(g.n,d.c))){g.o=true;AJb(g.p,g.i);f=sJb(g.p,ri(Elb(g.n,d.c),61));wLb(rJb(g.p,f).b);pLb(rJb(g.p,f).b,c);if(g.a.h){izb(rJb(g.p,f),g.a.l);um(ul(oyb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=rJb(g.p,b).b;um(oyb(a),'height',g.a.l);}}amb(g.d,qyb(e),ubb(new sbb(),true));AJb(g.p,ri(Elb(g.n,d.c),61));}}
...
function fbb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;ebb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;tx(p.d,p.e.b,2);if(p.i){tx(p.d,p.e.b+3,2);h=oE(new nE(),'myRadioGroup');jv(h,false);wz(p.d,0,0,h);f=gC(new eC(),(zab(),cbb,'New source'));wz(p.d,0,1,f);o=uA(new sA());m=gC(new eC(),(zab(),cbb,'URL')+':  ');vA(o,m);p.h.og('sourcesListTextBox');vA(o,p.h);wz(p.d,1,1,o);c=uA(new sA());l=gC(new eC(),(zab(),cbb,'Type')+':  ');vA(c,l);p.a.og('sourcesListListBox');vA(c,p.a);for(b=0;b<p.c.b;b++){wC(p.a,ri(ajb(p.c,b),1));}wz(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=ev(new dv());wz(p.d,b+e,0,a);jv(a,ri(ajb(p.e,b),40).b);j=gC(new eC(),ri(ajb(p.e,b),40).g);wz(p.d,b+e,1,j);}else{h=oE(new nE(),'myRadioGroup');if(!i&&ri(ajb(p.e,b),40).b){jv(h,true);i=true;}wz(p.d,b+e,0,h);k=gC(new eC(),ri(ajb(p.e,b),40).g);wz(p.d,b+e,1,k);}}if(!p.b){if(!i){jv(ri(lz(p.d,0,0),65),true);}}if(iO(gV,'sourcesListTitle')!==null&& !hfb(iO(gV,'sourcesListTitle'),'')){FBb(p.f,iO(gV,'sourcesListTitle'));}else{FBb(p.f,(zab(),cbb,'Sources disponibles'));}EBb(p.f,5);Exb(p.f,'sourcesListPanel');DBb(p.f,'icon-text');sz(p.d,4);oF(p.g,p.d);p.g.og('sourcesGrid');pLb(p.f,p.g);gw(p,p.f);return p;}
...
function BNb(){}
_=BNb.prototype=new jeb();_.ke=ENb;_.tN=gQb+'PopupCalendar$8';_.tI=345;function pOb(a){a.a=li('[I',347,(-1),[1,2,3,4,5,6,0]);}
function qOb(a){pOb(a);return a;}
function sOb(b){var a;a=Ee('dd/MM/yyyy');return a;}
function oOb(){}
_=oOb.prototype=new jeb();_.tN=hQb+'DateLocale_fr_CH';_.tI=346;function vOb(a,b){return xjb(new vjb(),dkb(a),Fjb(a),Bjb(a)+b);}
