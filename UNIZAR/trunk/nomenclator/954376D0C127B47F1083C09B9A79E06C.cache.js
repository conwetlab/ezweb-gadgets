...
/* The Original Code is 954376D0C127B47F1083C09B9A79E06C.cache.js
...
function gf(b){var a,c;a=ri(gmb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['a.C.','d.C.']);imb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(gmb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['a.C.','d.C.']);imb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(gmb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);imb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(gmb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);imb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(gmb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);imb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(gmb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);imb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(gmb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);imb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(gmb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['D','S','T','Q','Q','S','S']);imb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(gmb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);imb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(gmb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);imb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(gmb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);imb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(gmb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',350,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);imb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new reb();_.tN=iPb+'DateTimeConstants_pt_BR';_.tI=18;function Ch(){return null;}
...
function yT(d,a,b,c){if(pfb(a,'viewDetails'))hV(d.a,b,c);else{j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'Comportamento n\xE3o definido'),(bbb(),kbb,'Aceitar'),null,null,null);}}
...
function FS(){}
_=FS.prototype=new reb();_.tN=yPb+'AVOFilterBuilder';_.tI=150;_.c=null;_.d='CONTAINS WORD';_.g=false;function mT(e,a,f,c){var b,d;b=null;if(ofb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(ofb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(ofb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(ofb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(ofb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(ofb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(ofb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!ofb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(bbb(),kbb,'Aceitar'),null,null,null);}return b;}
function nT(e,b,d,c){var a;a=null;if(ofb(c,e.c)){a=e.b+b+d+e.a;}else if(ofb(c,e.eb)){a=e.db+b+d+e.cb;}else{j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(bbb(),kbb,'Aceitar'),null,null,null);}return a;}
...
function FT(){}
_=FT.prototype=new reb();_.tN=APb+'CriterionsListElement';_.tI=154;_.a=null;_.b=null;function vU(a){a.p=BV(new qV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=bjb(new Fib());a.g=bjb(new Fib());a.a=bjb(new Fib());a.c=lFb(new gFb(),(bbb(),kbb,'Pesquisando...'));}
...
function DU(e,b,d,c){var a;if(e.h.q){wIb(e.c);}a=pU(new oU(),e,b,d);cbb(e.k);if(e.h.r){FV(e.p,b.a,z4(b),e.m.a,d,(bbb(),kbb,'pt'),a);}else{CU(e,b,e.m.a,d,(bbb(),kbb,'pt'));}}
...
function nV(a,c,b){if(b!==null&& !pfb(b.c,'')){gV(this,a,c);dV(this,this,true,b);}else{j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(bbb(),kbb,'Aceitar'),null,null,null);}}
function gU(){}
...
function kU(b,a){if(b.a.h.q){sIb(b.a.c);}j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'N\xE3o se p\xF4de ligar com o servidor'),(bbb(),kbb,'Aceitar'),null,null,null);}
function lU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&tfb(e.c)>0){c='';try{if(qO(oV,e.c)!==null&&tfb(qO(oV,e.c))>0){c=qO(oV,e.c);}else{c=o3((bbb(),kbb),e.c);}if(ofb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,32)){a;c=e.d;}else throw a;}j7((bbb(),kbb,'ERRO'),c,(bbb(),kbb,'Aceitar'),null,null,null);}else{iV(f.b,e);}if(f.a.h.q){sIb(f.a.c);}}
...
function rU(b,a){if(b.a.h.q){sIb(b.a.c);}j7((bbb(),kbb,'ERRO'),(bbb(),kbb,'N\xE3o se p\xF4de ligar com o servidor')+': '+tgb(a),(bbb(),kbb,'Aceitar'),null,null,null);}
...
function x0(d,a){var b,c;p$(d,a);w0(d);d.b=null.ah;q$(d,d);uw(d.e,d);p4(d.j,'mapa',d.a);if(null.ah==true){if(null.ah){d.g=EBb(new fBb(),192,'my-cpanel-small');if(null.ah){eCb(d.g,false);}}else{d.g=EBb(new fBb(),128,'my-cpanel-small');}hCb(d.g,null.ah);gyb(d.g,'criterionContentPanel');}else{d.g=EBb(new fBb(),0,'internal-compound-cpanel-small');gyb(d.g,'internalCompoundCriterionContentPanel');}d.d.og('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',351,12,[])));nb(c,null.ah);if(null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN){d.a=CS(new BS(),d.b,(bbb(),kbb,'pt'),null.ah,null.ah,null.ah,null.ah,null.ah,igb(null.ah),igb(null.ah));}else{d.a=DS(new BS(),d.b,(bbb(),kbb,'pt'),igb(null.ah),igb(null.ah));}xJ(d.d,8);ku(d.d,d.a);if(null.ah==true){d.k=gv(new dv(),' '+(bbb(),kbb,'Usar mapa'));d.k.Fb(q0(new p0(),d));qK(d.i,d.k);if(null.ah){jv(d.k,true);}else{jv(d.k,false);ER(d.a);}if(null.ah){z0(d);}if(null.ah){d.ug(false);}}qF(d.e,d.d);qK(d.i,d.e);fCb(d.g,'icon-text');d.i.dc('criterionPanel');xLb(d.g,d.i);if(null.ah){b=new t0();d.h=vxb(new axb(),(bbb(),kbb,'Nomenclatura'),b);ozb(d.h,false);uzb(d.h,'coordinatesCCBGazetteerButton');xLb(d.g,d.h);}gw(d,d.g);return d;}
...
function p0(){}
_=p0.prototype=new reb();_.me=s0;_.tN=CPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=179;function v0(a){yo((bbb(),jbb,''),(bbb(),kbb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function t0(){}
...
function o3(d,b){var a,c;c=ri(gmb(d.a,b),1);if(c!==null)return c;if(pfb(b,'OuterServiceException')){a='Outer service reported an exception';imb(d.a,'OuterServiceException',a);return a;}if(pfb(b,'UnableToInitIndex')){a='Unable to init an index';imb(d.a,'UnableToInitIndex',a);return a;}if(pfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';imb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(pfb(b,'usarMapa')){a='Usar mapa';imb(d.a,'usarMapa',a);return a;}if(pfb(b,'hasta')){a='a';imb(d.a,'hasta',a);return a;}if(pfb(b,'resultados')){a='Resultados';imb(d.a,'resultados',a);return a;}if(pfb(b,'valueErrors')){a='Error entering search criteria';imb(d.a,'valueErrors',a);return a;}if(pfb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';imb(d.a,'ningunCriterioIntroducido',a);return a;}if(pfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';imb(d.a,'requiredCriterionError',a);return a;}if(pfb(b,'gazetteerTitle')){a='Nomenclatura';imb(d.a,'gazetteerTitle',a);return a;}if(pfb(b,'sourceURLTitle')){a='URL';imb(d.a,'sourceURLTitle',a);return a;}if(pfb(b,'UnknownFaliure')){a='Unknown service failure';imb(d.a,'UnknownFaliure',a);return a;}if(pfb(b,'okButtonLabel')){a='Aceitar';imb(d.a,'okButtonLabel',a);return a;}if(pfb(b,'nuevaBusqueda')){a='NOVA';imb(d.a,'nuevaBusqueda',a);return a;}if(pfb(b,'refinar')){a='REFINAR ';imb(d.a,'refinar',a);return a;}if(pfb(b,'newSourceTitle')){a='New source';imb(d.a,'newSourceTitle',a);return a;}if(pfb(b,'anterior')){a='Anterior';imb(d.a,'anterior',a);return a;}if(pfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";imb(d.a,'UnableToReadSourceResponse',a);return a;}if(pfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';imb(d.a,'UnableToSynchroniseSource',a);return a;}if(pfb(b,'siguiente')){a='Seguinte';imb(d.a,'siguiente',a);return a;}if(pfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';imb(d.a,'UnsupportedEncoding',a);return a;}if(pfb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';imb(d.a,'connection_error',a);return a;}if(pfb(b,'limpiar')){a='Limpar';imb(d.a,'limpiar',a);return a;}if(pfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';imb(d.a,'NoReachableOuterService',a);return a;}if(pfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';imb(d.a,'UnableToRemoveFromIndex',a);return a;}if(pfb(b,'sourcesListTitle')){a='Fontes dispon\xEDveis';imb(d.a,'sourcesListTitle',a);return a;}if(pfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';imb(d.a,'UnableToInitSource',a);return a;}if(pfb(b,'ayuda')){a='Ajuda';imb(d.a,'ayuda',a);return a;}if(pfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";imb(d.a,'NoReachableRDF',a);return a;}if(pfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';imb(d.a,'UnableToPerformInsertion',a);return a;}if(pfb(b,'deUnTotalDe')){a='de um total de';imb(d.a,'deUnTotalDe',a);return a;}if(pfb(b,'invalidDate')){a='Invalid date';imb(d.a,'invalidDate',a);return a;}if(pfb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';imb(d.a,'sinResultados',a);return a;}if(pfb(b,'aceptar')){a='Aceitar';imb(d.a,'aceptar',a);return a;}if(pfb(b,'buscar')){a='Pesquisar';imb(d.a,'buscar',a);return a;}if(pfb(b,'ResultList_Title')){a='Lista de resultados';imb(d.a,'ResultList_Title',a);return a;}if(pfb(b,'buscando')){a='Pesquisando...';imb(d.a,'buscando',a);return a;}if(pfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';imb(d.a,'NoReachablePool',a);return a;}if(pfb(b,'sourceTypeTitle')){a='Type';imb(d.a,'sourceTypeTitle',a);return a;}if(pfb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';imb(d.a,'SearchInfo_Title',a);return a;}if(pfb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';imb(d.a,'undefinedBehaviour',a);return a;}if(pfb(b,'detalle')){a='Pormenor';imb(d.a,'detalle',a);return a;}if(pfb(b,'error')){a='ERRO';imb(d.a,'error',a);return a;}if(pfb(b,'loading')){a='Carregando...';imb(d.a,'loading',a);return a;}if(pfb(b,'resultComponentVoid')){a='-';imb(d.a,'resultComponentVoid',a);return a;}if(pfb(b,'busquedaAnterior')){a='ANTERIOR';imb(d.a,'busquedaAnterior',a);return a;}if(pfb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';imb(d.a,'wrongSourceDescriptionFile',a);return a;}if(pfb(b,'locale')){a='pt';imb(d.a,'locale',a);return a;}if(pfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";imb(d.a,'NotAValidQuery',a);return a;}if(pfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';imb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw anb(new Fmb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function k3(){}
_=k3.prototype=new reb();_.tN=EPb+'Messages_pt';_.tI=184;function q3(a){a.a=bjb(new Fib());}
...
function D$(j,h){var a,b,c,d,e,f,g,i;gz(j.c);f=mnb(new lnb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=q8(new p8());lC(d,'<<');hC(d,j);s8(ri(d,54),1+j.a*j.d-j.d);}else{d=fC(new eC());lC(d,' ');}d.dc('navigationArrowsLeft');onb(f,d);if(h.b!=0){b=q8(new p8());lC(b,(bbb(),kbb,'Anterior'));hC(b,j);s8(ri(b,54),j.f-1);}else{b=fC(new eC());lC(b,' ');}b.dc('navigationPrevious');onb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=ydb(h.f/j.g);e++){g=q8(new p8());if(e==j.f){g.dc('navigationCurrentPage');}else{hC(g,j);s8(g,e);}lC(g,''+e);onb(f,g);}if(j.f<ydb(h.f/j.g)){i=q8(new p8());lC(i,(bbb(),kbb,'Seguinte'));hC(i,j);s8(ri(i,54),j.f+1);}else{i=fC(new eC());lC(i,' ');}i.dc('navigationNext');onb(f,i);if((j.a+1)*j.g*j.d<h.f){c=q8(new p8());lC(c,'>>');hC(c,j);s8(ri(c,54),e);}else{c=fC(new eC());lC(c,' ');}c.dc('navigationArrowsRight');onb(f,c);tx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){wz(j.c,0,a,ri(qnb(f,a),55));}}
...
function w_(c,a,b){v_(c);c.c=vxb(new axb(),'',a);c.a=vxb(new axb(),'',b);ixb(c.b,c.c);ixb(c.b,c.a);oEb(c.c,(bbb(),kbb,'REFINAR '));oEb(c.a,(bbb(),kbb,'NOVA'));zxb(c.c,'icon-refine');zxb(c.a,'icon-new');gw(c,c.b);return c;}
function u_(){}
...
function hab(c,b,a){gab(c);c.a=vxb(new axb(),'',b);c.b=vxb(new axb(),'',a);ixb(c.c,c.a);ixb(c.c,c.b);uzb(c.c,'searchButtonsPanel');oEb(c.a,(bbb(),kbb,'Pesquisar'));oEb(c.b,(bbb(),kbb,'Limpar'));zxb(c.a,'icon-search');zxb(c.b,'icon-clear');gw(c,c.c);return c;}
function fab(){}
...
function cbb(d){var a,b,c;if(d.h!==null){FJb(d.p,d.h);}d.h=pKb(new jKb(),2);a=d.h.b;if(d.a.h){um(wyb(a),'height',d.a.l);}oEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");fyb(d.h,710,d.f);xJb(d.p,d.h);if(d.a.h){um(ul(wyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=zJb(d.p,c).b;um(wyb(b),'height',d.a.l);}}}
...
function ebb(d,b){var a,c;xLb(d.h.b,b);oEb(d.h,'Pormenor');cKb(d.p,d.h);if(d.a.h){um(ul(wyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=zJb(d.p,c).b;um(wyb(a),'height',d.a.l);}}}
...
function wOb(){}
_=wOb.prototype=new reb();_.tN=pQb+'DateLocale_pt_BR';_.tI=348;function DOb(a,b){return Fjb(new Djb(),lkb(a),hkb(a),dkb(a)+b);}
