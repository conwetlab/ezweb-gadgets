...
/* The Original Code is CA281EAC38A115691D9A7C1ABB853615.cache.js
...
function ef(b){var a,c;a=ri(omb(b.a,'ampms'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['vorm.','nachm.']);qmb(b.a,'ampms',c);return c;}else return a;}
function gf(b){var a,c;a=ri(omb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['v. Chr.','n. Chr.']);qmb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(omb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['v. Chr.','n. Chr.']);qmb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(omb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);qmb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(omb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['1. Quartal','2. Quartal','3. Quartal','4. Quartal']);qmb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(omb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);qmb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(omb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['So','Mo','Di','Mi','Do','Fr','Sa']);qmb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(omb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Januar','Februar','M\xE4rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember']);qmb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(omb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['S','M','D','M','D','F','S']);qmb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(omb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Jan','Feb','Mrz','Apr','Mai','Jun','Jul','Aug','Sep','Okt','Nov','Dez']);qmb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(omb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['So','Mo','Di','Mi','Do','Fr','Sa']);qmb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(omb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);qmb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(omb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',351,1,['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag']);qmb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new zeb();_.tN=sPb+'DateTimeConstants_de_CH';_.tI=18;function Ch(){return null;}
...
function ECb(b,a){aDb();xIb(b,a);b.c=rxb(new lxb(),67108864);if((a&16777216)!=0){bDb(b,0,'OK');}if((a&67108864)!=0){bDb(b,0,'OK');bDb(b,1,'Abbrechen');}if((a&268435456)!=0){bDb(b,2,'Ja');bDb(b,3,'Nein');}if((a&1073741824)!=0){bDb(b,2,'Ja');bDb(b,3,'Nein');bDb(b,1,'Abbrechen');}return b;}
...
function aPb(){}
_=aPb.prototype=new zeb();_.tN=zQb+'DateLocale_de_CH';_.tI=349;function hPb(a,b){return hkb(new fkb(),tkb(a),pkb(a),lkb(a)+b);}
