...
/* The Original Code is 06FB2C187C936238348E1F25279C0B50.cache.js
...
function bf(){}
_=bf.prototype=new jeb();_.tN=aPb+'DateTimeConstants_en_GB';_.tI=18;function Ch(){return null;}
...
function z2(){}
_=z2.prototype=new v2();_.tN=vPb+'TextCQBConfiguration';_.tI=119;_.a=false;_.b=null;_.c=null;function iN(a){A2(a);a.a=false;a.l=(pN(),wN,'Name');Bib(a.i,'mne:Entidad/mne:nombreEntidad/mne:NombreEntidad/mne:nombre');a.c='FeatureNameCQB';a.p=false;return a;}
function hN(){}
...
function qT(d,a,b,c){if(hfb(a,'viewDetails'))FU(d.a,b,c);else{b7((zab(),cbb,'ERROR'),(zab(),cbb,'Undefined behaviour'),(zab(),cbb,'Ok'),null,null,null);}}
...
function iO(b,a){if(hfb(a,'locale')){return 'en';}else if(hfb(a,'FeatureNameCQB_Title')){return 'Name';}else if(hfb(a,'withoutTitle')){return '***** Without title *****';}else if(hfb(a,'withoutType')){return '***** Without type *****';}else if(hfb(a,'serviceNG')){return 'Gazetteer (IGN)';}else if(hfb(a,'serviceNGC')){return 'Concise Gazetteer';}else if(hfb(a,'serviceEurogeonames')){return 'EuroGeoNames';}else if(hfb(a,'servicePortugal')){return 'IGP Gazetteer (Portugal)';}else if(hfb(a,'tooltip_add_to_wms_client')){return 'Center in the map viewer';}else if(hfb(a,'tooltip_highlight')){return 'Place in map';}else if(hfb(a,'tooltip_title')){return 'View in detail';}else if(hfb(a,'error')){return 'ERROR';}else if(hfb(a,'centerWithMarkerError')){return 'Failure centering the map';}else if(hfb(a,'okButtonLabel')){return 'Ok';}else if(hfb(a,'invalidCoordinatesError')){return 'Failure centering the map: Invalid coordinates';}else{return '';}}
function fO(){}
_=fO.prototype=new jeb();_.tN=mPb+'MessagesSpecific';_.tI=126;function lO(a){xlb(new zkb());}
function mO(a){lO(a);return a;}
function kO(){}
_=kO.prototype=new jeb();_.tN=mPb+'Messages_en';_.tI=127;function oO(){}
...
function xS(){}
_=xS.prototype=new jeb();_.tN=qPb+'AVOFilterBuilder';_.tI=148;_.c=null;_.d='CONTAINS WORD';_.g=false;function eT(e,a,f,c){var b,d;b=null;if(gfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(gfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(gfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(gfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(gfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(gfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(gfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!gfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{b7((zab(),cbb,'ERROR'),(zab(),cbb,'FilterBuilderToolkitObject: invalid operation'),(zab(),cbb,'Ok'),null,null,null);}return b;}
function fT(e,b,d,c){var a;a=null;if(gfb(c,e.c)){a=e.b+b+d+e.a;}else if(gfb(c,e.eb)){a=e.db+b+d+e.cb;}else{b7((zab(),cbb,'ERROR'),(zab(),cbb,'FilterBuilderToolkitObject: invalid logic operation')+': '+c,(zab(),cbb,'Ok'),null,null,null);}return a;}
...
function xT(){}
_=xT.prototype=new jeb();_.tN=sPb+'CriterionsListElement';_.tI=152;_.a=null;_.b=null;function nU(a){a.p=tV(new iV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=zib(new xib());a.g=zib(new xib());a.a=zib(new xib());a.c=dFb(new EEb(),(zab(),cbb,'Searching...'));}
...
function vU(e,b,d,c){var a;if(e.h.q){oIb(e.c);}a=hU(new gU(),e,b,d);Aab(e.k);if(e.h.r){xV(e.p,b.a,r4(b),e.m.a,d,(zab(),cbb,'en'),a);}else{uU(e,b,e.m.a,d,(zab(),cbb,'en'));}}
...
function fV(a,c,b){if(b!==null&& !hfb(b.c,'')){EU(this,a,c);BU(this,this,true,b);}else{b7((zab(),cbb,'ERROR'),(zab(),cbb,'Wrong source description file')+': '+b.c,(zab(),cbb,'Ok'),null,null,null);}}
function ET(){}
...
function cU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERROR'),(zab(),cbb,'Cannot connect to server'),(zab(),cbb,'Ok'),null,null,null);}
function dU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&lfb(e.c)>0){c='';try{if(iO(gV,e.c)!==null&&lfb(iO(gV,e.c))>0){c=iO(gV,e.c);}else{c=g3((zab(),cbb),e.c);}if(gfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,32)){a;c=e.d;}else throw a;}b7((zab(),cbb,'ERROR'),c,(zab(),cbb,'Ok'),null,null,null);}else{aV(f.b,e);}if(f.a.h.q){kIb(f.a.c);}}
...
function jU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERROR'),(zab(),cbb,'Cannot connect to server')+': '+lgb(a),(zab(),cbb,'Ok'),null,null,null);}
...
function p0(d,a){var b,c;h$(d,a);o0(d);d.b=null.ah;i$(d,d);uw(d.e,d);h4(d.j,'mapa',d.a);if(null.ah==true){if(null.ah){d.g=wBb(new DAb(),192,'my-cpanel-small');if(null.ah){CBb(d.g,false);}}else{d.g=wBb(new DAb(),128,'my-cpanel-small');}FBb(d.g,null.ah);Exb(d.g,'criterionContentPanel');}else{d.g=wBb(new DAb(),0,'internal-compound-cpanel-small');Exb(d.g,'internalCompoundCriterionContentPanel');}d.d.og('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',349,12,[])));nb(c,null.ah);if(null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN){d.a=uS(new tS(),d.b,(zab(),cbb,'en'),null.ah,null.ah,null.ah,null.ah,null.ah,agb(null.ah),agb(null.ah));}else{d.a=vS(new tS(),d.b,(zab(),cbb,'en'),agb(null.ah),agb(null.ah));}vJ(d.d,8);ku(d.d,d.a);if(null.ah==true){d.k=gv(new dv(),' '+(zab(),cbb,'Use map'));d.k.Fb(i0(new h0(),d));oK(d.i,d.k);if(null.ah){jv(d.k,true);}else{jv(d.k,false);wR(d.a);}if(null.ah){r0(d);}if(null.ah){d.ug(false);}}oF(d.e,d.d);oK(d.i,d.e);DBb(d.g,'icon-text');d.i.dc('criterionPanel');pLb(d.g,d.i);if(null.ah){b=new l0();d.h=nxb(new ywb(),(zab(),cbb,'Gazetteer'),b);gzb(d.h,false);mzb(d.h,'coordinatesCCBGazetteerButton');pLb(d.g,d.h);}gw(d,d.g);return d;}
...
function h0(){}
_=h0.prototype=new jeb();_.me=k0;_.tN=uPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=177;function n0(a){yo((zab(),bbb,''),(zab(),cbb,'Gazetteer'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function l0(){}
...
function g3(d,b){var a,c;c=ri(Elb(d.a,b),1);if(c!==null)return c;if(hfb(b,'OuterServiceException')){a='Outer service reported an exception';amb(d.a,'OuterServiceException',a);return a;}if(hfb(b,'UnableToInitIndex')){a='Unable to init an index';amb(d.a,'UnableToInitIndex',a);return a;}if(hfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: invalid logic operation';amb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(hfb(b,'usarMapa')){a='Use map';amb(d.a,'usarMapa',a);return a;}if(hfb(b,'hasta')){a='to';amb(d.a,'hasta',a);return a;}if(hfb(b,'resultados')){a='Results';amb(d.a,'resultados',a);return a;}if(hfb(b,'valueErrors')){a='Error entering search criteria';amb(d.a,'valueErrors',a);return a;}if(hfb(b,'ningunCriterioIntroducido')){a='You must enter an item to begin search';amb(d.a,'ningunCriterioIntroducido',a);return a;}if(hfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';amb(d.a,'requiredCriterionError',a);return a;}if(hfb(b,'gazetteerTitle')){a='Gazetteer';amb(d.a,'gazetteerTitle',a);return a;}if(hfb(b,'sourceURLTitle')){a='URL';amb(d.a,'sourceURLTitle',a);return a;}if(hfb(b,'UnknownFaliure')){a='Unknown service failure';amb(d.a,'UnknownFaliure',a);return a;}if(hfb(b,'okButtonLabel')){a='Ok';amb(d.a,'okButtonLabel',a);return a;}if(hfb(b,'nuevaBusqueda')){a='NEW';amb(d.a,'nuevaBusqueda',a);return a;}if(hfb(b,'refinar')){a='REFINE ';amb(d.a,'refinar',a);return a;}if(hfb(b,'newSourceTitle')){a='New source';amb(d.a,'newSourceTitle',a);return a;}if(hfb(b,'anterior')){a='Previous';amb(d.a,'anterior',a);return a;}if(hfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";amb(d.a,'UnableToReadSourceResponse',a);return a;}if(hfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';amb(d.a,'UnableToSynchroniseSource',a);return a;}if(hfb(b,'siguiente')){a='Next';amb(d.a,'siguiente',a);return a;}if(hfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';amb(d.a,'UnsupportedEncoding',a);return a;}if(hfb(b,'connection_error')){a='Cannot connect to server';amb(d.a,'connection_error',a);return a;}if(hfb(b,'limpiar')){a='Clean';amb(d.a,'limpiar',a);return a;}if(hfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';amb(d.a,'NoReachableOuterService',a);return a;}if(hfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';amb(d.a,'UnableToRemoveFromIndex',a);return a;}if(hfb(b,'sourcesListTitle')){a='Available sources';amb(d.a,'sourcesListTitle',a);return a;}if(hfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';amb(d.a,'UnableToInitSource',a);return a;}if(hfb(b,'ayuda')){a='Help';amb(d.a,'ayuda',a);return a;}if(hfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";amb(d.a,'NoReachableRDF',a);return a;}if(hfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';amb(d.a,'UnableToPerformInsertion',a);return a;}if(hfb(b,'deUnTotalDe')){a='from';amb(d.a,'deUnTotalDe',a);return a;}if(hfb(b,'invalidDate')){a='Invalid date';amb(d.a,'invalidDate',a);return a;}if(hfb(b,'sinResultados')){a='No results found';amb(d.a,'sinResultados',a);return a;}if(hfb(b,'aceptar')){a='OK';amb(d.a,'aceptar',a);return a;}if(hfb(b,'buscar')){a='Search';amb(d.a,'buscar',a);return a;}if(hfb(b,'ResultList_Title')){a='Results list';amb(d.a,'ResultList_Title',a);return a;}if(hfb(b,'buscando')){a='Searching...';amb(d.a,'buscando',a);return a;}if(hfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';amb(d.a,'NoReachablePool',a);return a;}if(hfb(b,'sourceTypeTitle')){a='Type';amb(d.a,'sourceTypeTitle',a);return a;}if(hfb(b,'SearchInfo_Title')){a='Search Info';amb(d.a,'SearchInfo_Title',a);return a;}if(hfb(b,'undefinedBehaviour')){a='Undefined behaviour';amb(d.a,'undefinedBehaviour',a);return a;}if(hfb(b,'detalle')){a='Detail';amb(d.a,'detalle',a);return a;}if(hfb(b,'error')){a='ERROR';amb(d.a,'error',a);return a;}if(hfb(b,'loading')){a='Loading...';amb(d.a,'loading',a);return a;}if(hfb(b,'resultComponentVoid')){a='-';amb(d.a,'resultComponentVoid',a);return a;}if(hfb(b,'busquedaAnterior')){a='PREVIOUS';amb(d.a,'busquedaAnterior',a);return a;}if(hfb(b,'wrongSourceDescriptionFile')){a='Wrong source description file';amb(d.a,'wrongSourceDescriptionFile',a);return a;}if(hfb(b,'locale')){a='en';amb(d.a,'locale',a);return a;}if(hfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";amb(d.a,'NotAValidQuery',a);return a;}if(hfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: invalid operation';amb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw ymb(new xmb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function c3(){}
_=c3.prototype=new jeb();_.tN=wPb+'Messages_en';_.tI=182;function i3(a){a.a=zib(new xib());}
...
function v$(j,h){var a,b,c,d,e,f,g,i;gz(j.c);f=enb(new dnb());j.h=h.e;j.f=vi((h.g+1)/j.g);j.a=vi((j.f-1)/j.d);if(j.a!=0){d=i8(new h8());lC(d,'<<');hC(d,j);k8(ri(d,54),1+j.a*j.d-j.d);}else{d=fC(new eC());lC(d,' ');}d.dc('navigationArrowsLeft');gnb(f,d);if(h.b!=0){b=i8(new h8());lC(b,(zab(),cbb,'Previous'));hC(b,j);k8(ri(b,54),j.f-1);}else{b=fC(new eC());lC(b,' ');}b.dc('navigationPrevious');gnb(f,b);for(e=1+j.a*j.d;e<=(j.a+1)*j.d&&e<=qdb(h.f/j.g);e++){g=i8(new h8());if(e==j.f){g.dc('navigationCurrentPage');}else{hC(g,j);k8(g,e);}lC(g,''+e);gnb(f,g);}if(j.f<qdb(h.f/j.g)){i=i8(new h8());lC(i,(zab(),cbb,'Next'));hC(i,j);k8(ri(i,54),j.f+1);}else{i=fC(new eC());lC(i,' ');}i.dc('navigationNext');gnb(f,i);if((j.a+1)*j.g*j.d<h.f){c=i8(new h8());lC(c,'>>');hC(c,j);k8(ri(c,54),e);}else{c=fC(new eC());lC(c,' ');}c.dc('navigationArrowsRight');gnb(f,c);tx(j.c,1,f.a.b);for(a=0;a<f.a.b;a++){wz(j.c,0,a,ri(inb(f,a),55));}}
...
function o_(c,a,b){n_(c);c.c=nxb(new ywb(),'',a);c.a=nxb(new ywb(),'',b);axb(c.b,c.c);axb(c.b,c.a);gEb(c.c,(zab(),cbb,'REFINE '));gEb(c.a,(zab(),cbb,'NEW'));rxb(c.c,'icon-refine');rxb(c.a,'icon-new');gw(c,c.b);return c;}
function m_(){}
...
function F_(c,b,a){E_(c);c.a=nxb(new ywb(),'',b);c.b=nxb(new ywb(),'',a);axb(c.c,c.a);axb(c.c,c.b);mzb(c.c,'searchButtonsPanel');gEb(c.a,(zab(),cbb,'Search'));gEb(c.b,(zab(),cbb,'Clean'));rxb(c.a,'icon-search');rxb(c.b,'icon-clear');gw(c,c.c);return c;}
function D_(){}
...
function Aab(d){var a,b,c;if(d.h!==null){xJb(d.p,d.h);}d.h=hKb(new bKb(),2);a=d.h.b;if(d.a.h){um(oyb(a),'height',d.a.l);}gEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Detail");Dxb(d.h,710,d.f);pJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=rJb(d.p,c).b;um(oyb(b),'height',d.a.l);}}}
function Bab(g,d){var a,b,c,e,f;Dxb(g.p,600,pab(new oab(),g));e=hKb(new bKb(),0);if(Elb(g.n,d.c)!==null){f=sJb(g.p,ri(Elb(g.n,d.c),61));xJb(g.p,ri(Elb(g.n,d.c),61));if(d.g!==null&& !hfb(d.g,'')){gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Results");}mzb(e,'resultsTabItem');a=e.b;gGb(a,true);if(g.a.h){um(oyb(a),'height',g.a.l);}amb(g.n,d.c,e);tJb(g.p,ri(Elb(g.n,d.c),61),f);AJb(g.p,e);}else{if(d.g!==null&& !hfb(d.g,'')){gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{gEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Results");}mzb(e,'resultsTabItem');a=e.b;gGb(a,true);if(g.a.h){um(oyb(a),'height',g.a.l);}amb(g.n,d.c,e);pJb(g.p,ri(Elb(g.n,d.c),61));}amb(g.d,qyb(e),ubb(new sbb(),false));AJb(g.p,ri(Elb(g.n,d.c),61));if(g.a.h){um(ul(oyb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=rJb(g.p,c).b;um(oyb(b),'height',g.a.l);}}}
function Cab(d,b){var a,c;pLb(d.h.b,b);gEb(d.h,'Detail');AJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=rJb(d.p,c).b;um(oyb(a),'height',d.a.l);}}}
function Dab(g,c,d){var a,b,e,f;e=ri(Elb(g.n,d.c),61);amb(g.c,qyb(e),c);Dxb(e,8,tab(new sab(),g));if(d.g!==null&& !hfb(d.g,'')){gEb(ri(Elb(g.n,d.c),61),d.g);}else{gEb(ri(Elb(g.n,d.c),61),'Results');}if(g.o==false||g.p.d.eQ(Elb(g.n,d.c))){g.o=true;AJb(g.p,g.i);f=sJb(g.p,ri(Elb(g.n,d.c),61));wLb(rJb(g.p,f).b);pLb(rJb(g.p,f).b,c);if(g.a.h){izb(rJb(g.p,f),g.a.l);um(ul(oyb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=rJb(g.p,b).b;um(oyb(a),'height',g.a.l);}}amb(g.d,qyb(e),ubb(new sbb(),true));AJb(g.p,ri(Elb(g.n,d.c),61));}}
...
function oOb(){}
_=oOb.prototype=new jeb();_.tN=hQb+'DateLocale_en_GB';_.tI=346;function vOb(a,b){return xjb(new vjb(),dkb(a),Fjb(a),Bjb(a)+b);}
