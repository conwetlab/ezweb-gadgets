...
/* The Original Code is 7C96801851FCE6001CBA226092ACB9F7.cache.js
 * The Initial Developer of the Original Code is IAAA.
 *
 * Created on Mon Feb 08 16:41:17 CET 2010 
 */
...
function rh(b){var a,c;a=Dk(inb(b.a,'ampms'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['m.','p.']);knb(b.a,'ampms',c);return c;}else return a;}
function th(b){var a,c;a=Dk(inb(b.a,'eraNames'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['aC','dC']);knb(b.a,'eraNames',c);return c;}else return a;}
function uh(b){var a,c;a=Dk(inb(b.a,'eras'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['aC','dC']);knb(b.a,'eras',c);return c;}else return a;}
function vh(b){var a,c;a=Dk(inb(b.a,'months'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['gennaio','febbraio','marzo','aprile','maggio','giugno','luglio','agosto','settembre','ottobre','novembre','dicembre']);knb(b.a,'months',c);return c;}else return a;}
function wh(b){var a,c;a=Dk(inb(b.a,'narrowMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['G','F','M','A','M','G','L','A','S','O','N','D']);knb(b.a,'narrowMonths',c);return c;}else return a;}
function xh(b){var a,c;a=Dk(inb(b.a,'quarters'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['1o trimestre','2o trimestre','3o trimestre','4o trimestre']);knb(b.a,'quarters',c);return c;}else return a;}
function yh(b){var a,c;a=Dk(inb(b.a,'shortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['gen','feb','mar','apr','mag','giu','lug','ago','set','ott','nov','dic']);knb(b.a,'shortMonths',c);return c;}else return a;}
...
function Ah(b){var a,c;a=Dk(inb(b.a,'shortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['dom','lun','mar','mer','gio','ven','sab']);knb(b.a,'shortWeekdays',c);return c;}else return a;}
function Bh(b){var a,c;a=Dk(inb(b.a,'standaloneMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['gennaio','febbraio','marzo','aprile','maggio','giugno','luglio','agosto','settembre','ottobre','novembre','dicembre']);knb(b.a,'standaloneMonths',c);return c;}else return a;}
function Ch(b){var a,c;a=Dk(inb(b.a,'standaloneNarrowMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['G','F','M','A','M','G','L','A','S','O','N','D']);knb(b.a,'standaloneNarrowMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Dk(inb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['D','L','M','M','G','V','S']);knb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Dk(inb(b.a,'standaloneShortMonths'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['gen','feb','mar','apr','mag','giu','lug','ago','set','ott','nov','dic']);knb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Fh(b){var a,c;a=Dk(inb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['dom','lun','mar','mer','gio','ven','sab']);knb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function ai(b){var a,c;a=Dk(inb(b.a,'standaloneWeekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['domenica','luned\xEC','marted\xEC','mercoled\xEC','gioved\xEC','venerd\xEC','sabato']);knb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function bi(b){var a,c;a=Dk(inb(b.a,'weekdays'),4);if(a===null){c=xk('[Ljava.lang.String;',353,1,['domenica','luned\xEC','marted\xEC','mercoled\xEC','gioved\xEC','venerd\xEC','sabato']);knb(b.a,'weekdays',c);return c;}else return a;}
function oh(){}
_=oh.prototype=new sfb();_.tN=pQb+'DateTimeConstants_it_CH';_.tI=28;function ik(){return null;}
...
function APb(){}
_=APb.prototype=new sfb();_.tN=uRb+'DateLocale_it_CH';_.tI=347;function bQb(a,b){return blb(new Fkb(),nlb(a),jlb(a),flb(a)+b);}
