...
/* The Original Code is 7B0F05161703226BA02E783F1AEC7F20.cache.js
...
function gf(b){var a,c;a=ri(Elb(b.a,'eraNames'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['a.C.','d.C.']);amb(b.a,'eraNames',c);return c;}else return a;}
function hf(b){var a,c;a=ri(Elb(b.a,'eras'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['a.C.','d.C.']);amb(b.a,'eras',c);return c;}else return a;}
function jf(b){var a,c;a=ri(Elb(b.a,'months'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);amb(b.a,'months',c);return c;}else return a;}
...
function lf(b){var a,c;a=ri(Elb(b.a,'quarters'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);amb(b.a,'quarters',c);return c;}else return a;}
function mf(b){var a,c;a=ri(Elb(b.a,'shortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);amb(b.a,'shortMonths',c);return c;}else return a;}
...
function of(b){var a,c;a=ri(Elb(b.a,'shortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);amb(b.a,'shortWeekdays',c);return c;}else return a;}
function pf(b){var a,c;a=ri(Elb(b.a,'standaloneMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);amb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function rf(b){var a,c;a=ri(Elb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['D','S','T','Q','Q','S','S']);amb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function sf(b){var a,c;a=ri(Elb(b.a,'standaloneShortMonths'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);amb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function tf(b){var a,c;a=ri(Elb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);amb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function uf(b){var a,c;a=ri(Elb(b.a,'standaloneWeekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);amb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function vf(b){var a,c;a=ri(Elb(b.a,'weekdays'),4);if(a===null){c=li('[Ljava.lang.String;',348,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);amb(b.a,'weekdays',c);return c;}else return a;}
function bf(){}
_=bf.prototype=new jeb();_.tN=aPb+'DateTimeConstants_pt_PT';_.tI=18;function Ch(){return null;}
...
function qT(d,a,b,c){if(hfb(a,'viewDetails'))FU(d.a,b,c);else{b7((zab(),cbb,'ERRO'),(zab(),cbb,'Comportamento n\xE3o definido'),(zab(),cbb,'Aceitar'),null,null,null);}}
...
function xS(){}
_=xS.prototype=new jeb();_.tN=qPb+'AVOFilterBuilder';_.tI=148;_.c=null;_.d='CONTAINS WORD';_.g=false;function eT(e,a,f,c){var b,d;b=null;if(gfb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(gfb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(gfb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(gfb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(gfb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(gfb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(gfb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!gfb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{b7((zab(),cbb,'ERRO'),(zab(),cbb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(zab(),cbb,'Aceitar'),null,null,null);}return b;}
function fT(e,b,d,c){var a;a=null;if(gfb(c,e.c)){a=e.b+b+d+e.a;}else if(gfb(c,e.eb)){a=e.db+b+d+e.cb;}else{b7((zab(),cbb,'ERRO'),(zab(),cbb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(zab(),cbb,'Aceitar'),null,null,null);}return a;}
...
function xT(){}
_=xT.prototype=new jeb();_.tN=sPb+'CriterionsListElement';_.tI=152;_.a=null;_.b=null;function nU(a){a.p=tV(new iV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=zib(new xib());a.g=zib(new xib());a.a=zib(new xib());a.c=dFb(new EEb(),(zab(),cbb,'Pesquisando...'));}
...
function vU(e,b,d,c){var a;if(e.h.q){oIb(e.c);}a=hU(new gU(),e,b,d);Aab(e.k);if(e.h.r){xV(e.p,b.a,r4(b),e.m.a,d,(zab(),cbb,'pt'),a);}else{uU(e,b,e.m.a,d,(zab(),cbb,'pt'));}}
...
function fV(a,c,b){if(b!==null&& !hfb(b.c,'')){EU(this,a,c);BU(this,this,true,b);}else{b7((zab(),cbb,'ERRO'),(zab(),cbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(zab(),cbb,'Aceitar'),null,null,null);}}
function ET(){}
...
function cU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERRO'),(zab(),cbb,'N\xE3o se p\xF4de ligar com o servidor'),(zab(),cbb,'Aceitar'),null,null,null);}
function dU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&lfb(e.c)>0){c='';try{if(iO(gV,e.c)!==null&&lfb(iO(gV,e.c))>0){c=iO(gV,e.c);}else{c=g3((zab(),cbb),e.c);}if(gfb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,32)){a;c=e.d;}else throw a;}b7((zab(),cbb,'ERRO'),c,(zab(),cbb,'Aceitar'),null,null,null);}else{aV(f.b,e);}if(f.a.h.q){kIb(f.a.c);}}
...
function jU(b,a){if(b.a.h.q){kIb(b.a.c);}b7((zab(),cbb,'ERRO'),(zab(),cbb,'N\xE3o se p\xF4de ligar com o servidor')+': '+lgb(a),(zab(),cbb,'Aceitar'),null,null,null);}
...
function p0(d,a){var b,c;h$(d,a);o0(d);d.b=null.ah;i$(d,d);uw(d.e,d);h4(d.j,'mapa',d.a);if(null.ah==true){if(null.ah){d.g=wBb(new DAb(),192,'my-cpanel-small');if(null.ah){CBb(d.g,false);}}else{d.g=wBb(new DAb(),128,'my-cpanel-small');}FBb(d.g,null.ah);Exb(d.g,'criterionContentPanel');}else{d.g=wBb(new DAb(),0,'internal-compound-cpanel-small');Exb(d.g,'internalCompoundCriterionContentPanel');}d.d.og('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',349,12,[])));nb(c,null.ah);if(null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN&&null.ah!=NaN){d.a=uS(new tS(),d.b,(zab(),cbb,'pt'),null.ah,null.ah,null.ah,null.ah,null.ah,agb(null.ah),agb(null.ah));}else{d.a=vS(new tS(),d.b,(zab(),cbb,'pt'),agb(null.ah),agb(null.ah));}vJ(d.d,8);ku(d.d,d.a);if(null.ah==true){d.k=gv(new dv(),' '+(zab(),cbb,'Usar mapa'));d.k.Fb(i0(new h0(),d));oK(d.i,d.k);if(null.ah){jv(d.k,true);}else{jv(d.k,false);wR(d.a);}if(null.ah){r0(d);}if(null.ah){d.ug(false);}}oF(d.e,d.d);oK(d.i,d.e);DBb(d.g,'icon-text');d.i.dc('criterionPanel');pLb(d.g,d.i);if(null.ah){b=new l0();d.h=nxb(new ywb(),(zab(),cbb,'Nomenclatura'),b);gzb(d.h,false);mzb(d.h,'coordinatesCCBGazetteerButton');pLb(d.g,d.h);}gw(d,d.g);return d;}
...
function h0(){}
_=h0.prototype=new jeb();_.me=k0;_.tN=uPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=177;function n0(a){yo((zab(),bbb,''),(zab(),cbb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function l0(){}
...
function g3(d,b){var a,c;c=ri(Elb(d.a,b),1);if(c!==null)return c;if(hfb(b,'OuterServiceException')){a='Outer service reported an exception';amb(d.a,'OuterServiceException',a);return a;}if(hfb(b,'UnableToInitIndex')){a='Unable to init an index';amb(d.a,'UnableToInitIndex',a);return a;}if(hfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';amb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(hfb(b,'usarMapa')){a='Usar mapa';amb(d.a,'usarMapa',a);return a;}if(hfb(b,'hasta')){a='a';amb(d.a,'hasta',a);return a;}if(hfb(b,'resultados')){a='Resultados';amb(d.a,'resultados',a);return a;}if(hfb(b,'valueErrors')){a='Error entering search criteria';amb(d.a,'valueErrors',a);return a;}if(hfb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';amb(d.a,'ningunCriterioIntroducido',a);return a;}if(hfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';amb(d.a,'requiredCriterionError',a);return a;}if(hfb(b,'gazetteerTitle')){a='Nomenclatura';amb(d.a,'gazetteerTitle',a);return a;}if(hfb(b,'sourceURLTitle')){a='URL';amb(d.a,'sourceURLTitle',a);return a;}if(hfb(b,'UnknownFaliure')){a='Unknown service failure';amb(d.a,'UnknownFaliure',a);return a;}if(hfb(b,'okButtonLabel')){a='Aceitar';amb(d.a,'okButtonLabel',a);return a;}if(hfb(b,'nuevaBusqueda')){a='NOVA';amb(d.a,'nuevaBusqueda',a);return a;}if(hfb(b,'refinar')){a='REFINAR ';amb(d.a,'refinar',a);return a;}if(hfb(b,'newSourceTitle')){a='New source';amb(d.a,'newSourceTitle',a);return a;}if(hfb(b,'anterior')){a='Anterior';amb(d.a,'anterior',a);return a;}if(hfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";amb(d.a,'UnableToReadSourceResponse',a);return a;}if(hfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';amb(d.a,'UnableToSynchroniseSource',a);return a;}if(hfb(b,'siguiente')){a='Seguinte';amb(d.a,'siguiente',a);return a;}if(hfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';amb(d.a,'UnsupportedEncoding',a);return a;}if(hfb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';amb(d.a,'connection_error',a);return a;}if(hfb(b,'limpiar')){a='Limpar';amb(d.a,'limpiar',a);return a;}if(hfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';amb(d.a,'NoReachableOuterService',a);return a;}if(hfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';amb(d.a,'UnableToRemoveFromIndex',a);return a;}if(hfb(b,'sourcesListTitle')){a='Fontes dispon\xEDveis';amb(d.a,'sourcesListTitle',a);return a;}if(hfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';amb(d.a,'UnableToInitSource',a);return a;}if(hfb(b,'ayuda')){a='Ajuda';amb(d.a,'ayuda',a);return a;}if(hfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";amb(d.a,'NoReachableRDF',a);return a;}if(hfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';amb(d.a,'UnableToPerformInsertion',a);return a;}if(hfb(b,'deUnTotalDe')){a='de um total de';amb(d.a,'deUnTotalDe',a);return a;}if(hfb(b,'invalidDate')){a='Invalid date';amb(d.a,'invalidDate',a);return a;}if(hfb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';amb(d.a,'sinResultados',a);return a;}if(hfb(b,'aceptar')){a='Aceitar';amb(d.a,'aceptar',a);return a;}if(hfb(b,'buscar')){a='Pesquisar';amb(d.a,'buscar',a);return a;}if(hfb(b,'ResultList_Title')){a='Lista de resultados';amb(d.a,'ResultList_Title',a);return a;}if(hfb(b,'buscando')){a='Pesquisando...';amb(d.a,'buscando',a);return a;}if(hfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';amb(d.a,'NoReachablePool',a);return a;}if(hfb(b,'sourceTypeTitle')){a='Type';amb(d.a,'sourceTypeTitle',a);return a;}if(hfb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';amb(d.a,'SearchInfo_Title',a);return a;}if(hfb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';amb(d.a,'undefinedBehaviour',a);return a;}if(hfb(b,'detalle')){a='Pormenor';amb(d.a,'detalle',a);return a;}if(hfb(b,'error')){a='ERRO';amb(d.a,'error',a);return a;}if(hfb(b,'loading')){a='Carregando...';amb(d.a,'loading',a);return a;}if(hfb(b,'resultComponentVoid')){a='-';amb(d.a,'resultComponentVoid',a);return a;}if(hfb(b,'busquedaAnterior')){a='ANTERIOR';amb(d.a,'busquedaAnterior',a);return a;}if(hfb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';amb(d.a,'wrongSourceDescriptionFile',a);return a;}if(hfb(b,'locale')){a='pt';amb(d.a,'locale',a);return a;}if(hfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";amb(d.a,'NotAValidQuery',a);return a;}if(hfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';amb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw ymb(new xmb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function c3(){}
_=c3.prototype=new jeb();_.tN=wPb+'Messages_pt';_.tI=182;function i3(a){a.a=zib(new xib());}
...
function o_(c,a,b){n_(c);c.c=nxb(new ywb(),'',a);c.a=nxb(new ywb(),'',b);axb(c.b,c.c);axb(c.b,c.a);gEb(c.c,(zab(),cbb,'REFINAR '));gEb(c.a,(zab(),cbb,'NOVA'));rxb(c.c,'icon-refine');rxb(c.a,'icon-new');gw(c,c.b);return c;}
function m_(){}
...
function F_(c,b,a){E_(c);c.a=nxb(new ywb(),'',b);c.b=nxb(new ywb(),'',a);axb(c.c,c.a);axb(c.c,c.b);mzb(c.c,'searchButtonsPanel');gEb(c.a,(zab(),cbb,'Pesquisar'));gEb(c.b,(zab(),cbb,'Limpar'));rxb(c.a,'icon-search');rxb(c.b,'icon-clear');gw(c,c.c);return c;}
function D_(){}
...
function Aab(d){var a,b,c;if(d.h!==null){xJb(d.p,d.h);}d.h=hKb(new bKb(),2);a=d.h.b;if(d.a.h){um(oyb(a),'height',d.a.l);}gEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");Dxb(d.h,710,d.f);pJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=rJb(d.p,c).b;um(oyb(b),'height',d.a.l);}}}
...
function Cab(d,b){var a,c;pLb(d.h.b,b);gEb(d.h,'Pormenor');AJb(d.p,d.h);if(d.a.h){um(ul(oyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=rJb(d.p,c).b;um(oyb(a),'height',d.a.l);}}}
...
function oOb(){}
_=oOb.prototype=new jeb();_.tN=hQb+'DateLocale_pt_PT';_.tI=346;function vOb(a,b){return xjb(new vjb(),dkb(a),Fjb(a),Bjb(a)+b);}
