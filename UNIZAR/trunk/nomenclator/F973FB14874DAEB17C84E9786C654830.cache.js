...
/* The Original Code is F973FB14874DAEB17C84E9786C654830.cache.js
...
function bf(){}
_=bf.prototype=new leb();_.tN=cPb+'DateTimeConstants_en';_.tI=18;function Ch(){return null;}
...
function B2(){}
_=B2.prototype=new x2();_.tN=xPb+'TextCQBConfiguration';_.tI=120;_.a=false;_.b=null;_.c=null;function kN(a){C2(a);a.a=false;a.l=(rN(),yN,'Name');Dib(a.i,'mne:Entidad/mne:nombreEntidad/mne:NombreEntidad/mne:nombre');a.c='FeatureNameCQB';a.p=false;return a;}
function jN(){}
...
function sT(d,a,b,c){if(jfb(a,'viewDetails'))bV(d.a,b,c);else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Undefined behaviour'),(Bab(),ebb,'Ok'),null,null,null);}}
...
function kO(b,a){if(jfb(a,'locale')){return 'en';}else if(jfb(a,'FeatureNameCQB_Title')){return 'Name';}else if(jfb(a,'withoutTitle')){return '***** Without title *****';}else if(jfb(a,'withoutType')){return '***** Without type *****';}else if(jfb(a,'serviceNG')){return 'Gazetteer (IGN)';}else if(jfb(a,'serviceNGC')){return 'Concise Gazetteer';}else if(jfb(a,'serviceEurogeonames')){return 'EuroGeoNames';}else if(jfb(a,'servicePortugal')){return 'IGP Gazetteer (Portugal)';}else if(jfb(a,'tooltip_add_to_wms_client')){return 'Center in the map viewer';}else if(jfb(a,'tooltip_highlight')){return 'Place in map';}else if(jfb(a,'tooltip_title')){return 'View in detail';}else if(jfb(a,'error')){return 'ERROR';}else if(jfb(a,'centerWithMarkerError')){return 'Failure centering the map';}else if(jfb(a,'okButtonLabel')){return 'Ok';}else if(jfb(a,'invalidCoordinatesError')){return 'Failure centering the map: Invalid coordinates';}else{return '';}}
function hO(){}
_=hO.prototype=new leb();_.tN=oPb+'MessagesSpecific';_.tI=127;function nO(a){zlb(new Bkb());}
function oO(a){nO(a);return a;}
function mO(){}
_=mO.prototype=new leb();_.tN=oPb+'Messages_en';_.tI=128;function qO(){}
...
function zS(){}
_=zS.prototype=new leb();_.tN=sPb+'AVOFilterBuilder';_.tI=149;_.c=null;_.d='CONTAINS WORD';_.g=false;function gT(e,a,f,c){var b,d;b=null;if(ifb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(ifb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(ifb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(ifb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(ifb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(ifb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(ifb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!ifb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'FilterBuilderToolkitObject: invalid operation'),(Bab(),ebb,'Ok'),null,null,null);}return b;}
function hT(e,b,d,c){var a;a=null;if(ifb(c,e.c)){a=e.b+b+d+e.a;}else if(ifb(c,e.eb)){a=e.db+b+d+e.cb;}else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'FilterBuilderToolkitObject: invalid logic operation')+': '+c,(Bab(),ebb,'Ok'),null,null,null);}return a;}
...
function zT(){}
_=zT.prototype=new leb();_.tN=uPb+'CriterionsListElement';_.tI=153;_.a=null;_.b=null;function pU(a){a.p=vV(new kV());a.j=a.p;a.n=Fb()+'SearchControllerServer';a.e=Bib(new zib());a.g=Bib(new zib());a.a=Bib(new zib());a.c=fFb(new aFb(),(Bab(),ebb,'Searching...'));}
...
function xU(e,b,d,c){var a;if(e.h.q){qIb(e.c);}a=jU(new iU(),e,b,d);Cab(e.k);if(e.h.r){zV(e.p,b.a,t4(b),e.m.a,d,(Bab(),ebb,'en'),a);}else{wU(e,b,e.m.a,d,(Bab(),ebb,'en'));}}
...
function BU(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=i6(new F5());t=new jX();e=ocb(Dg(s,'totalLength').tS());r6(q,hcb(e));o6(q,C7(Dg(s,'queryErrorCode').Dd().a));p6(q,C7(Dg(s,'queryErrorMessage').Dd().a));if(q.c!==null&&nfb(q.c)>0){g='';try{if(kO(iV,q.c)!==null&&nfb(kO(iV,q.c))>0){g=kO(iV,q.c);}else{g=i3((Bab(),ebb),q.c);}if(ifb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=Di(a);if(si(a,32)){a;g=q.d;}else throw a;}d7((Bab(),ebb,'ERROR'),g,(Bab(),ebb,'Ok'),null,null,null);}else{mX(t,Dg(s,'initiallySelectedSource').Bd().a);nX(t,C7(Dg(s,'sourceName').Dd().a));oX(t,C7(Dg(s,'sourceRDF').Dd().a));rX(t,C7(Dg(s,'sourceTitle').Dd().a));tX(t,Dg(s,'useSourceRDF').Bd().a);sX(t,Dg(s,'useRDFMetadata').Bd().a);lX(t,Dg(s,'createRDF').Bd().a);qX(t,C7(Dg(s,'sourceServiceURL').Dd().a));pX(t,C7(Dg(s,'sourceServiceType').Dd().a));for(h=0;h<Ff(r);h++){p=b6(new a6());o=Bf(r,h);n=xf(new wf());if((n=o.zd())!==null){k=Bf(n,0).Cd();u4(p.a,C7(Dg(k,'fileIdentifier').Dd().a));v4(p.a,C7(Dg(k,'metadataLanguage').Dd().a));m=Bib(new zib());d=Bf(n,1);c=xf(new wf());if((c=d.zd())!==null){for(i=0;i<Ff(c);i++){j=Bf(c,i).Cd();l=new j5();o5(l,C7(Dg(j,'text').Dd().a));l5(l,C7(Dg(j,'alternativeText').Dd().a));f=ocb(Dg(j,'type').tS());q5(l,hcb(f));p5(l,C7(Dg(j,'tooltip').Dd().a));m5(l,C7(Dg(j,'condition').Dd().a));n5(l,C7(Dg(j,'function').Dd().a));Cib(m,i,l);}}d6(p,m);}j6(q,p);}q6(q,t);n6(q,u.l);s6(q,u.r);if(u.h.q){mIb(u.c);}cV(u,q);}}
function DU(f,c,d,e){var a,b;if(f.h.t){c8(f.h.j,f.h.i);f.h.k.rg(true);}a=cU(new bU(),f,c);if(d){f.d=f.m.a;}else{f.d=zU(f);B6(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&nfb(f.d.a)>0){if(d){if(e!==null&& !jfb(e.c,'')){Dab(f.k,e);if(f.h.q){qIb(f.c);}if(f.h.r){AV(f.p,f.d,f.l,f.r,e,a);}else{CU(f,f.l,f.r,e);}}else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Wrong source description file')+': '+e.c,(Bab(),ebb,'Ok'),null,null,null);}}else{if(f.h.v){f.e=jbb(f.k.b);}for(b=0;b<f.e.b;b++){if(ri(cjb(f.e,b),40)!==null&& !jfb(ri(cjb(f.e,b),40).c,'')){Dab(f.k,ri(cjb(f.e,b),40));if(f.h.q){qIb(f.c);}if(f.h.r){AV(f.p,f.d,f.l,f.r,ri(cjb(f.e,b),40),a);}else{CU(f,f.l,f.r,ri(cjb(f.e,b),40));}}else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Wrong source description file')+': '+ri(cjb(f.e,b),40).c,(Bab(),ebb,'Ok'),null,null,null);}}}}else if(f.d.a!==null&&nfb(f.d.a)==0){e7(null,(Bab(),ebb,'You must enter an item to begin search'),(Bab(),ebb,'OK'),null,null,null);}}
...
function hV(a,c,b){if(b!==null&& !jfb(b.c,'')){aV(this,a,c);DU(this,this,true,b);}else{d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Wrong source description file')+': '+b.c,(Bab(),ebb,'Ok'),null,null,null);}}
function aU(){}
...
function eU(b,a){if(b.a.h.q){mIb(b.a.c);}d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Cannot connect to server'),(Bab(),ebb,'Ok'),null,null,null);}
function fU(f,d){var a,c,e;e=ri(d,42);if(e.c!==null&&nfb(e.c)>0){c='';try{if(kO(iV,e.c)!==null&&nfb(kO(iV,e.c))>0){c=kO(iV,e.c);}else{c=i3((Bab(),ebb),e.c);}if(ifb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=Di(a);if(si(a,32)){a;c=e.d;}else throw a;}d7((Bab(),ebb,'ERROR'),c,(Bab(),ebb,'Ok'),null,null,null);}else{cV(f.b,e);}if(f.a.h.q){mIb(f.a.c);}}
...
function lU(b,a){if(b.a.h.q){mIb(b.a.c);}d7((Bab(),ebb,'ERROR'),(Bab(),ebb,'Cannot connect to server')+': '+ngb(a),(Bab(),ebb,'Ok'),null,null,null);}
...
function r0(d,a){var b,c;j$(d,a);q0(d);d.b=null.Dg;k$(d,d);yw(d.e,d);j4(d.j,'mapa',d.a);if(null.Dg==true){if(null.Dg){d.g=yBb(new FAb(),192,'my-cpanel-small');if(null.Dg){EBb(d.g,false);}}else{d.g=yBb(new FAb(),128,'my-cpanel-small');}bCb(d.g,null.Dg);ayb(d.g,'criterionContentPanel');}else{d.g=yBb(new FAb(),0,'internal-compound-cpanel-small');ayb(d.g,'internalCompoundCriterionContentPanel');}d.d.lg('coordinatesBox');c=kb(new jb());mb(c,eb(new ab(),li('[Lcom.eg.gwt.openLayers.client.JSObject;',350,12,[])));nb(c,null.Dg);if(null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN&&null.Dg!=NaN){d.a=wS(new vS(),d.b,(Bab(),ebb,'en'),null.Dg,null.Dg,null.Dg,null.Dg,null.Dg,cgb(null.Dg),cgb(null.Dg));}else{d.a=xS(new vS(),d.b,(Bab(),ebb,'en'),cgb(null.Dg),cgb(null.Dg));}zJ(d.d,8);ou(d.d,d.a);if(null.Dg==true){d.k=kv(new hv(),' '+(Bab(),ebb,'Use map'));d.k.Fb(k0(new j0(),d));sK(d.i,d.k);if(null.Dg){nv(d.k,true);}else{nv(d.k,false);yR(d.a);}if(null.Dg){t0(d);}if(null.Dg){d.rg(false);}}sF(d.e,d.d);sK(d.i,d.e);FBb(d.g,'icon-text');d.i.dc('criterionPanel');rLb(d.g,d.i);if(null.Dg){b=new n0();d.h=pxb(new Awb(),(Bab(),ebb,'Gazetteer'),b);izb(d.h,false);ozb(d.h,'coordinatesCCBGazetteerButton');rLb(d.g,d.h);}kw(d,d.g);return d;}
...
function j0(){}
_=j0.prototype=new leb();_.je=m0;_.tN=wPb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=178;function p0(a){yo((Bab(),dbb,''),(Bab(),ebb,'Gazetteer'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function n0(){}
...
function i3(d,b){var a,c;c=ri(amb(d.a,b),1);if(c!==null)return c;if(jfb(b,'OuterServiceException')){a='Outer service reported an exception';cmb(d.a,'OuterServiceException',a);return a;}if(jfb(b,'UnableToInitIndex')){a='Unable to init an index';cmb(d.a,'UnableToInitIndex',a);return a;}if(jfb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: invalid logic operation';cmb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(jfb(b,'usarMapa')){a='Use map';cmb(d.a,'usarMapa',a);return a;}if(jfb(b,'hasta')){a='to';cmb(d.a,'hasta',a);return a;}if(jfb(b,'resultados')){a='Results';cmb(d.a,'resultados',a);return a;}if(jfb(b,'valueErrors')){a='Error entering search criteria';cmb(d.a,'valueErrors',a);return a;}if(jfb(b,'ningunCriterioIntroducido')){a='You must enter an item to begin search';cmb(d.a,'ningunCriterioIntroducido',a);return a;}if(jfb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';cmb(d.a,'requiredCriterionError',a);return a;}if(jfb(b,'gazetteerTitle')){a='Gazetteer';cmb(d.a,'gazetteerTitle',a);return a;}if(jfb(b,'sourceURLTitle')){a='URL';cmb(d.a,'sourceURLTitle',a);return a;}if(jfb(b,'UnknownFaliure')){a='Unknown service failure';cmb(d.a,'UnknownFaliure',a);return a;}if(jfb(b,'okButtonLabel')){a='Ok';cmb(d.a,'okButtonLabel',a);return a;}if(jfb(b,'nuevaBusqueda')){a='NEW';cmb(d.a,'nuevaBusqueda',a);return a;}if(jfb(b,'refinar')){a='REFINE ';cmb(d.a,'refinar',a);return a;}if(jfb(b,'newSourceTitle')){a='New source';cmb(d.a,'newSourceTitle',a);return a;}if(jfb(b,'anterior')){a='Previous';cmb(d.a,'anterior',a);return a;}if(jfb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";cmb(d.a,'UnableToReadSourceResponse',a);return a;}if(jfb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';cmb(d.a,'UnableToSynchroniseSource',a);return a;}if(jfb(b,'siguiente')){a='Next';cmb(d.a,'siguiente',a);return a;}if(jfb(b,'UnsupportedEncoding')){a='Unsupported Encoding';cmb(d.a,'UnsupportedEncoding',a);return a;}if(jfb(b,'connection_error')){a='Cannot connect to server';cmb(d.a,'connection_error',a);return a;}if(jfb(b,'limpiar')){a='Clean';cmb(d.a,'limpiar',a);return a;}if(jfb(b,'NoReachableOuterService')){a='Could not connect with the outer service';cmb(d.a,'NoReachableOuterService',a);return a;}if(jfb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';cmb(d.a,'UnableToRemoveFromIndex',a);return a;}if(jfb(b,'sourcesListTitle')){a='Available sources';cmb(d.a,'sourcesListTitle',a);return a;}if(jfb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';cmb(d.a,'UnableToInitSource',a);return a;}if(jfb(b,'ayuda')){a='Help';cmb(d.a,'ayuda',a);return a;}if(jfb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";cmb(d.a,'NoReachableRDF',a);return a;}if(jfb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';cmb(d.a,'UnableToPerformInsertion',a);return a;}if(jfb(b,'deUnTotalDe')){a='from';cmb(d.a,'deUnTotalDe',a);return a;}if(jfb(b,'invalidDate')){a='Invalid date';cmb(d.a,'invalidDate',a);return a;}if(jfb(b,'sinResultados')){a='No results found';cmb(d.a,'sinResultados',a);return a;}if(jfb(b,'aceptar')){a='OK';cmb(d.a,'aceptar',a);return a;}if(jfb(b,'buscar')){a='Search';cmb(d.a,'buscar',a);return a;}if(jfb(b,'ResultList_Title')){a='Results list';cmb(d.a,'ResultList_Title',a);return a;}if(jfb(b,'buscando')){a='Searching...';cmb(d.a,'buscando',a);return a;}if(jfb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';cmb(d.a,'NoReachablePool',a);return a;}if(jfb(b,'sourceTypeTitle')){a='Type';cmb(d.a,'sourceTypeTitle',a);return a;}if(jfb(b,'SearchInfo_Title')){a='Search Info';cmb(d.a,'SearchInfo_Title',a);return a;}if(jfb(b,'undefinedBehaviour')){a='Undefined behaviour';cmb(d.a,'undefinedBehaviour',a);return a;}if(jfb(b,'detalle')){a='Detail';cmb(d.a,'detalle',a);return a;}if(jfb(b,'error')){a='ERROR';cmb(d.a,'error',a);return a;}if(jfb(b,'loading')){a='Loading...';cmb(d.a,'loading',a);return a;}if(jfb(b,'resultComponentVoid')){a='-';cmb(d.a,'resultComponentVoid',a);return a;}if(jfb(b,'busquedaAnterior')){a='PREVIOUS';cmb(d.a,'busquedaAnterior',a);return a;}if(jfb(b,'wrongSourceDescriptionFile')){a='Wrong source description file';cmb(d.a,'wrongSourceDescriptionFile',a);return a;}if(jfb(b,'locale')){a='en';cmb(d.a,'locale',a);return a;}if(jfb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";cmb(d.a,'NotAValidQuery',a);return a;}if(jfb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: invalid operation';cmb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw Amb(new zmb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function e3(){}
_=e3.prototype=new leb();_.tN=yPb+'Messages_en';_.tI=183;function k3(a){a.a=Bib(new zib());}
...
function q_(c,a,b){p_(c);c.c=pxb(new Awb(),'',a);c.a=pxb(new Awb(),'',b);cxb(c.b,c.c);cxb(c.b,c.a);iEb(c.c,(Bab(),ebb,'REFINE '));iEb(c.a,(Bab(),ebb,'NEW'));txb(c.c,'icon-refine');txb(c.a,'icon-new');kw(c,c.b);return c;}
function o_(){}
...
function bab(c,b,a){aab(c);c.a=pxb(new Awb(),'',b);c.b=pxb(new Awb(),'',a);cxb(c.c,c.a);cxb(c.c,c.b);ozb(c.c,'searchButtonsPanel');iEb(c.a,(Bab(),ebb,'Search'));iEb(c.b,(Bab(),ebb,'Clean'));txb(c.a,'icon-search');txb(c.b,'icon-clear');kw(c,c.c);return c;}
function F_(){}
...
function Cab(d){var a,b,c;if(d.h!==null){zJb(d.p,d.h);}d.h=jKb(new dKb(),2);a=d.h.b;if(d.a.h){um(qyb(a),'height',d.a.l);}iEb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Detail");Fxb(d.h,710,d.f);rJb(d.p,d.h);if(d.a.h){um(ul(qyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=tJb(d.p,c).b;um(qyb(b),'height',d.a.l);}}}
function Dab(g,d){var a,b,c,e,f;Fxb(g.p,600,rab(new qab(),g));e=jKb(new dKb(),0);if(amb(g.n,d.c)!==null){f=uJb(g.p,ri(amb(g.n,d.c),61));zJb(g.p,ri(amb(g.n,d.c),61));if(d.g!==null&& !jfb(d.g,'')){iEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{iEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Results");}ozb(e,'resultsTabItem');a=e.b;iGb(a,true);if(g.a.h){um(qyb(a),'height',g.a.l);}cmb(g.n,d.c,e);vJb(g.p,ri(amb(g.n,d.c),61),f);CJb(g.p,e);}else{if(d.g!==null&& !jfb(d.g,'')){iEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;"+d.g);}else{iEb(e,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Results");}ozb(e,'resultsTabItem');a=e.b;iGb(a,true);if(g.a.h){um(qyb(a),'height',g.a.l);}cmb(g.n,d.c,e);rJb(g.p,ri(amb(g.n,d.c),61));}cmb(g.d,syb(e),wbb(new ubb(),false));CJb(g.p,ri(amb(g.n,d.c),61));if(g.a.h){um(ul(qyb(g.p),1),'height',g.a.l);for(c=0;c<g.p.z.b;c++){b=tJb(g.p,c).b;um(qyb(b),'height',g.a.l);}}}
function Eab(d,b){var a,c;rLb(d.h.b,b);iEb(d.h,'Detail');CJb(d.p,d.h);if(d.a.h){um(ul(qyb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=tJb(d.p,c).b;um(qyb(a),'height',d.a.l);}}}
function Fab(g,c,d){var a,b,e,f;e=ri(amb(g.n,d.c),61);cmb(g.c,syb(e),c);Fxb(e,8,vab(new uab(),g));if(d.g!==null&& !jfb(d.g,'')){iEb(ri(amb(g.n,d.c),61),d.g);}else{iEb(ri(amb(g.n,d.c),61),'Results');}if(g.o==false||g.p.d.eQ(amb(g.n,d.c))){g.o=true;CJb(g.p,g.i);f=uJb(g.p,ri(amb(g.n,d.c),61));yLb(tJb(g.p,f).b);rLb(tJb(g.p,f).b,c);if(g.a.h){kzb(tJb(g.p,f),g.a.l);um(ul(qyb(g.p),1),'height',g.a.l);for(b=0;b<g.p.z.b;b++){a=tJb(g.p,b).b;um(qyb(a),'height',g.a.l);}}cmb(g.d,syb(e),wbb(new ubb(),true));CJb(g.p,ri(amb(g.n,d.c),61));}}
...
function hbb(p,n,d,q,g){var a,b,c,e,f,h,i,j,k,l,m,o;gbb(p);p.e=n;p.b=d;p.i=q;p.c=g;e=0;i=false;xx(p.d,p.e.b,2);if(p.i){xx(p.d,p.e.b+3,2);h=sE(new rE(),'myRadioGroup');nv(h,false);Az(p.d,0,0,h);f=kC(new iC(),(Bab(),ebb,'New source'));Az(p.d,0,1,f);o=yA(new wA());m=kC(new iC(),(Bab(),ebb,'URL')+':  ');zA(o,m);p.h.lg('sourcesListTextBox');zA(o,p.h);Az(p.d,1,1,o);c=yA(new wA());l=kC(new iC(),(Bab(),ebb,'Type')+':  ');zA(c,l);p.a.lg('sourcesListListBox');zA(c,p.a);for(b=0;b<p.c.b;b++){AC(p.a,ri(cjb(p.c,b),1));}Az(p.d,2,1,c);e=3;}for(b=0;b<p.e.b;b++){if(p.b){a=iv(new hv());Az(p.d,b+e,0,a);nv(a,ri(cjb(p.e,b),40).b);j=kC(new iC(),ri(cjb(p.e,b),40).g);Az(p.d,b+e,1,j);}else{h=sE(new rE(),'myRadioGroup');if(!i&&ri(cjb(p.e,b),40).b){nv(h,true);i=true;}Az(p.d,b+e,0,h);k=kC(new iC(),ri(cjb(p.e,b),40).g);Az(p.d,b+e,1,k);}}if(!p.b){if(!i){nv(ri(pz(p.d,0,0),65),true);}}if(kO(iV,'sourcesListTitle')!==null&& !jfb(kO(iV,'sourcesListTitle'),'')){bCb(p.f,kO(iV,'sourcesListTitle'));}else{bCb(p.f,(Bab(),ebb,'Available sources'));}aCb(p.f,5);ayb(p.f,'sourcesListPanel');FBb(p.f,'icon-text');wz(p.d,4);sF(p.g,p.d);p.g.lg('sourcesGrid');rLb(p.f,p.g);kw(p,p.f);return p;}
