...
/* The Original Code is 8377B6389ADFEF76E3C53766DC56FD28.cache.js
...
function th(b){var a,c;a=Bk(gnb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);inb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(gnb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);inb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(gnb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);inb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(gnb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);inb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(gnb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);inb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(gnb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['D','S','T','Q','Q','S','S']);inb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(gnb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);inb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(gnb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);inb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(gnb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);inb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(gnb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',353,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);inb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new qfb();_.tN=lQb+'DateTimeConstants_pt_PT';_.tI=28;function gk(){return null;}
...
function rU(d,a,b,c){if(ogb(a,'viewDetails'))aW(d.a,b,c);else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'Comportamento n\xE3o definido'),(acb(),jcb,'Aceitar'),null,null,null);}}
...
function yT(){}
_=yT.prototype=new qfb();_.tN=zQb+'AVOFilterBuilder';_.tI=148;_.c=null;_.d='CONTAINS WORD';_.g=false;function fU(e,a,f,c){var b,d;b=null;if(ngb(c,e.o)){b=e.n;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.m;}else if(ngb(c,e.j)){b=e.i;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.h;}else if(ngb(c,e.v)){b=e.u;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.t;}else if(ngb(c,e.D)){b=e.C;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.B;}else if(ngb(c,e.A)){b=e.z;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.w;}else if(ngb(c,e.ab)){b=e.F;b=b+e.ib+a+e.hb;b=b+e.cb+f+e.bb;b=b+e.E;}else if(ngb(c,'BBOX')){d=a;b=e.e;b=b+e.ib+e.jb+e.hb;if(!ngb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(acb(),jcb,'Aceitar'),null,null,null);}return b;}
function gU(e,b,d,c){var a;a=null;if(ngb(c,e.c)){a=e.b+b+d+e.a;}else if(ngb(c,e.gb)){a=e.fb+b+d+e.eb;}else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(acb(),jcb,'Aceitar'),null,null,null);}return a;}
...
function yU(){}
_=yU.prototype=new qfb();_.tN=BQb+'CriterionsListElement';_.tI=152;_.a=null;_.b=null;function oV(a){a.p=uW(new jW());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=bkb(new Fjb());a.g=bkb(new Fjb());a.a=bkb(new Fjb());a.c=lGb(new gGb(),(acb(),jcb,'Pesquisando...'));}
...
function wV(e,b,d,c){var a;if(e.h.q){wJb(e.c);}a=iV(new hV(),e,b,d);bcb(e.k);if(e.h.r){yW(e.p,b.a,s5(b),e.m.a,d,(acb(),jcb,'pt'),a);}else{vV(e,b,e.m.a,d,(acb(),jcb,'pt'));}}
...
function AV(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=h7(new E6());t=new iY();e=tdb(hj(s,'totalLength').tS());q7(q,mdb(e));n7(q,B8(hj(s,'queryErrorCode').ce().a));o7(q,B8(hj(s,'queryErrorMessage').ce().a));if(q.c!==null&&sgb(q.c)>0){g='';try{if(CQ(hW,q.c)!==null&&sgb(CQ(hW,q.c))>0){g=CQ(hW,q.c);}else{g=h4((acb(),jcb),q.c);}if(ngb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=hl(a);if(Ck(a,33)){a;g=q.d;}else throw a;}c8((acb(),jcb,'ERRO'),g,(acb(),jcb,'Aceitar'),null,null,null);}else{lY(t,hj(s,'initiallySelectedSource').ae().a);mY(t,B8(hj(s,'sourceName').ce().a));nY(t,B8(hj(s,'sourceRDF').ce().a));qY(t,B8(hj(s,'sourceTitle').ce().a));sY(t,hj(s,'useSourceRDF').ae().a);rY(t,hj(s,'useRDFMetadata').ae().a);kY(t,hj(s,'createRDF').ae().a);pY(t,B8(hj(s,'sourceServiceURL').ce().a));oY(t,B8(hj(s,'sourceServiceType').ce().a));for(h=0;h<ji(r);h++){p=a7(new F6());o=fi(r,h);n=bi(new ai());if((n=o.Ed())!==null){k=fi(n,0).be();t5(p.a,B8(hj(k,'fileIdentifier').ce().a));u5(p.a,B8(hj(k,'metadataLanguage').ce().a));m=bkb(new Fjb());d=fi(n,1);c=bi(new ai());if((c=d.Ed())!==null){for(i=0;i<ji(c);i++){j=fi(c,i).be();l=new i6();n6(l,B8(hj(j,'text').ce().a));k6(l,B8(hj(j,'alternativeText').ce().a));f=tdb(hj(j,'type').tS());p6(l,mdb(f));o6(l,B8(hj(j,'tooltip').ce().a));l6(l,B8(hj(j,'condition').ce().a));m6(l,B8(hj(j,'function').ce().a));ckb(m,i,l);}}c7(p,m);}i7(q,p);}p7(q,t);m7(q,u.l);r7(q,u.r);if(u.h.q){sJb(u.c);}bW(u,q);}}
function CV(f,c,d,e){var a,b;if(f.h.t){a9(f.h.j,f.h.i);f.h.k.xg(true);}a=bV(new aV(),f,c);if(d){f.d=f.m.a;}else{f.d=yV(f);A7(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&sgb(f.d.a)>0){if(d){if(e!==null&& !ogb(e.c,'')){ccb(f.k,e);if(f.h.q){wJb(f.c);}if(f.h.r){zW(f.p,f.d,f.l,f.r,e,a);}else{BV(f,f.l,f.r,e);}}else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(acb(),jcb,'Aceitar'),null,null,null);}}else{if(f.h.v){f.e=ocb(f.k.b);}for(b=0;b<f.e.b;b++){if(Bk(ikb(f.e,b),41)!==null&& !ogb(Bk(ikb(f.e,b),41).c,'')){ccb(f.k,Bk(ikb(f.e,b),41));if(f.h.q){wJb(f.c);}if(f.h.r){zW(f.p,f.d,f.l,f.r,Bk(ikb(f.e,b),41),a);}else{BV(f,f.l,f.r,Bk(ikb(f.e,b),41));}}else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Bk(ikb(f.e,b),41).c,(acb(),jcb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&sgb(f.d.a)==0){d8(null,(acb(),jcb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(acb(),jcb,'Aceitar'),null,null,null);}}
...
function gW(a,c,b){if(b!==null&& !ogb(b.c,'')){FV(this,a,c);CV(this,this,true,b);}else{c8((acb(),jcb,'ERRO'),(acb(),jcb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(acb(),jcb,'Aceitar'),null,null,null);}}
function FU(){}
...
function dV(b,a){if(b.a.h.q){sJb(b.a.c);}c8((acb(),jcb,'ERRO'),(acb(),jcb,'N\xE3o se p\xF4de ligar com o servidor'),(acb(),jcb,'Aceitar'),null,null,null);}
function eV(f,d){var a,c,e;e=Bk(d,43);if(e.c!==null&&sgb(e.c)>0){c='';try{if(CQ(hW,e.c)!==null&&sgb(CQ(hW,e.c))>0){c=CQ(hW,e.c);}else{c=h4((acb(),jcb),e.c);}if(ngb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,33)){a;c=e.d;}else throw a;}c8((acb(),jcb,'ERRO'),c,(acb(),jcb,'Aceitar'),null,null,null);}else{bW(f.b,e);}if(f.a.h.q){sJb(f.a.c);}}
...
function kV(b,a){if(b.a.h.q){sJb(b.a.c);}c8((acb(),jcb,'ERRO'),(acb(),jcb,'N\xE3o se p\xF4de ligar com o servidor')+': '+thb(a),(acb(),jcb,'Aceitar'),null,null,null);}
...
function i1(){}
_=i1.prototype=new qfb();_.oe=l1;_.tN=DQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=177;function o1(a){Eq((acb(),icb,''),(acb(),jcb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function m1(){}
...
function h4(d,b){var a,c;c=Bk(gnb(d.a,b),1);if(c!==null)return c;if(ogb(b,'OuterServiceException')){a='Outer service reported an exception';inb(d.a,'OuterServiceException',a);return a;}if(ogb(b,'UnableToInitIndex')){a='Unable to init an index';inb(d.a,'UnableToInitIndex',a);return a;}if(ogb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';inb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(ogb(b,'usarMapa')){a='Usar mapa';inb(d.a,'usarMapa',a);return a;}if(ogb(b,'hasta')){a='a';inb(d.a,'hasta',a);return a;}if(ogb(b,'resultados')){a='Resultados';inb(d.a,'resultados',a);return a;}if(ogb(b,'valueErrors')){a='Error entering search criteria';inb(d.a,'valueErrors',a);return a;}if(ogb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';inb(d.a,'ningunCriterioIntroducido',a);return a;}if(ogb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';inb(d.a,'requiredCriterionError',a);return a;}if(ogb(b,'gazetteerTitle')){a='Nomenclatura';inb(d.a,'gazetteerTitle',a);return a;}if(ogb(b,'sourceURLTitle')){a='URL';inb(d.a,'sourceURLTitle',a);return a;}if(ogb(b,'UnknownFaliure')){a='Unknown service failure';inb(d.a,'UnknownFaliure',a);return a;}if(ogb(b,'okButtonLabel')){a='Aceitar';inb(d.a,'okButtonLabel',a);return a;}if(ogb(b,'nuevaBusqueda')){a='NOVA';inb(d.a,'nuevaBusqueda',a);return a;}if(ogb(b,'refinar')){a='REFINAR ';inb(d.a,'refinar',a);return a;}if(ogb(b,'newSourceTitle')){a='New source';inb(d.a,'newSourceTitle',a);return a;}if(ogb(b,'anterior')){a='Anterior';inb(d.a,'anterior',a);return a;}if(ogb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";inb(d.a,'UnableToReadSourceResponse',a);return a;}if(ogb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';inb(d.a,'UnableToSynchroniseSource',a);return a;}if(ogb(b,'siguiente')){a='Seguinte';inb(d.a,'siguiente',a);return a;}if(ogb(b,'UnsupportedEncoding')){a='Unsupported Encoding';inb(d.a,'UnsupportedEncoding',a);return a;}if(ogb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';inb(d.a,'connection_error',a);return a;}if(ogb(b,'limpiar')){a='Limpar';inb(d.a,'limpiar',a);return a;}if(ogb(b,'NoReachableOuterService')){a='Could not connect with the outer service';inb(d.a,'NoReachableOuterService',a);return a;}if(ogb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';inb(d.a,'UnableToRemoveFromIndex',a);return a;}if(ogb(b,'sourcesListTitle')){a='Sources list';inb(d.a,'sourcesListTitle',a);return a;}if(ogb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';inb(d.a,'UnableToInitSource',a);return a;}if(ogb(b,'ayuda')){a='Ajuda';inb(d.a,'ayuda',a);return a;}if(ogb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";inb(d.a,'NoReachableRDF',a);return a;}if(ogb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';inb(d.a,'UnableToPerformInsertion',a);return a;}if(ogb(b,'deUnTotalDe')){a='de um total de';inb(d.a,'deUnTotalDe',a);return a;}if(ogb(b,'invalidDate')){a='Invalid date';inb(d.a,'invalidDate',a);return a;}if(ogb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';inb(d.a,'sinResultados',a);return a;}if(ogb(b,'aceptar')){a='Aceitar';inb(d.a,'aceptar',a);return a;}if(ogb(b,'buscar')){a='Pesquisar';inb(d.a,'buscar',a);return a;}if(ogb(b,'ResultList_Title')){a='Lista de resultados';inb(d.a,'ResultList_Title',a);return a;}if(ogb(b,'buscando')){a='Pesquisando...';inb(d.a,'buscando',a);return a;}if(ogb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';inb(d.a,'NoReachablePool',a);return a;}if(ogb(b,'sourceTypeTitle')){a='Type';inb(d.a,'sourceTypeTitle',a);return a;}if(ogb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';inb(d.a,'SearchInfo_Title',a);return a;}if(ogb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';inb(d.a,'undefinedBehaviour',a);return a;}if(ogb(b,'detalle')){a='Pormenor';inb(d.a,'detalle',a);return a;}if(ogb(b,'error')){a='ERRO';inb(d.a,'error',a);return a;}if(ogb(b,'loading')){a='Carregando...';inb(d.a,'loading',a);return a;}if(ogb(b,'resultComponentVoid')){a='-';inb(d.a,'resultComponentVoid',a);return a;}if(ogb(b,'busquedaAnterior')){a='ANTERIOR';inb(d.a,'busquedaAnterior',a);return a;}if(ogb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';inb(d.a,'wrongSourceDescriptionFile',a);return a;}if(ogb(b,'locale')){a='pt';inb(d.a,'locale',a);return a;}if(ogb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";inb(d.a,'NotAValidQuery',a);return a;}if(ogb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';inb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw aob(new Fnb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function d4(){}
_=d4.prototype=new qfb();_.tN=FQb+'Messages_pt';_.tI=182;function j4(a){a.a=bkb(new Fjb());}
...
function vab(c,a,b){uab(c);c.c=vyb(new ayb(),'',a);c.a=vyb(new ayb(),'',b);iyb(c.b,c.c);iyb(c.b,c.a);oFb(c.c,(acb(),jcb,'REFINAR '));oFb(c.a,(acb(),jcb,'NOVA'));zyb(c.c,'icon-refine');zyb(c.a,'icon-new');uy(c,c.b);return c;}
function tab(){}
...
function gbb(c,b,a){fbb(c);c.a=vyb(new ayb(),'',b);c.b=vyb(new ayb(),'',a);iyb(c.c,c.a);iyb(c.c,c.b);uAb(c.c,'searchButtonsPanel');oFb(c.a,(acb(),jcb,'Pesquisar'));oFb(c.b,(acb(),jcb,'Limpar'));zyb(c.a,'icon-search');zyb(c.b,'icon-clear');uy(c,c.c);return c;}
function ebb(){}
...
function bcb(d){var a,b,c;if(d.h!==null){FKb(d.p,d.h);}d.h=pLb(new jLb(),2);a=d.h.b;if(d.a.h){ap(wzb(a),'height',d.a.l);}oFb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");fzb(d.h,710,d.f);xKb(d.p,d.h);if(d.a.h){ap(Fn(wzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){b=zKb(d.p,c).b;ap(wzb(b),'height',d.a.l);}}}
...
function dcb(d,b){var a,c;xMb(d.h.b,b);oFb(d.h,'Pormenor');cLb(d.p,d.h);if(d.a.h){ap(Fn(wzb(d.p),1),'height',d.a.l);for(c=0;c<d.p.B.b;c++){a=zKb(d.p,c).b;ap(wzb(a),'height',d.a.l);}}}
...
function wPb(){}
_=wPb.prototype=new qfb();_.tN=qRb+'DateLocale_pt_PT';_.tI=347;function DPb(a,b){return Fkb(new Dkb(),llb(a),hlb(a),dlb(a)+b);}
