...
/* The Original Code is FB2D55A02A9D630057AD0B7560E5D1F2.cache.js
...
function rh(b){var a,c;a=Bk(ymb(b.a,'eraNames'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['a.C.','d.C.']);Amb(b.a,'eraNames',c);return c;}else return a;}
function sh(b){var a,c;a=Bk(ymb(b.a,'eras'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['a.C.','d.C.']);Amb(b.a,'eras',c);return c;}else return a;}
function th(b){var a,c;a=Bk(ymb(b.a,'months'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);Amb(b.a,'months',c);return c;}else return a;}
...
function vh(b){var a,c;a=Bk(ymb(b.a,'quarters'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['1\xBA trimestre','2\xBA trimestre','3\xBA trimestre','4\xBA trimestre']);Amb(b.a,'quarters',c);return c;}else return a;}
function wh(b){var a,c;a=Bk(ymb(b.a,'shortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);Amb(b.a,'shortMonths',c);return c;}else return a;}
...
function yh(b){var a,c;a=Bk(ymb(b.a,'shortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);Amb(b.a,'shortWeekdays',c);return c;}else return a;}
function zh(b){var a,c;a=Bk(ymb(b.a,'standaloneMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['janeiro','fevereiro','mar\xE7o','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro']);Amb(b.a,'standaloneMonths',c);return c;}else return a;}
...
function Bh(b){var a,c;a=Bk(ymb(b.a,'standaloneNarrowWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['D','S','T','Q','Q','S','S']);Amb(b.a,'standaloneNarrowWeekdays',c);return c;}else return a;}
function Ch(b){var a,c;a=Bk(ymb(b.a,'standaloneShortMonths'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['jan','fev','mar','abr','mai','jun','jul','ago','set','out','nov','dez']);Amb(b.a,'standaloneShortMonths',c);return c;}else return a;}
function Dh(b){var a,c;a=Bk(ymb(b.a,'standaloneShortWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['dom','seg','ter','qua','qui','sex','s\xE1b']);Amb(b.a,'standaloneShortWeekdays',c);return c;}else return a;}
function Eh(b){var a,c;a=Bk(ymb(b.a,'standaloneWeekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);Amb(b.a,'standaloneWeekdays',c);return c;}else return a;}
function Fh(b){var a,c;a=Bk(ymb(b.a,'weekdays'),4);if(a===null){c=vk('[Ljava.lang.String;',351,1,['domingo','segunda-feira','ter\xE7a-feira','quarta-feira','quinta-feira','sexta-feira','s\xE1bado']);Amb(b.a,'weekdays',c);return c;}else return a;}
function mh(){}
_=mh.prototype=new cfb();_.tN=DPb+'DateTimeConstants_pt_BR';_.tI=28;function gk(){return null;}
...
function dU(d,a,b,c){if(agb(a,'viewDetails'))sV(d.a,b,c);else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'Comportamento n\xE3o definido'),(sbb(),Bbb,'Aceitar'),null,null,null);}}
...
function kT(){}
_=kT.prototype=new cfb();_.tN=lQb+'AVOFilterBuilder';_.tI=146;_.c=null;_.d='CONTAINS WORD';_.g=false;function xT(e,a,f,c){var b,d;b=null;if(Ffb(c,e.o)){b=e.n;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.m;}else if(Ffb(c,e.j)){b=e.i;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.h;}else if(Ffb(c,e.v)){b=e.u;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.t;}else if(Ffb(c,e.B)){b=e.A;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.z;}else if(Ffb(c,e.y)){b=e.x;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.w;}else if(Ffb(c,e.E)){b=e.D;b=b+e.gb+a+e.fb;b=b+e.ab+f+e.F;b=b+e.C;}else if(Ffb(c,'BBOX')){d=a;b=e.e;b=b+e.gb+e.hb+e.fb;if(!Ffb(d,'')){b=b+e.p+d+e.q;}else{b=b+e.g;}b=b+e.l+f+e.k;b=b+e.f;b=b+e.d;}else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida'),(sbb(),Bbb,'Aceitar'),null,null,null);}return b;}
function yT(e,b,d,c){var a;a=null;if(Ffb(c,e.c)){a=e.b+b+d+e.a;}else if(Ffb(c,e.eb)){a=e.db+b+d+e.cb;}else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida')+': '+c,(sbb(),Bbb,'Aceitar'),null,null,null);}return a;}
...
function kU(){}
_=kU.prototype=new cfb();_.tN=nQb+'CriterionsListElement';_.tI=150;_.a=null;_.b=null;function aV(a){a.p=gW(new BV());a.j=a.p;a.n=ke()+'SearchControllerServer';a.e=tjb(new rjb());a.g=tjb(new rjb());a.a=tjb(new rjb());a.c=DFb(new yFb(),(sbb(),Bbb,'Pesquisando...'));}
...
function iV(e,b,d,c){var a;if(e.h.q){iJb(e.c);}a=AU(new zU(),e,b,d);tbb(e.k);if(e.h.r){kW(e.p,b.a,e5(b),e.m.a,d,(sbb(),Bbb,'pt'),a);}else{hV(e,b,e.m.a,d,(sbb(),Bbb,'pt'));}}
...
function mV(u,s,r){var a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t;q=z6(new q6());t=new AX();e=fdb(hj(s,'totalLength').tS());c7(q,Ecb(e));F6(q,n8(hj(s,'queryErrorCode').Dd().a));a7(q,n8(hj(s,'queryErrorMessage').Dd().a));if(q.c!==null&&egb(q.c)>0){g='';try{if(oQ(zV,q.c)!==null&&egb(oQ(zV,q.c))>0){g=oQ(zV,q.c);}else{g=z3((sbb(),Bbb),q.c);}if(Ffb(q.c,'OuterServiceException')){g=g+': '+q.d;}}catch(a){a=hl(a);if(Ck(a,33)){a;g=q.d;}else throw a;}u7((sbb(),Bbb,'ERRO'),g,(sbb(),Bbb,'Aceitar'),null,null,null);}else{DX(t,hj(s,'initiallySelectedSource').Bd().a);EX(t,n8(hj(s,'sourceName').Dd().a));FX(t,n8(hj(s,'sourceRDF').Dd().a));cY(t,n8(hj(s,'sourceTitle').Dd().a));eY(t,hj(s,'useSourceRDF').Bd().a);dY(t,hj(s,'useRDFMetadata').Bd().a);CX(t,hj(s,'createRDF').Bd().a);bY(t,n8(hj(s,'sourceServiceURL').Dd().a));aY(t,n8(hj(s,'sourceServiceType').Dd().a));for(h=0;h<ji(r);h++){p=s6(new r6());o=fi(r,h);n=bi(new ai());if((n=o.zd())!==null){k=fi(n,0).Cd();f5(p.a,n8(hj(k,'fileIdentifier').Dd().a));g5(p.a,n8(hj(k,'metadataLanguage').Dd().a));m=tjb(new rjb());d=fi(n,1);c=bi(new ai());if((c=d.zd())!==null){for(i=0;i<ji(c);i++){j=fi(c,i).Cd();l=new A5();F5(l,n8(hj(j,'text').Dd().a));C5(l,n8(hj(j,'alternativeText').Dd().a));f=fdb(hj(j,'type').tS());b6(l,Ecb(f));a6(l,n8(hj(j,'tooltip').Dd().a));D5(l,n8(hj(j,'condition').Dd().a));E5(l,n8(hj(j,'function').Dd().a));ujb(m,i,l);}}u6(p,m);}A6(q,p);}b7(q,t);E6(q,u.l);d7(q,u.r);if(u.h.q){eJb(u.c);}tV(u,q);}}
function oV(f,c,d,e){var a,b;if(f.h.t){s8(f.h.j,f.h.i);f.h.k.sg(true);}a=tU(new sU(),f,c);if(d){f.d=f.m.a;}else{f.d=kV(f);m7(f.m,f.d);f.l=0;f.r=f.h.m-1;}if(f.d.a!==null&&egb(f.d.a)>0){if(d){if(e!==null&& !agb(e.c,'')){ubb(f.k,e);if(f.h.q){iJb(f.c);}if(f.h.r){lW(f.p,f.d,f.l,f.r,e,a);}else{nV(f,f.l,f.r,e);}}else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+e.c,(sbb(),Bbb,'Aceitar'),null,null,null);}}else{if(f.h.v){f.e=acb(f.k.b);}for(b=0;b<f.e.b;b++){if(Bk(Ajb(f.e,b),41)!==null&& !agb(Bk(Ajb(f.e,b),41).c,'')){ubb(f.k,Bk(Ajb(f.e,b),41));if(f.h.q){iJb(f.c);}if(f.h.r){lW(f.p,f.d,f.l,f.r,Bk(Ajb(f.e,b),41),a);}else{nV(f,f.l,f.r,Bk(Ajb(f.e,b),41));}}else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+Bk(Ajb(f.e,b),41).c,(sbb(),Bbb,'Aceitar'),null,null,null);}}}}else if(f.d.a!==null&&egb(f.d.a)==0){v7(null,(sbb(),Bbb,'Deve escrever algum crit\xE9rio para realizar a pesquisa'),(sbb(),Bbb,'Aceitar'),null,null,null);}}
...
function yV(a,c,b){if(b!==null&& !agb(b.c,'')){rV(this,a,c);oV(this,this,true,b);}else{u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'Ficheiro de descri\xE7\xE3o de fonte incorrecto')+': '+b.c,(sbb(),Bbb,'Aceitar'),null,null,null);}}
function rU(){}
...
function vU(b,a){if(b.a.h.q){eJb(b.a.c);}u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'N\xE3o se p\xF4de ligar com o servidor'),(sbb(),Bbb,'Aceitar'),null,null,null);}
function wU(f,d){var a,c,e;e=Bk(d,43);if(e.c!==null&&egb(e.c)>0){c='';try{if(oQ(zV,e.c)!==null&&egb(oQ(zV,e.c))>0){c=oQ(zV,e.c);}else{c=z3((sbb(),Bbb),e.c);}if(Ffb(e.c,'OuterServiceException')){c=c+': '+e.d;}}catch(a){a=hl(a);if(Ck(a,33)){a;c=e.d;}else throw a;}u7((sbb(),Bbb,'ERRO'),c,(sbb(),Bbb,'Aceitar'),null,null,null);}else{tV(f.b,e);}if(f.a.h.q){eJb(f.a.c);}}
...
function CU(b,a){if(b.a.h.q){eJb(b.a.c);}u7((sbb(),Bbb,'ERRO'),(sbb(),Bbb,'N\xE3o se p\xF4de ligar com o servidor')+': '+fhb(a),(sbb(),Bbb,'Aceitar'),null,null,null);}
...
function A0(){}
_=A0.prototype=new cfb();_.je=D0;_.tN=pQb+'CoordinatesBoxCriterionQueryBuilder$2';_.tI=175;function a1(a){Eq((sbb(),Abb,''),(sbb(),Bbb,'Nomenclatura'),'left=200,top=100,width=285,height=303,scrollbars=no,resizable=yes');}
function E0(){}
...
function z3(d,b){var a,c;c=Bk(ymb(d.a,b),1);if(c!==null)return c;if(agb(b,'OuterServiceException')){a='Outer service reported an exception';Amb(d.a,'OuterServiceException',a);return a;}if(agb(b,'UnableToInitIndex')){a='Unable to init an index';Amb(d.a,'UnableToInitIndex',a);return a;}if(agb(b,'fEncodingBuilder_invalidLogicOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o l\xF3gica inv\xE1lida';Amb(d.a,'fEncodingBuilder_invalidLogicOp',a);return a;}if(agb(b,'usarMapa')){a='Usar mapa';Amb(d.a,'usarMapa',a);return a;}if(agb(b,'hasta')){a='a';Amb(d.a,'hasta',a);return a;}if(agb(b,'resultados')){a='Resultados';Amb(d.a,'resultados',a);return a;}if(agb(b,'valueErrors')){a='Error entering search criteria';Amb(d.a,'valueErrors',a);return a;}if(agb(b,'ningunCriterioIntroducido')){a='Deve escrever algum crit\xE9rio para realizar a pesquisa';Amb(d.a,'ningunCriterioIntroducido',a);return a;}if(agb(b,'requiredCriterionError')){a='Se debe rellenar correctamente el criterio de b\xFAsqueda';Amb(d.a,'requiredCriterionError',a);return a;}if(agb(b,'gazetteerTitle')){a='Nomenclatura';Amb(d.a,'gazetteerTitle',a);return a;}if(agb(b,'sourceURLTitle')){a='URL';Amb(d.a,'sourceURLTitle',a);return a;}if(agb(b,'UnknownFaliure')){a='Unknown service failure';Amb(d.a,'UnknownFaliure',a);return a;}if(agb(b,'okButtonLabel')){a='Aceitar';Amb(d.a,'okButtonLabel',a);return a;}if(agb(b,'nuevaBusqueda')){a='NOVA';Amb(d.a,'nuevaBusqueda',a);return a;}if(agb(b,'refinar')){a='REFINAR ';Amb(d.a,'refinar',a);return a;}if(agb(b,'newSourceTitle')){a='New source';Amb(d.a,'newSourceTitle',a);return a;}if(agb(b,'anterior')){a='Anterior';Amb(d.a,'anterior',a);return a;}if(agb(b,'UnableToReadSourceResponse')){a="Unable to interpret the outer service's response";Amb(d.a,'UnableToReadSourceResponse',a);return a;}if(agb(b,'UnableToSynchroniseSource')){a='Unable to init an index. Searches will not be made against this index';Amb(d.a,'UnableToSynchroniseSource',a);return a;}if(agb(b,'siguiente')){a='Seguinte';Amb(d.a,'siguiente',a);return a;}if(agb(b,'UnsupportedEncoding')){a='Unsupported Encoding';Amb(d.a,'UnsupportedEncoding',a);return a;}if(agb(b,'connection_error')){a='N\xE3o se p\xF4de ligar com o servidor';Amb(d.a,'connection_error',a);return a;}if(agb(b,'limpiar')){a='Limpar';Amb(d.a,'limpiar',a);return a;}if(agb(b,'NoReachableOuterService')){a='Could not connect with the outer service';Amb(d.a,'NoReachableOuterService',a);return a;}if(agb(b,'UnableToRemoveFromIndex')){a='Unable to delete a resource from an index';Amb(d.a,'UnableToRemoveFromIndex',a);return a;}if(agb(b,'sourcesListTitle')){a='Sources list';Amb(d.a,'sourcesListTitle',a);return a;}if(agb(b,'UnableToInitSource')){a='Failure founded while initializing outer service connection';Amb(d.a,'UnableToInitSource',a);return a;}if(agb(b,'ayuda')){a='Ajuda';Amb(d.a,'ayuda',a);return a;}if(agb(b,'NoReachableRDF')){a="Unable to obtain outer service's description";Amb(d.a,'NoReachableRDF',a);return a;}if(agb(b,'UnableToPerformInsertion')){a='Unable to complete the insertion operation';Amb(d.a,'UnableToPerformInsertion',a);return a;}if(agb(b,'deUnTotalDe')){a='de um total de';Amb(d.a,'deUnTotalDe',a);return a;}if(agb(b,'invalidDate')){a='Invalid date';Amb(d.a,'invalidDate',a);return a;}if(agb(b,'sinResultados')){a='N\xE3o se encontraram resultados para a consulta';Amb(d.a,'sinResultados',a);return a;}if(agb(b,'aceptar')){a='Aceitar';Amb(d.a,'aceptar',a);return a;}if(agb(b,'buscar')){a='Pesquisar';Amb(d.a,'buscar',a);return a;}if(agb(b,'ResultList_Title')){a='Lista de resultados';Amb(d.a,'ResultList_Title',a);return a;}if(agb(b,'buscando')){a='Pesquisando...';Amb(d.a,'buscando',a);return a;}if(agb(b,'NoReachablePool')){a='Unsuccessful connection establishment with the service';Amb(d.a,'NoReachablePool',a);return a;}if(agb(b,'sourceTypeTitle')){a='Type';Amb(d.a,'sourceTypeTitle',a);return a;}if(agb(b,'SearchInfo_Title')){a='Informa\xE7\xE3o da consulta';Amb(d.a,'SearchInfo_Title',a);return a;}if(agb(b,'undefinedBehaviour')){a='Comportamento n\xE3o definido';Amb(d.a,'undefinedBehaviour',a);return a;}if(agb(b,'detalle')){a='Pormenor';Amb(d.a,'detalle',a);return a;}if(agb(b,'error')){a='ERRO';Amb(d.a,'error',a);return a;}if(agb(b,'loading')){a='Carregando...';Amb(d.a,'loading',a);return a;}if(agb(b,'resultComponentVoid')){a='-';Amb(d.a,'resultComponentVoid',a);return a;}if(agb(b,'busquedaAnterior')){a='ANTERIOR';Amb(d.a,'busquedaAnterior',a);return a;}if(agb(b,'wrongSourceDescriptionFile')){a='Ficheiro de descri\xE7\xE3o de fonte incorrecto';Amb(d.a,'wrongSourceDescriptionFile',a);return a;}if(agb(b,'locale')){a='pt';Amb(d.a,'locale',a);return a;}if(agb(b,'NotAValidQuery')){a="Query's spelling has not a valid structure";Amb(d.a,'NotAValidQuery',a);return a;}if(agb(b,'fEncodingBuilder_invalidOp')){a='FilterBuilderToolkitObject: opera\xE7\xE3o inv\xE1lida';Amb(d.a,'fEncodingBuilder_invalidOp',a);return a;}throw snb(new rnb(),"Cannot find constant '"+b+"'; expecting a method name",'iaaa.searchengine.client.internationalization.Messages',b);}
function v3(){}
_=v3.prototype=new cfb();_.tN=rQb+'Messages_pt';_.tI=180;function B3(a){a.a=tjb(new rjb());}
...
function hab(c,a,b){gab(c);c.c=hyb(new sxb(),'',a);c.a=hyb(new sxb(),'',b);Axb(c.b,c.c);Axb(c.b,c.a);aFb(c.c,(sbb(),Bbb,'REFINAR '));aFb(c.a,(sbb(),Bbb,'NOVA'));lyb(c.c,'icon-refine');lyb(c.a,'icon-new');sy(c,c.b);return c;}
function fab(){}
...
function yab(c,b,a){xab(c);c.a=hyb(new sxb(),'',b);c.b=hyb(new sxb(),'',a);Axb(c.c,c.a);Axb(c.c,c.b);gAb(c.c,'searchButtonsPanel');aFb(c.a,(sbb(),Bbb,'Pesquisar'));aFb(c.b,(sbb(),Bbb,'Limpar'));lyb(c.a,'icon-search');lyb(c.b,'icon-clear');sy(c,c.c);return c;}
function wab(){}
...
function tbb(d){var a,b,c;if(d.h!==null){rKb(d.p,d.h);}d.h=bLb(new BKb(),2);a=d.h.b;if(d.a.h){ap(izb(a),'height',d.a.l);}aFb(d.h,"<IMG SRC='images/loading_node_transparent.gif'>&nbsp;&nbsp;Pormenor");xyb(d.h,710,d.f);jKb(d.p,d.h);if(d.a.h){ap(Fn(izb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){b=lKb(d.p,c).b;ap(izb(b),'height',d.a.l);}}}
...
function vbb(d,b){var a,c;jMb(d.h.b,b);aFb(d.h,'Pormenor');uKb(d.p,d.h);if(d.a.h){ap(Fn(izb(d.p),1),'height',d.a.l);for(c=0;c<d.p.z.b;c++){a=lKb(d.p,c).b;ap(izb(a),'height',d.a.l);}}}
...
function iPb(){}
_=iPb.prototype=new cfb();_.tN=cRb+'DateLocale_pt_BR';_.tI=345;function pPb(a,b){return rkb(new pkb(),Dkb(a),zkb(a),vkb(a)+b);}
