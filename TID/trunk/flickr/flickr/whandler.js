...
var headerLayer = (function() {
	...
	img.setAttribute ('src', 'http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/flickr.png');
	...
	imglogout.src ='http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/logout.png';
	...
	imgrefresh.src ='http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/refresh.png';
...
var footerLayer = (function() {
	...
	img.src = 'http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/go-first.png';
	img.setAttribute ('title', 'Go First');
	img.addEventListener ('click', function (e){setArrays(null,0);}, false);
	footer.appendChild (img);
	img = document.createElement ('img');
	img.src = 'http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/go-previous.png';
	img.setAttribute ('title', 'Go Previous');
	img.addEventListener ('click', function (e){setArrays(null,1);}, false);
	footer.appendChild (img);
	img = document.createElement ('img');
	img.src = 'http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/go-next.png';
	img.setAttribute ('title', 'Go Next');
	img.addEventListener ('click', function (e){setArrays(null,2);}, false);
	footer.appendChild (img);
	img = document.createElement ('img');
	img.src = 'http://ezweb.tid.es/repository/ezweb-gadgets/flickr/flickr_3.2/img/go-last.png';
